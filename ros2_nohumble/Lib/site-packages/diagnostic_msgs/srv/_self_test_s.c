...
bool diagnostic_msgs__srv__self_test__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("diagnostic_msgs.srv._self_test", (char *)PyUnicode_1BYTE_DATA(module_attr), 30) == 0);
    assert(strncmp("SelfTest_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);
...
bool diagnostic_msgs__srv__self_test__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("diagnostic_msgs.srv._self_test", (char *)PyUnicode_1BYTE_DATA(module_attr), 30) == 0);
    assert(strncmp("SelfTest_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 17) == 0);
...
bool diagnostic_msgs__srv__self_test__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("diagnostic_msgs.srv._self_test", (char *)PyUnicode_1BYTE_DATA(module_attr), 30) == 0);
    assert(strncmp("SelfTest_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 14) == 0);
