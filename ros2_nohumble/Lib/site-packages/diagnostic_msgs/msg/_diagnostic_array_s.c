...
bool diagnostic_msgs__msg__diagnostic_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("diagnostic_msgs.msg._diagnostic_array", (char *)PyUnicode_1BYTE_DATA(module_attr), 37) == 0);
    assert(strncmp("DiagnosticArray", (char *)PyUnicode_1BYTE_DATA(name_attr), 15) == 0);
