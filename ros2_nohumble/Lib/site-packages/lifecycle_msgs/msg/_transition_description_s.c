...
bool lifecycle_msgs__msg__transition_description__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lifecycle_msgs.msg._transition_description", (char *)PyUnicode_1BYTE_DATA(module_attr), 42) == 0);
    assert(strncmp("TransitionDescription", (char *)PyUnicode_1BYTE_DATA(name_attr), 21) == 0);
