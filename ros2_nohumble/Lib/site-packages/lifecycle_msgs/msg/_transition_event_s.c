...
bool lifecycle_msgs__msg__transition_event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lifecycle_msgs.msg._transition_event", (char *)PyUnicode_1BYTE_DATA(module_attr), 36) == 0);
    assert(strncmp("TransitionEvent", (char *)PyUnicode_1BYTE_DATA(name_attr), 15) == 0);
