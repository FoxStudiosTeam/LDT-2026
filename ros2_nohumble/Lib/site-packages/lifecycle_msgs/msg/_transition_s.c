...
bool lifecycle_msgs__msg__transition__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lifecycle_msgs.msg._transition", (char *)PyUnicode_1BYTE_DATA(module_attr), 30) == 0);
    assert(strncmp("Transition", (char *)PyUnicode_1BYTE_DATA(name_attr), 10) == 0);
