...
class Metaclass_TransitionEvent(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class TransitionEventConstants(typing.TypedDict):
        pass

    __constants: TransitionEventConstants = {
    }
    ...
    def __import_type_support__(cls) -> None:
        try:
            ...
            if Transition._TYPE_SUPPORT is None:
                Transition.__import_type_support__()
...
class TransitionEvent(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_TransitionEvent):
    ...
    def __init__(self, *,
                 ...
                 transition: typing.Optional[lifecycle_msgs.msg.Transition] = None,  # noqa: E501
                 start_state: typing.Optional[lifecycle_msgs.msg.State] = None,  # noqa: E501
                 goal_state: typing.Optional[lifecycle_msgs.msg.State] = None,  # noqa: E501
        ...
        from lifecycle_msgs.msg import Transition
        self.transition = transition if transition is not None else Transition()
        from lifecycle_msgs.msg import State
        self.start_state = start_state if start_state is not None else State()
        from lifecycle_msgs.msg import State
        self.goal_state = goal_state if goal_state is not None else State()
