...
bool lifecycle_msgs__srv__get_available_transitions__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lifecycle_msgs.srv._get_available_transitions", (char *)PyUnicode_1BYTE_DATA(module_attr), 45) == 0);
    assert(strncmp("GetAvailableTransitions_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 31) == 0);
...
bool lifecycle_msgs__srv__get_available_transitions__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("lifecycle_msgs.srv._get_available_transitions", (char *)PyUnicode_1BYTE_DATA(module_attr), 45) == 0);
    assert(strncmp("GetAvailableTransitions_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 32) == 0);
...
bool lifecycle_msgs__srv__get_available_transitions__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("lifecycle_msgs.srv._get_available_transitions", (char *)PyUnicode_1BYTE_DATA(module_attr), 45) == 0);
    assert(strncmp("GetAvailableTransitions_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 29) == 0);
