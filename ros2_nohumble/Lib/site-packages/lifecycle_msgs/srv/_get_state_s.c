...
bool lifecycle_msgs__srv__get_state__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lifecycle_msgs.srv._get_state", (char *)PyUnicode_1BYTE_DATA(module_attr), 29) == 0);
    assert(strncmp("GetState_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);
...
bool lifecycle_msgs__srv__get_state__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("lifecycle_msgs.srv._get_state", (char *)PyUnicode_1BYTE_DATA(module_attr), 29) == 0);
    assert(strncmp("GetState_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 17) == 0);
...
bool lifecycle_msgs__srv__get_state__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("lifecycle_msgs.srv._get_state", (char *)PyUnicode_1BYTE_DATA(module_attr), 29) == 0);
    assert(strncmp("GetState_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 14) == 0);
