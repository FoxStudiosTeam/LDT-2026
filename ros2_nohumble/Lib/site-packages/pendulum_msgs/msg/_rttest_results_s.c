...
bool pendulum_msgs__msg__rttest_results__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pendulum_msgs.msg._rttest_results", (char *)PyUnicode_1BYTE_DATA(module_attr), 33) == 0);
    assert(strncmp("RttestResults", (char *)PyUnicode_1BYTE_DATA(name_attr), 13) == 0);
