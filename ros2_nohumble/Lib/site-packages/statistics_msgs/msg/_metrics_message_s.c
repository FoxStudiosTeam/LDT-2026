...
bool statistics_msgs__msg__metrics_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("statistics_msgs.msg._metrics_message", (char *)PyUnicode_1BYTE_DATA(module_attr), 36) == 0);
    assert(strncmp("MetricsMessage", (char *)PyUnicode_1BYTE_DATA(name_attr), 14) == 0);
