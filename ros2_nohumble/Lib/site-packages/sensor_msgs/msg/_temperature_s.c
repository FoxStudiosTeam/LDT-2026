...
bool sensor_msgs__msg__temperature__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sensor_msgs.msg._temperature", (char *)PyUnicode_1BYTE_DATA(module_attr), 28) == 0);
    assert(strncmp("Temperature", (char *)PyUnicode_1BYTE_DATA(name_attr), 11) == 0);
