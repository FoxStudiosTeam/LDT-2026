...
class Metaclass_MagneticField(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class MagneticFieldConstants(typing.TypedDict):
        pass

    __constants: MagneticFieldConstants = {
    }
...
class MagneticField(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_MagneticField):
    ...
    def __init__(self, *,
                 ...
                 magnetic_field: typing.Optional[geometry_msgs.msg.Vector3] = None,  # noqa: E501
                 magnetic_field_covariance: typing.Optional[typing.Union[numpy.typing.NDArray[numpy.float64], collections.abc.Sequence[float]]] = None,  # noqa: E501
        ...
        from geometry_msgs.msg import Vector3
        self.magnetic_field = magnetic_field if magnetic_field is not None else Vector3()
        if magnetic_field_covariance is None:
    ...
    @builtins.property
    def magnetic_field_covariance(self) -> typing.Annotated[typing.Any, numpy.typing.NDArray[numpy.float64]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'magnetic_field_covariance'."""
        return self._magnetic_field_covariance

    @magnetic_field_covariance.setter
    def magnetic_field_covariance(self, value: typing.Union[numpy.typing.NDArray[numpy.float64], collections.abc.Sequence[float]]) -> None:
        ...
        if self._check_fields:
            if isinstance(value, numpy.ndarray):
                ...
                assert \
                    ...
                    "The 'magnetic_field_covariance' field must be sequence with length 9 and each value of type 'float' and each double in [-.000000, .000000]"
