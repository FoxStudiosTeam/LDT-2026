...
class Metaclass_CompressedImage(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class CompressedImageConstants(typing.TypedDict):
        pass

    __constants: CompressedImageConstants = {
    }
...
class CompressedImage(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_CompressedImage):
    ...
    def __init__(self, *,
                 ...
                 format: typing.Optional[str] = None,  # noqa: E501, A002
    ...
    def format(self, value: str) -> None:  # noqa: A003
