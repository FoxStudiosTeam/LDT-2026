...
bool sensor_msgs__msg__time_reference__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sensor_msgs.msg._time_reference", (char *)PyUnicode_1BYTE_DATA(module_attr), 31) == 0);
    assert(strncmp("TimeReference", (char *)PyUnicode_1BYTE_DATA(name_attr), 13) == 0);
