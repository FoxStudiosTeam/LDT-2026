...
bool sensor_msgs__msg__joy_feedback_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sensor_msgs.msg._joy_feedback_array", (char *)PyUnicode_1BYTE_DATA(module_attr), 35) == 0);
    assert(strncmp("JoyFeedbackArray", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);
