...
bool sensor_msgs__msg__point_field__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sensor_msgs.msg._point_field", (char *)PyUnicode_1BYTE_DATA(module_attr), 28) == 0);
    assert(strncmp("PointField", (char *)PyUnicode_1BYTE_DATA(name_attr), 10) == 0);
