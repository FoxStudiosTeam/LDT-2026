...
class Metaclass_MultiEchoLaserScan(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class MultiEchoLaserScanConstants(typing.TypedDict):
        pass

    __constants: MultiEchoLaserScanConstants = {
    }
    ...
    def __import_type_support__(cls) -> None:
        try:
            ...
            if LaserEcho._TYPE_SUPPORT is None:
                LaserEcho.__import_type_support__()
...
class MultiEchoLaserScan(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_MultiEchoLaserScan):
    ...
    def __init__(self, *,
                 ...
                 angle_min: typing.Optional[float] = None,  # noqa: E501
                 angle_max: typing.Optional[float] = None,  # noqa: E501
                 angle_increment: typing.Optional[float] = None,  # noqa: E501
                 time_increment: typing.Optional[float] = None,  # noqa: E501
                 scan_time: typing.Optional[float] = None,  # noqa: E501
                 range_min: typing.Optional[float] = None,  # noqa: E501
                 range_max: typing.Optional[float] = None,  # noqa: E501
                 ranges: typing.Optional[collections.abc.Sequence[sensor_msgs.msg.LaserEcho]] = None,  # noqa: E501
                 intensities: typing.Optional[collections.abc.Sequence[sensor_msgs.msg.LaserEcho]] = None,  # noqa: E501
        ...
        self.angle_min = angle_min if angle_min is not None else float()
        self.angle_max = angle_max if angle_max is not None else float()
        self.angle_increment = angle_increment if angle_increment is not None else float()
        self.time_increment = time_increment if time_increment is not None else float()
        self.scan_time = scan_time if scan_time is not None else float()
        self.range_min = range_min if range_min is not None else float()
        self.range_max = range_max if range_max is not None else float()
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, MultiEchoLaserScan):
            return False
    ...
    @builtins.property
    def ranges(self) -> typing.Annotated[typing.Any, list[sensor_msgs.msg.LaserEcho]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'ranges'."""
        return self._ranges

    @ranges.setter
    def ranges(self, value: collections.abc.Sequence[sensor_msgs.msg.LaserEcho]) -> None:
            ...
            if False:  # Done for templating alignment
                ...
                assert \
                    ((isinstance(value, collections.abc.Sequence) or
                     ...
                     True), \
                    "The 'ranges' field must be sequence and each value of type 'LaserEcho'"

        if isinstance(value, list):
            self._ranges = value
            return
        self._ranges = list(value)

    @builtins.property
    def intensities(self) -> typing.Annotated[typing.Any, list[sensor_msgs.msg.LaserEcho]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'intensities'."""
        return self._intensities

    @intensities.setter
    def intensities(self, value: collections.abc.Sequence[sensor_msgs.msg.LaserEcho]) -> None:
        if isinstance(value, collections.abc.Set):
            import warnings
            warnings.warn(
                'Using set or subclass of set is deprecated,'
            ...
            if False:  # Done for templating alignment
                ...
                assert \
                    ((isinstance(value, collections.abc.Sequence) or
                     ...
                     all(isinstance(v, LaserEcho) for v in value) and
                     True), \
                    "The 'intensities' field must be sequence and each value of type 'LaserEcho'"

        if isinstance(value, list):
            self._intensities = value
            return
        self._intensities = list(value)
