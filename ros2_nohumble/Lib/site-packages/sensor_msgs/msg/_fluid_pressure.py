...
class Metaclass_FluidPressure(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class FluidPressureConstants(typing.TypedDict):
        pass

    __constants: FluidPressureConstants = {
    }
...
class FluidPressure(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_FluidPressure):
    ...
    def __init__(self, *,
                 ...
                 fluid_pressure: typing.Optional[float] = None,  # noqa: E501
                 variance: typing.Optional[float] = None,  # noqa: E501
        ...
        self.fluid_pressure = fluid_pressure if fluid_pressure is not None else float()
        self.variance = variance if variance is not None else float()
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, FluidPressure):
            return False
