...
bool sensor_msgs__msg__magnetic_field__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sensor_msgs.msg._magnetic_field", (char *)PyUnicode_1BYTE_DATA(module_attr), 31) == 0);
    assert(strncmp("MagneticField", (char *)PyUnicode_1BYTE_DATA(name_attr), 13) == 0);
