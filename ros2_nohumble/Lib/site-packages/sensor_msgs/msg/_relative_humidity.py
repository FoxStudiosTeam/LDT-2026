...
class Metaclass_RelativeHumidity(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class RelativeHumidityConstants(typing.TypedDict):
        pass

    __constants: RelativeHumidityConstants = {
    }
...
class RelativeHumidity(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_RelativeHumidity):
    ...
    def __init__(self, *,
                 ...
                 relative_humidity: typing.Optional[float] = None,  # noqa: E501
        ...
        self.relative_humidity = relative_humidity if relative_humidity is not None else float()
