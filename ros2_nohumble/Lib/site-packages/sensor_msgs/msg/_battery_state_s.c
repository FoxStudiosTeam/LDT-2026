...
bool sensor_msgs__msg__battery_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sensor_msgs.msg._battery_state", (char *)PyUnicode_1BYTE_DATA(module_attr), 30) == 0);
    assert(strncmp("BatteryState", (char *)PyUnicode_1BYTE_DATA(name_attr), 12) == 0);
