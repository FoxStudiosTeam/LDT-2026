...
bool sensor_msgs__msg__multi_echo_laser_scan__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sensor_msgs.msg._multi_echo_laser_scan", (char *)PyUnicode_1BYTE_DATA(module_attr), 38) == 0);
    assert(strncmp("MultiEchoLaserScan", (char *)PyUnicode_1BYTE_DATA(name_attr), 18) == 0);
