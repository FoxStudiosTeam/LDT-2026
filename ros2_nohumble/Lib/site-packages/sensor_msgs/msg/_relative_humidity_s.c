...
bool sensor_msgs__msg__relative_humidity__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sensor_msgs.msg._relative_humidity", (char *)PyUnicode_1BYTE_DATA(module_attr), 34) == 0);
    assert(strncmp("RelativeHumidity", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);
