...
bool sensor_msgs__msg__compressed_image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sensor_msgs.msg._compressed_image", (char *)PyUnicode_1BYTE_DATA(module_attr), 33) == 0);
    assert(strncmp("CompressedImage", (char *)PyUnicode_1BYTE_DATA(name_attr), 15) == 0);
