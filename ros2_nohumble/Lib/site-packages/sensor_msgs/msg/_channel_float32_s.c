...
bool sensor_msgs__msg__channel_float32__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sensor_msgs.msg._channel_float32", (char *)PyUnicode_1BYTE_DATA(module_attr), 32) == 0);
    assert(strncmp("ChannelFloat32", (char *)PyUnicode_1BYTE_DATA(name_attr), 14) == 0);
