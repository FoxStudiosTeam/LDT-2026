...
class Metaclass_Temperature(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class TemperatureConstants(typing.TypedDict):
        pass

    __constants: TemperatureConstants = {
    }
...
class Temperature(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_Temperature):
