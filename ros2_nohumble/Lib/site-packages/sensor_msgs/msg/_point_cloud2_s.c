...
bool sensor_msgs__msg__point_cloud2__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sensor_msgs.msg._point_cloud2", (char *)PyUnicode_1BYTE_DATA(module_attr), 29) == 0);
    assert(strncmp("PointCloud2", (char *)PyUnicode_1BYTE_DATA(name_attr), 11) == 0);
