...
class Metaclass_JoyFeedbackArray(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class JoyFeedbackArrayConstants(typing.TypedDict):
        pass

    __constants: JoyFeedbackArrayConstants = {
    }
    ...
    def __import_type_support__(cls) -> None:
        try:
            ...
            if JoyFeedback._TYPE_SUPPORT is None:
                JoyFeedback.__import_type_support__()
...
class JoyFeedbackArray(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_JoyFeedbackArray):
    ...
    def __init__(self, *,
                 array: typing.Optional[collections.abc.Sequence[sensor_msgs.msg.JoyFeedback]] = None,  # noqa: E501
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, JoyFeedbackArray):
            return False
    ...
    @builtins.property
    def array(self) -> typing.Annotated[typing.Any, list[sensor_msgs.msg.JoyFeedback]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'array'."""
        return self._array

    @array.setter
    def array(self, value: collections.abc.Sequence[sensor_msgs.msg.JoyFeedback]) -> None:
            ...
            if False:  # Done for templating alignment
                ...
                assert \
                    ((isinstance(value, collections.abc.Sequence) or
                     ...
                     True), \
                    "The 'array' field must be sequence and each value of type 'JoyFeedback'"
