...
bool sensor_msgs__msg__nav_sat_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sensor_msgs.msg._nav_sat_status", (char *)PyUnicode_1BYTE_DATA(module_attr), 31) == 0);
    assert(strncmp("NavSatStatus", (char *)PyUnicode_1BYTE_DATA(name_attr), 12) == 0);
