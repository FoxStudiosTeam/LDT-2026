...
class Metaclass_PointCloud(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class PointCloudConstants(typing.TypedDict):
        pass

    __constants: PointCloudConstants = {
    }
    ...
    def __import_type_support__(cls) -> None:
        try:
            ...
            if ChannelFloat32._TYPE_SUPPORT is None:
                ChannelFloat32.__import_type_support__()
...
class PointCloud(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_PointCloud):
    ...
    def __init__(self, *,
                 ...
                 channels: typing.Optional[collections.abc.Sequence[sensor_msgs.msg.ChannelFloat32]] = None,  # noqa: E501
    ...
    @builtins.property
    def channels(self) -> typing.Annotated[typing.Any, list[sensor_msgs.msg.ChannelFloat32]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'channels'."""
        return self._channels

    @channels.setter
    def channels(self, value: collections.abc.Sequence[sensor_msgs.msg.ChannelFloat32]) -> None:
        if isinstance(value, collections.abc.Set):
            import warnings
            warnings.warn(
                'Using set or subclass of set is deprecated,'
            ...
            if False:  # Done for templating alignment
                ...
                assert \
                    ((isinstance(value, collections.abc.Sequence) or
                     ...
                     True), \
                    "The 'channels' field must be sequence and each value of type 'ChannelFloat32'"
