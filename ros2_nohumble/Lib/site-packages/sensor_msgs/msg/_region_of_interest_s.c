...
bool sensor_msgs__msg__region_of_interest__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sensor_msgs.msg._region_of_interest", (char *)PyUnicode_1BYTE_DATA(module_attr), 35) == 0);
    assert(strncmp("RegionOfInterest", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);
