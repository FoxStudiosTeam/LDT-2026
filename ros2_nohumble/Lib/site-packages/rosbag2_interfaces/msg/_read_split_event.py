...
class Metaclass_ReadSplitEvent(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class ReadSplitEventConstants(typing.TypedDict):
        pass

    __constants: ReadSplitEventConstants = {
    }
...
class ReadSplitEvent(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_ReadSplitEvent):
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, ReadSplitEvent):
            return False
