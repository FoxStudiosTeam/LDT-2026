...
bool rosbag2_interfaces__msg__write_split_event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rosbag2_interfaces.msg._write_split_event", (char *)PyUnicode_1BYTE_DATA(module_attr), 41) == 0);
    assert(strncmp("WriteSplitEvent", (char *)PyUnicode_1BYTE_DATA(name_attr), 15) == 0);
