...
class Metaclass_PoseArray(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class PoseArrayConstants(typing.TypedDict):
        pass

    __constants: PoseArrayConstants = {
    }
...
class PoseArray(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_PoseArray):
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, PoseArray):
            return False
