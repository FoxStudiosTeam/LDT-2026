...
bool geometry_msgs__msg__twist_with_covariance_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("geometry_msgs.msg._twist_with_covariance_stamped", (char *)PyUnicode_1BYTE_DATA(module_attr), 48) == 0);
    assert(strncmp("TwistWithCovarianceStamped", (char *)PyUnicode_1BYTE_DATA(name_attr), 26) == 0);
