...
class Metaclass_TwistWithCovarianceStamped(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class TwistWithCovarianceStampedConstants(typing.TypedDict):
        pass

    __constants: TwistWithCovarianceStampedConstants = {
    }
...
class TwistWithCovarianceStamped(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_TwistWithCovarianceStamped):
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, TwistWithCovarianceStamped):
            return False
