...
bool geometry_msgs__msg__inertia_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("geometry_msgs.msg._inertia_stamped", (char *)PyUnicode_1BYTE_DATA(module_attr), 34) == 0);
    assert(strncmp("InertiaStamped", (char *)PyUnicode_1BYTE_DATA(name_attr), 14) == 0);
