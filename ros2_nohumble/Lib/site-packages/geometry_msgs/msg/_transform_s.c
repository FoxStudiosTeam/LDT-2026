...
bool geometry_msgs__msg__transform__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("geometry_msgs.msg._transform", (char *)PyUnicode_1BYTE_DATA(module_attr), 28) == 0);
    assert(strncmp("Transform", (char *)PyUnicode_1BYTE_DATA(name_attr), 9) == 0);
