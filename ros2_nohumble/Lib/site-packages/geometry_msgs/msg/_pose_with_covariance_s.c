...
bool geometry_msgs__msg__pose_with_covariance__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("geometry_msgs.msg._pose_with_covariance", (char *)PyUnicode_1BYTE_DATA(module_attr), 39) == 0);
    assert(strncmp("PoseWithCovariance", (char *)PyUnicode_1BYTE_DATA(name_attr), 18) == 0);
