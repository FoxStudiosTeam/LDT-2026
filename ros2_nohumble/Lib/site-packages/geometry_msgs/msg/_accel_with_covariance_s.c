...
bool geometry_msgs__msg__accel_with_covariance__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("geometry_msgs.msg._accel_with_covariance", (char *)PyUnicode_1BYTE_DATA(module_attr), 40) == 0);
    assert(strncmp("AccelWithCovariance", (char *)PyUnicode_1BYTE_DATA(name_attr), 19) == 0);
