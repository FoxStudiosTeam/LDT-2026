...
bool geometry_msgs__msg__transform_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("geometry_msgs.msg._transform_stamped", (char *)PyUnicode_1BYTE_DATA(module_attr), 36) == 0);
    assert(strncmp("TransformStamped", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);
