...
bool geometry_msgs__msg__quaternion__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("geometry_msgs.msg._quaternion", (char *)PyUnicode_1BYTE_DATA(module_attr), 29) == 0);
    assert(strncmp("Quaternion", (char *)PyUnicode_1BYTE_DATA(name_attr), 10) == 0);
