...
bool geometry_msgs__msg__quaternion_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("geometry_msgs.msg._quaternion_stamped", (char *)PyUnicode_1BYTE_DATA(module_attr), 37) == 0);
    assert(strncmp("QuaternionStamped", (char *)PyUnicode_1BYTE_DATA(name_attr), 17) == 0);
