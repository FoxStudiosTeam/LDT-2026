...
class Metaclass_Quaternion(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class QuaternionConstants(typing.TypedDict):
        pass

    __constants: QuaternionConstants = {
    }
    ...
    @property
    def X__DEFAULT(cls) -> float:
        """Return default value for message field 'x'."""
        return 0.0

    @property
    def Y__DEFAULT(cls) -> float:
        """Return default value for message field 'y'."""
        return 0.0

    @property
    def Z__DEFAULT(cls) -> float:
        """Return default value for message field 'z'."""
        return 0.0

    @property
    def W__DEFAULT(cls) -> float:
        """Return default value for message field 'w'."""
        return 1.0


class Quaternion(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_Quaternion):
    ...
    def __init__(self, *,
                 ...
                 w: typing.Optional[float] = None,  # noqa: E501
                 check_fields: typing.Optional[bool] = None) -> None:
        if check_fields is not None:
            self._check_fields = check_fields
        else:
            self._check_fields = ros_python_check_fields == '1'
        self.x = x if x is not None else Quaternion.X__DEFAULT
        self.y = y if y is not None else Quaternion.Y__DEFAULT
        self.z = z if z is not None else Quaternion.Z__DEFAULT
        self.w = w if w is not None else Quaternion.W__DEFAULT
