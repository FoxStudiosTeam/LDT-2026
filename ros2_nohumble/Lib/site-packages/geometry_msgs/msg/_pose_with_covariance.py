...
class Metaclass_PoseWithCovariance(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class PoseWithCovarianceConstants(typing.TypedDict):
        pass

    __constants: PoseWithCovarianceConstants = {
    }
...
class PoseWithCovariance(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_PoseWithCovariance):
