...
bool trajectory_msgs__msg__multi_dof_joint_trajectory_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("trajectory_msgs.msg._multi_dof_joint_trajectory_point", (char *)PyUnicode_1BYTE_DATA(module_attr), 53) == 0);
    assert(strncmp("MultiDOFJointTrajectoryPoint", (char *)PyUnicode_1BYTE_DATA(name_attr), 28) == 0);
