...
bool trajectory_msgs__msg__joint_trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("trajectory_msgs.msg._joint_trajectory", (char *)PyUnicode_1BYTE_DATA(module_attr), 37) == 0);
    assert(strncmp("JointTrajectory", (char *)PyUnicode_1BYTE_DATA(name_attr), 15) == 0);
