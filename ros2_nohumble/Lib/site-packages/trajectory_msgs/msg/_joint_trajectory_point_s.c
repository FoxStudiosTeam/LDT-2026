...
bool trajectory_msgs__msg__joint_trajectory_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("trajectory_msgs.msg._joint_trajectory_point", (char *)PyUnicode_1BYTE_DATA(module_attr), 43) == 0);
    assert(strncmp("JointTrajectoryPoint", (char *)PyUnicode_1BYTE_DATA(name_attr), 20) == 0);
