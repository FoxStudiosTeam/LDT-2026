...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema"
    ...
    <xs:complexType name="DomainRule">
        <xs:sequence minOccurs="1" maxOccurs="1">
            ...
            <xs:element name="allow_unauthenticated_participants" type="xs:boolean" /> <!-- DDSSEC-130 -->
            <xs:element name="enable_join_access_control" type="xs:boolean" /> <!-- DDSSEC-130 -->
    ...
    <!--  DDSSEC-130 removed BooleanKind
    ...
    <xs:complexType name="TopicRule">
        <xs:sequence minOccurs="1" maxOccurs="1">
            ...
            <xs:element name="enable_discovery_protection" type="xs:boolean" /> <!-- DDSSEC-130 -->
            <!-- DDSSEC11-85 -->
            <xs:element name="enable_liveliness_protection" type="xs:boolean" />
            <xs:element name="enable_read_access_control" type="xs:boolean" />  <!-- DDSSEC-130 -->
            <xs:element name="enable_write_access_control" type="xs:boolean" /> <!-- DDSSEC-130 -->
