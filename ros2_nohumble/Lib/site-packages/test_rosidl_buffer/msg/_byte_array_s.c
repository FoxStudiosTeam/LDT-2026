...
bool test_rosidl_buffer__msg__byte_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("test_rosidl_buffer.msg._byte_array", (char *)PyUnicode_1BYTE_DATA(module_attr), 34) == 0);
  ...
  test_rosidl_buffer__msg__ByteArray * ros_message = _ros_message;
  {  // seq
...
PyObject * test_rosidl_buffer__msg__byte_array__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("test_rosidl_buffer.msg._byte_array");
