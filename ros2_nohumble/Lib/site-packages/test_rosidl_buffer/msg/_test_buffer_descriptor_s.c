...
bool test_rosidl_buffer__msg__test_buffer_descriptor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("test_rosidl_buffer.msg._test_buffer_descriptor", (char *)PyUnicode_1BYTE_DATA(module_attr), 46) == 0);
    assert(strncmp("TestBufferDescriptor", (char *)PyUnicode_1BYTE_DATA(name_attr), 20) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  test_rosidl_buffer__msg__TestBufferDescriptor * ros_message = _ros_message;
  {  // size
  ...
  {  // data_hash
    PyObject * field = PyObject_GetAttrString(_pymsg, "data_hash");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->data_hash = PyLong_AsUnsignedLongLong(field);
    Py_DECREF(field);
  }
  {  // data
...
{
  /* NOTE(esteve): Call constructor of TestBufferDescriptor */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("test_rosidl_buffer.msg._test_buffer_descriptor");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TestBufferDescriptor");
  ...
  {  // data_hash
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLongLong(ros_message->data_hash);
    {
      int rc = PyObject_SetAttrString(_pymessage, "data_hash", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
