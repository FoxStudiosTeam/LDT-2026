...
bool test_msgs__srv__basic_types__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("test_msgs.srv._basic_types", (char *)PyUnicode_1BYTE_DATA(module_attr), 26) == 0);
    assert(strncmp("BasicTypes_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 18) == 0);
...
bool test_msgs__srv__basic_types__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("test_msgs.srv._basic_types", (char *)PyUnicode_1BYTE_DATA(module_attr), 26) == 0);
    assert(strncmp("BasicTypes_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 19) == 0);
...
bool test_msgs__srv__basic_types__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("test_msgs.srv._basic_types", (char *)PyUnicode_1BYTE_DATA(module_attr), 26) == 0);
    assert(strncmp("BasicTypes_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);
