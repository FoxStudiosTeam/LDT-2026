...
bool test_msgs__srv__arrays__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("test_msgs.srv._arrays", (char *)PyUnicode_1BYTE_DATA(module_attr), 21) == 0);
    assert(strncmp("Arrays_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 14) == 0);
...
bool test_msgs__srv__arrays__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("test_msgs.srv._arrays", (char *)PyUnicode_1BYTE_DATA(module_attr), 21) == 0);
    assert(strncmp("Arrays_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 15) == 0);
...
bool test_msgs__srv__arrays__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("test_msgs.srv._arrays", (char *)PyUnicode_1BYTE_DATA(module_attr), 21) == 0);
    assert(strncmp("Arrays_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 12) == 0);
