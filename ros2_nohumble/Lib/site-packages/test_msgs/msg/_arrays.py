...
class Metaclass_Arrays(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class ArraysConstants(typing.TypedDict):
        pass

    __constants: ArraysConstants = {
    }
...
class Arrays(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_Arrays):
    ...
    def __init__(self, *,
        ...
        self.bool_values_default = bool_values_default if bool_values_default is not None else Arrays.BOOL_VALUES_DEFAULT__DEFAULT
        self.byte_values_default = byte_values_default if byte_values_default is not None else Arrays.BYTE_VALUES_DEFAULT__DEFAULT
        self.char_values_default = char_values_default if char_values_default is not None else Arrays.CHAR_VALUES_DEFAULT__DEFAULT
        self.float32_values_default = float32_values_default if float32_values_default is not None else Arrays.FLOAT32_VALUES_DEFAULT__DEFAULT
        self.float64_values_default = float64_values_default if float64_values_default is not None else Arrays.FLOAT64_VALUES_DEFAULT__DEFAULT
        self.int8_values_default = int8_values_default if int8_values_default is not None else Arrays.INT8_VALUES_DEFAULT__DEFAULT
        self.uint8_values_default = uint8_values_default if uint8_values_default is not None else Arrays.UINT8_VALUES_DEFAULT__DEFAULT
        self.int16_values_default = int16_values_default if int16_values_default is not None else Arrays.INT16_VALUES_DEFAULT__DEFAULT
        self.uint16_values_default = uint16_values_default if uint16_values_default is not None else Arrays.UINT16_VALUES_DEFAULT__DEFAULT
        self.int32_values_default = int32_values_default if int32_values_default is not None else Arrays.INT32_VALUES_DEFAULT__DEFAULT
        self.uint32_values_default = uint32_values_default if uint32_values_default is not None else Arrays.UINT32_VALUES_DEFAULT__DEFAULT
        self.int64_values_default = int64_values_default if int64_values_default is not None else Arrays.INT64_VALUES_DEFAULT__DEFAULT
        self.uint64_values_default = uint64_values_default if uint64_values_default is not None else Arrays.UINT64_VALUES_DEFAULT__DEFAULT
        self.string_values_default = string_values_default if string_values_default is not None else Arrays.STRING_VALUES_DEFAULT__DEFAULT
