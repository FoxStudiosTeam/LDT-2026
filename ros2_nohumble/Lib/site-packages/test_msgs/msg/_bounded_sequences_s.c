...
bool test_msgs__msg__bounded_sequences__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("test_msgs.msg._bounded_sequences", (char *)PyUnicode_1BYTE_DATA(module_attr), 32) == 0);
    assert(strncmp("BoundedSequences", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);
