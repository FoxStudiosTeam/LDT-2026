...
bool test_msgs__msg__unbounded_sequences__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("test_msgs.msg._unbounded_sequences", (char *)PyUnicode_1BYTE_DATA(module_attr), 34) == 0);
    assert(strncmp("UnboundedSequences", (char *)PyUnicode_1BYTE_DATA(name_attr), 18) == 0);
          ...
          if (rosidl_buffer_mod != NULL) {
            ...
            if (get_ptr_func != NULL) {
              ...
              if (ptr_result != NULL) {
                ...
                ros_message->char_values.data = (uint8_t *)buffer_ptr;
                ros_message->char_values.size = 0;
                ros_message->char_values.capacity = 0;
                ros_message->char_values.is_rosidl_buffer = true;
                ros_message->char_values.owns_rosidl_buffer = false;
        ...
        if (backend_str != NULL && strcmp(backend_str, "cpu") != 0) {
          ...
          if (rosidl_buffer_mod != NULL) {
            ...
            if (get_ptr_func != NULL) {
              ...
              if (ptr_result != NULL) {
                uintptr_t buffer_ptr = (uintptr_t)PyLong_AsUnsignedLongLong(ptr_result);
                ros_message->uint8_values.data = (uint8_t *)buffer_ptr;
                ros_message->uint8_values.size = 0;
                ros_message->uint8_values.capacity = 0;
                ros_message->uint8_values.is_rosidl_buffer = true;
                ros_message->uint8_values.owns_rosidl_buffer = false;
                Py_DECREF(ptr_result);
              }
              Py_DECREF(get_ptr_func);
            }
        ...
        if (backend_str != NULL && strcmp(backend_str, "cpu") != 0) {
          ...
          if (rosidl_buffer_mod != NULL) {
            ...
            if (get_ptr_func != NULL) {
              ...
              if (ptr_result != NULL) {
                uintptr_t buffer_ptr = (uintptr_t)PyLong_AsUnsignedLongLong(ptr_result);
                ros_message->char_values_default.data = (uint8_t *)buffer_ptr;
                ros_message->char_values_default.size = 0;
                ros_message->char_values_default.capacity = 0;
                ros_message->char_values_default.is_rosidl_buffer = true;
                ros_message->char_values_default.owns_rosidl_buffer = false;
                Py_DECREF(ptr_result);
              }
              Py_DECREF(get_ptr_func);
            }
          ...
          Py_DECREF(field);
          // Sentinel is set, skip normal conversion for this field
          goto char_values_default__done;
        }
        Py_DECREF(backend_attr);
      } else {
        PyErr_Clear();
        ...
        if (backend_str != NULL && strcmp(backend_str, "cpu") != 0) {
          ...
          if (rosidl_buffer_mod != NULL) {
            ...
            if (get_ptr_func != NULL) {
              ...
              if (ptr_result != NULL) {
                uintptr_t buffer_ptr = (uintptr_t)PyLong_AsUnsignedLongLong(ptr_result);
                ros_message->uint8_values_default.data = (uint8_t *)buffer_ptr;
                ros_message->uint8_values_default.size = 0;
                ros_message->uint8_values_default.capacity = 0;
                ros_message->uint8_values_default.is_rosidl_buffer = true;
                ros_message->uint8_values_default.owns_rosidl_buffer = false;
                Py_DECREF(ptr_result);
              }
              Py_DECREF(get_ptr_func);
            }
          ...
          Py_DECREF(field);
          // Sentinel is set, skip normal conversion for this field
          goto uint8_values_default__done;
        }
        Py_DECREF(backend_attr);
      } else {
        PyErr_Clear();
...
PyObject * test_msgs__msg__unbounded_sequences__convert_to_py(void * raw_ros_message)
{
  ...
  {  // char_values
    ...
    if (ros_message->char_values.is_rosidl_buffer) {
      ...
      if (rosidl_buffer_internal != NULL) {
        ...
        if (take_func != NULL) {
          PyObject * ptr_arg = PyLong_FromUnsignedLongLong(
            (uint64_t)(uintptr_t)ros_message->char_values.data);
          ...
          if (field != NULL) {
            ...
            ros_message->char_values.data = NULL;
            ros_message->char_values.size = 0;
            ros_message->char_values.capacity = 0;
      ...
      if (PyObject_SetAttrString(_pymessage, "char_values", field) == -1) {
        Py_DECREF(field);
        return NULL;
      }
      Py_DECREF(field);
  ...
  {  // uint8_values
    ...
    if (ros_message->uint8_values.is_rosidl_buffer) {
      ...
      if (rosidl_buffer_internal != NULL) {
        ...
        if (take_func != NULL) {
          PyObject * ptr_arg = PyLong_FromUnsignedLongLong(
            (uint64_t)(uintptr_t)ros_message->uint8_values.data);
          field = PyObject_CallFunctionObjArgs(take_func, ptr_arg, NULL);
          Py_XDECREF(ptr_arg);
          Py_DECREF(take_func);
          if (field != NULL) {
            // Ownership transferred to Python â€” clear the C sequence immediately
            ros_message->uint8_values.data = NULL;
            ros_message->uint8_values.size = 0;
            ros_message->uint8_values.capacity = 0;
      ...
      // Set the Buffer on the Python message object
      if (PyObject_SetAttrString(_pymessage, "uint8_values", field) == -1) {
        Py_DECREF(field);
        return NULL;
      }
      Py_DECREF(field);
  ...
  {  // char_values_default
    ...
    if (ros_message->char_values_default.is_rosidl_buffer) {
      ...
      if (rosidl_buffer_internal != NULL) {
        ...
        if (take_func != NULL) {
          PyObject * ptr_arg = PyLong_FromUnsignedLongLong(
            (uint64_t)(uintptr_t)ros_message->char_values_default.data);
          field = PyObject_CallFunctionObjArgs(take_func, ptr_arg, NULL);
          Py_XDECREF(ptr_arg);
          Py_DECREF(take_func);
          if (field != NULL) {
            // Ownership transferred to Python â€” clear the C sequence immediately
            ros_message->char_values_default.data = NULL;
            ros_message->char_values_default.size = 0;
            ros_message->char_values_default.capacity = 0;
      ...
      // Set the Buffer on the Python message object
      if (PyObject_SetAttrString(_pymessage, "char_values_default", field) == -1) {
        Py_DECREF(field);
        return NULL;
      }
      Py_DECREF(field);
  ...
  {  // uint8_values_default
    ...
    if (ros_message->uint8_values_default.is_rosidl_buffer) {
      ...
      if (rosidl_buffer_internal != NULL) {
        ...
        if (take_func != NULL) {
          PyObject * ptr_arg = PyLong_FromUnsignedLongLong(
            (uint64_t)(uintptr_t)ros_message->uint8_values_default.data);
          field = PyObject_CallFunctionObjArgs(take_func, ptr_arg, NULL);
          Py_XDECREF(ptr_arg);
          Py_DECREF(take_func);
          if (field != NULL) {
            // Ownership transferred to Python â€” clear the C sequence immediately
            ros_message->uint8_values_default.data = NULL;
            ros_message->uint8_values_default.size = 0;
            ros_message->uint8_values_default.capacity = 0;
      ...
      // Set the Buffer on the Python message object
      if (PyObject_SetAttrString(_pymessage, "uint8_values_default", field) == -1) {
        Py_DECREF(field);
        return NULL;
      }
      Py_DECREF(field);
