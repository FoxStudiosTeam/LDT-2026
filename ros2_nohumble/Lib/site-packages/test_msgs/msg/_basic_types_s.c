...
bool test_msgs__msg__basic_types__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("test_msgs.msg._basic_types", (char *)PyUnicode_1BYTE_DATA(module_attr), 26) == 0);
    assert(strncmp("BasicTypes", (char *)PyUnicode_1BYTE_DATA(name_attr), 10) == 0);
