...
bool test_msgs__msg__bounded_plain_sequences__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("test_msgs.msg._bounded_plain_sequences", (char *)PyUnicode_1BYTE_DATA(module_attr), 38) == 0);
    assert(strncmp("BoundedPlainSequences", (char *)PyUnicode_1BYTE_DATA(name_attr), 21) == 0);
