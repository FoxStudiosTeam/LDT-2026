...
class Metaclass_Defaults(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class DefaultsConstants(typing.TypedDict):
        pass

    __constants: DefaultsConstants = {
    }
    ...
    @property
    def BOOL_VALUE__DEFAULT(cls) -> typing.Literal[True]:
        """Return default value for message field 'bool_value'."""
        return True

    @property
    def BYTE_VALUE__DEFAULT(cls) -> bytes:
        """Return default value for message field 'byte_value'."""
        return b'2'

    @property
    def CHAR_VALUE__DEFAULT(cls) -> typing.Literal[100]:
        """Return default value for message field 'char_value'."""
        return 100

    @property
    def FLOAT32_VALUE__DEFAULT(cls) -> float:
        """Return default value for message field 'float32_value'."""
        return 1.125

    @property
    def FLOAT64_VALUE__DEFAULT(cls) -> float:
        """Return default value for message field 'float64_value'."""
        return 1.125

    @property
    def INT8_VALUE__DEFAULT(cls) -> typing.Literal[-50]:
        """Return default value for message field 'int8_value'."""
        return -50

    @property
    def UINT8_VALUE__DEFAULT(cls) -> typing.Literal[200]:
        """Return default value for message field 'uint8_value'."""
        return 200

    @property
    def INT16_VALUE__DEFAULT(cls) -> typing.Literal[-1000]:
        """Return default value for message field 'int16_value'."""
        return -1000

    @property
    def UINT16_VALUE__DEFAULT(cls) -> typing.Literal[2000]:
        """Return default value for message field 'uint16_value'."""
        return 2000

    @property
    def INT32_VALUE__DEFAULT(cls) -> typing.Literal[-30000]:
        """Return default value for message field 'int32_value'."""
        return -30000

    @property
    def UINT32_VALUE__DEFAULT(cls) -> typing.Literal[60000]:
        """Return default value for message field 'uint32_value'."""
        return 60000

    @property
    def INT64_VALUE__DEFAULT(cls) -> typing.Literal[-40000000]:
        """Return default value for message field 'int64_value'."""
        return -40000000

    @property
    def UINT64_VALUE__DEFAULT(cls) -> typing.Literal[50000000]:
        """Return default value for message field 'uint64_value'."""
        return 50000000


class Defaults(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_Defaults):
    ...
    def __init__(self, *,
                 bool_value: typing.Optional[bool] = None,  # noqa: E501
                 byte_value: typing.Optional[typing.Union[bytes, collections.abc.ByteString]] = None,  # noqa: E501
                 char_value: typing.Optional[int] = None,  # noqa: E501
                 float32_value: typing.Optional[float] = None,  # noqa: E501
                 float64_value: typing.Optional[float] = None,  # noqa: E501
                 int8_value: typing.Optional[int] = None,  # noqa: E501
                 uint8_value: typing.Optional[int] = None,  # noqa: E501
                 int16_value: typing.Optional[int] = None,  # noqa: E501
                 uint16_value: typing.Optional[int] = None,  # noqa: E501
                 int32_value: typing.Optional[int] = None,  # noqa: E501
                 uint32_value: typing.Optional[int] = None,  # noqa: E501
                 int64_value: typing.Optional[int] = None,  # noqa: E501
                 uint64_value: typing.Optional[int] = None,  # noqa: E501
                 check_fields: typing.Optional[bool] = None) -> None:
        if check_fields is not None:
            self._check_fields = check_fields
        else:
            self._check_fields = ros_python_check_fields == '1'
        self.bool_value = bool_value if bool_value is not None else Defaults.BOOL_VALUE__DEFAULT
        self.byte_value = byte_value if byte_value is not None else Defaults.BYTE_VALUE__DEFAULT
        self.char_value = char_value if char_value is not None else Defaults.CHAR_VALUE__DEFAULT
        self.float32_value = float32_value if float32_value is not None else Defaults.FLOAT32_VALUE__DEFAULT
        self.float64_value = float64_value if float64_value is not None else Defaults.FLOAT64_VALUE__DEFAULT
        self.int8_value = int8_value if int8_value is not None else Defaults.INT8_VALUE__DEFAULT
        self.uint8_value = uint8_value if uint8_value is not None else Defaults.UINT8_VALUE__DEFAULT
        self.int16_value = int16_value if int16_value is not None else Defaults.INT16_VALUE__DEFAULT
        self.uint16_value = uint16_value if uint16_value is not None else Defaults.UINT16_VALUE__DEFAULT
        self.int32_value = int32_value if int32_value is not None else Defaults.INT32_VALUE__DEFAULT
        self.uint32_value = uint32_value if uint32_value is not None else Defaults.UINT32_VALUE__DEFAULT
        self.int64_value = int64_value if int64_value is not None else Defaults.INT64_VALUE__DEFAULT
        self.uint64_value = uint64_value if uint64_value is not None else Defaults.UINT64_VALUE__DEFAULT
    ...
    @builtins.property
    def byte_value(self) -> typing.Union[bytes, collections.abc.ByteString]:
        """Message field 'byte_value'."""
        return self._byte_value

    @byte_value.setter
    def byte_value(self, value: typing.Union[bytes, collections.abc.ByteString]) -> None:
    ...
    @char_value.setter
    def char_value(self, value: int) -> None:
    ...
    def float32_value(self, value: float) -> None:
    ...
    def float64_value(self, value: float) -> None:
    ...
    @int8_value.setter
    def int8_value(self, value: int) -> None:
    ...
    @uint8_value.setter
    def uint8_value(self, value: int) -> None:
    ...
    @int16_value.setter
    def int16_value(self, value: int) -> None:
    ...
    @uint16_value.setter
    def uint16_value(self, value: int) -> None:
    ...
    @int32_value.setter
    def int32_value(self, value: int) -> None:
    ...
    @uint32_value.setter
    def uint32_value(self, value: int) -> None:
    ...
    @int64_value.setter
    def int64_value(self, value: int) -> None:
    ...
    @uint64_value.setter
    def uint64_value(self, value: int) -> None:
