...
class Metaclass_BoundedPlainSequences(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class BoundedPlainSequencesConstants(typing.TypedDict):
        pass

    __constants: BoundedPlainSequencesConstants = {
    }
...
class BoundedPlainSequences(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_BoundedPlainSequences):
    ...
    def __init__(self, *,
        ...
        self.bool_values_default = bool_values_default if bool_values_default is not None else BoundedPlainSequences.BOOL_VALUES_DEFAULT__DEFAULT
        self.byte_values_default = byte_values_default if byte_values_default is not None else BoundedPlainSequences.BYTE_VALUES_DEFAULT__DEFAULT
        self.char_values_default = char_values_default if char_values_default is not None else BoundedPlainSequences.CHAR_VALUES_DEFAULT__DEFAULT
        self.float32_values_default = float32_values_default if float32_values_default is not None else BoundedPlainSequences.FLOAT32_VALUES_DEFAULT__DEFAULT
        self.float64_values_default = float64_values_default if float64_values_default is not None else BoundedPlainSequences.FLOAT64_VALUES_DEFAULT__DEFAULT
        self.int8_values_default = int8_values_default if int8_values_default is not None else BoundedPlainSequences.INT8_VALUES_DEFAULT__DEFAULT
        self.uint8_values_default = uint8_values_default if uint8_values_default is not None else BoundedPlainSequences.UINT8_VALUES_DEFAULT__DEFAULT
        self.int16_values_default = int16_values_default if int16_values_default is not None else BoundedPlainSequences.INT16_VALUES_DEFAULT__DEFAULT
        self.uint16_values_default = uint16_values_default if uint16_values_default is not None else BoundedPlainSequences.UINT16_VALUES_DEFAULT__DEFAULT
        self.int32_values_default = int32_values_default if int32_values_default is not None else BoundedPlainSequences.INT32_VALUES_DEFAULT__DEFAULT
        self.uint32_values_default = uint32_values_default if uint32_values_default is not None else BoundedPlainSequences.UINT32_VALUES_DEFAULT__DEFAULT
        self.int64_values_default = int64_values_default if int64_values_default is not None else BoundedPlainSequences.INT64_VALUES_DEFAULT__DEFAULT
        self.uint64_values_default = uint64_values_default if uint64_values_default is not None else BoundedPlainSequences.UINT64_VALUES_DEFAULT__DEFAULT
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, BoundedPlainSequences):
            return False
