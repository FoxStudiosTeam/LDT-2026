...
bool test_msgs__msg__multi_nested__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("test_msgs.msg._multi_nested", (char *)PyUnicode_1BYTE_DATA(module_attr), 27) == 0);
    assert(strncmp("MultiNested", (char *)PyUnicode_1BYTE_DATA(name_attr), 11) == 0);
