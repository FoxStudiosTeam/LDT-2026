...
bool shape_msgs__msg__solid_primitive__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("shape_msgs.msg._solid_primitive", (char *)PyUnicode_1BYTE_DATA(module_attr), 31) == 0);
    assert(strncmp("SolidPrimitive", (char *)PyUnicode_1BYTE_DATA(name_attr), 14) == 0);
