...
bool shape_msgs__msg__mesh_triangle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("shape_msgs.msg._mesh_triangle", (char *)PyUnicode_1BYTE_DATA(module_attr), 29) == 0);
    assert(strncmp("MeshTriangle", (char *)PyUnicode_1BYTE_DATA(name_attr), 12) == 0);
