...
bool stereo_msgs__msg__disparity_image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("stereo_msgs.msg._disparity_image", (char *)PyUnicode_1BYTE_DATA(module_attr), 32) == 0);
    assert(strncmp("DisparityImage", (char *)PyUnicode_1BYTE_DATA(name_attr), 14) == 0);
