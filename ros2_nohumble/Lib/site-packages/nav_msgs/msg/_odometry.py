...
class Metaclass_Odometry(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class OdometryConstants(typing.TypedDict):
        pass

    __constants: OdometryConstants = {
    }
    ...
    def __import_type_support__(cls) -> None:
        try:
            ...
            if PoseWithCovariance._TYPE_SUPPORT is None:
                PoseWithCovariance.__import_type_support__()
...
class Odometry(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_Odometry):
    ...
    def __init__(self, *,
                 ...
                 child_frame_id: typing.Optional[str] = None,  # noqa: E501
                 pose: typing.Optional[geometry_msgs.msg.PoseWithCovariance] = None,  # noqa: E501
                 twist: typing.Optional[geometry_msgs.msg.TwistWithCovariance] = None,  # noqa: E501
        ...
        self.child_frame_id = child_frame_id if child_frame_id is not None else str()
        from geometry_msgs.msg import PoseWithCovariance
