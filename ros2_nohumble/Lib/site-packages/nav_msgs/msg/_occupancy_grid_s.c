...
bool nav_msgs__msg__occupancy_grid__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav_msgs.msg._occupancy_grid", (char *)PyUnicode_1BYTE_DATA(module_attr), 28) == 0);
    assert(strncmp("OccupancyGrid", (char *)PyUnicode_1BYTE_DATA(name_attr), 13) == 0);
