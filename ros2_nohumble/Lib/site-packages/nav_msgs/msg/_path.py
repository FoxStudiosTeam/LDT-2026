...
class Metaclass_Path(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class PathConstants(typing.TypedDict):
        pass

    __constants: PathConstants = {
    }
...
class Path(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_Path):
    """Message class 'Path'."""
