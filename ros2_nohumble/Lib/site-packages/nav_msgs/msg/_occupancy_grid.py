...
class Metaclass_OccupancyGrid(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class OccupancyGridConstants(typing.TypedDict):
        pass

    __constants: OccupancyGridConstants = {
    }
    ...
    def __import_type_support__(cls) -> None:
        try:
            ...
            if MapMetaData._TYPE_SUPPORT is None:
                MapMetaData.__import_type_support__()
...
class OccupancyGrid(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_OccupancyGrid):
    ...
    def __init__(self, *,
                 ...
                 info: typing.Optional[nav_msgs.msg.MapMetaData] = None,  # noqa: E501
        ...
        from nav_msgs.msg import MapMetaData
        self.info = info if info is not None else MapMetaData()
