...
class LoadMap_Event(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_LoadMap_Event):
    ...
    def __init__(self, *,
                 ...
                 request: typing.Optional[collections.abc.Sequence[nav_msgs.srv.LoadMap_Request]] = None,  # noqa: E501
                 response: typing.Optional[collections.abc.Sequence[nav_msgs.srv.LoadMap_Response]] = None,  # noqa: E501
                 check_fields: typing.Optional[bool] = None) -> None:
        if check_fields is not None:
            self._check_fields = check_fields
        else:
    ...
    @builtins.property
    def request(self) -> typing.Annotated[typing.Any, list[nav_msgs.srv.LoadMap_Request]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'request'."""
        return self._request

    @request.setter
    def request(self, value: collections.abc.Sequence[nav_msgs.srv.LoadMap_Request]) -> None:
    ...
    @builtins.property
    def response(self) -> typing.Annotated[typing.Any, list[nav_msgs.srv.LoadMap_Response]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'response'."""
        return self._response

    @response.setter
    def response(self, value: collections.abc.Sequence[nav_msgs.srv.LoadMap_Response]) -> None:
        if isinstance(value, collections.abc.Set):
            import warnings
            warnings.warn(
                'Using set or subclass of set is deprecated,'
