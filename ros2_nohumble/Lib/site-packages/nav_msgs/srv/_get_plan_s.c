...
bool nav_msgs__srv__get_plan__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav_msgs.srv._get_plan", (char *)PyUnicode_1BYTE_DATA(module_attr), 22) == 0);
    assert(strncmp("GetPlan_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 15) == 0);
...
bool nav_msgs__srv__get_plan__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("nav_msgs.srv._get_plan", (char *)PyUnicode_1BYTE_DATA(module_attr), 22) == 0);
    assert(strncmp("GetPlan_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);
...
bool nav_msgs__srv__get_plan__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("nav_msgs.srv._get_plan", (char *)PyUnicode_1BYTE_DATA(module_attr), 22) == 0);
    assert(strncmp("GetPlan_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 13) == 0);
