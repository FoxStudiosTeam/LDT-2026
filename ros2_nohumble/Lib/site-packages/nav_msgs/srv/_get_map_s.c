...
bool nav_msgs__srv__get_map__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav_msgs.srv._get_map", (char *)PyUnicode_1BYTE_DATA(module_attr), 21) == 0);
    assert(strncmp("GetMap_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 14) == 0);
...
bool nav_msgs__srv__get_map__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("nav_msgs.srv._get_map", (char *)PyUnicode_1BYTE_DATA(module_attr), 21) == 0);
    assert(strncmp("GetMap_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 15) == 0);
...
bool nav_msgs__srv__get_map__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("nav_msgs.srv._get_map", (char *)PyUnicode_1BYTE_DATA(module_attr), 21) == 0);
    assert(strncmp("GetMap_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 12) == 0);
