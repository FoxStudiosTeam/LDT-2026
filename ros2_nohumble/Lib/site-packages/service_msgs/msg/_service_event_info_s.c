...
bool service_msgs__msg__service_event_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("service_msgs.msg._service_event_info", (char *)PyUnicode_1BYTE_DATA(module_attr), 36) == 0);
    assert(strncmp("ServiceEventInfo", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);
