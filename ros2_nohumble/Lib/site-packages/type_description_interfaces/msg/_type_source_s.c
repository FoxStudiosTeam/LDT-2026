...
bool type_description_interfaces__msg__type_source__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("type_description_interfaces.msg._type_source", (char *)PyUnicode_1BYTE_DATA(module_attr), 44) == 0);
    assert(strncmp("TypeSource", (char *)PyUnicode_1BYTE_DATA(name_attr), 10) == 0);
