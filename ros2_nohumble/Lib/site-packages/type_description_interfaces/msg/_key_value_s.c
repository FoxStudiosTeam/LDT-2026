...
bool type_description_interfaces__msg__key_value__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("type_description_interfaces.msg._key_value", (char *)PyUnicode_1BYTE_DATA(module_attr), 42) == 0);
    assert(strncmp("KeyValue", (char *)PyUnicode_1BYTE_DATA(name_attr), 8) == 0);
