...
bool type_description_interfaces__msg__individual_type_description__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("type_description_interfaces.msg._individual_type_description", (char *)PyUnicode_1BYTE_DATA(module_attr), 60) == 0);
    assert(strncmp("IndividualTypeDescription", (char *)PyUnicode_1BYTE_DATA(name_attr), 25) == 0);
