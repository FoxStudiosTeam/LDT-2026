...
bool composition_interfaces__srv__load_node__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("composition_interfaces.srv._load_node", (char *)PyUnicode_1BYTE_DATA(module_attr), 37) == 0);
    assert(strncmp("LoadNode_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);
...
bool composition_interfaces__srv__load_node__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("composition_interfaces.srv._load_node", (char *)PyUnicode_1BYTE_DATA(module_attr), 37) == 0);
    assert(strncmp("LoadNode_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 17) == 0);
...
bool composition_interfaces__srv__load_node__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("composition_interfaces.srv._load_node", (char *)PyUnicode_1BYTE_DATA(module_attr), 37) == 0);
    assert(strncmp("LoadNode_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 14) == 0);
