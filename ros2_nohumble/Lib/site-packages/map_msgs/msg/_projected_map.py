...
class Metaclass_ProjectedMap(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class ProjectedMapConstants(typing.TypedDict):
        pass

    __constants: ProjectedMapConstants = {
    }
...
class ProjectedMap(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_ProjectedMap):
    ...
    def __init__(self, *,
                 ...
                 min_z: typing.Optional[float] = None,  # noqa: E501
                 max_z: typing.Optional[float] = None,  # noqa: E501
        ...
        self.min_z = min_z if min_z is not None else float()
        self.max_z = max_z if max_z is not None else float()
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, ProjectedMap):
            return False
