...
bool map_msgs__msg__occupancy_grid_update__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("map_msgs.msg._occupancy_grid_update", (char *)PyUnicode_1BYTE_DATA(module_attr), 35) == 0);
    assert(strncmp("OccupancyGridUpdate", (char *)PyUnicode_1BYTE_DATA(name_attr), 19) == 0);
