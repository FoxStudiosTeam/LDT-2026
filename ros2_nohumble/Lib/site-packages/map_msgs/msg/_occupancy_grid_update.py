...
class Metaclass_OccupancyGridUpdate(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class OccupancyGridUpdateConstants(typing.TypedDict):
        pass

    __constants: OccupancyGridUpdateConstants = {
    }
...
class OccupancyGridUpdate(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_OccupancyGridUpdate):
    ...
    def __init__(self, *,
                 ...
                 x: typing.Optional[int] = None,  # noqa: E501
                 y: typing.Optional[int] = None,  # noqa: E501
        ...
        self.x = x if x is not None else int()
        self.y = y if y is not None else int()
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, OccupancyGridUpdate):
            return False
