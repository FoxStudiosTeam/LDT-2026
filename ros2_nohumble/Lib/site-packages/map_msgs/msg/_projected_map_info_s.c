...
bool map_msgs__msg__projected_map_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("map_msgs.msg._projected_map_info", (char *)PyUnicode_1BYTE_DATA(module_attr), 32) == 0);
    assert(strncmp("ProjectedMapInfo", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);
