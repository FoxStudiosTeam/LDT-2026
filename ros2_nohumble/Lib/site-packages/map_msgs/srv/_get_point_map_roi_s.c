...
bool map_msgs__srv__get_point_map_roi__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("map_msgs.srv._get_point_map_roi", (char *)PyUnicode_1BYTE_DATA(module_attr), 31) == 0);
    assert(strncmp("GetPointMapROI_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 22) == 0);
...
bool map_msgs__srv__get_point_map_roi__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("map_msgs.srv._get_point_map_roi", (char *)PyUnicode_1BYTE_DATA(module_attr), 31) == 0);
    assert(strncmp("GetPointMapROI_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 23) == 0);
...
bool map_msgs__srv__get_point_map_roi__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("map_msgs.srv._get_point_map_roi", (char *)PyUnicode_1BYTE_DATA(module_attr), 31) == 0);
    assert(strncmp("GetPointMapROI_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 20) == 0);
