...
bool map_msgs__srv__set_map_projections__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("map_msgs.srv._set_map_projections", (char *)PyUnicode_1BYTE_DATA(module_attr), 33) == 0);
    assert(strncmp("SetMapProjections_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 25) == 0);
...
bool map_msgs__srv__set_map_projections__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("map_msgs.srv._set_map_projections", (char *)PyUnicode_1BYTE_DATA(module_attr), 33) == 0);
    assert(strncmp("SetMapProjections_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 26) == 0);
...
bool map_msgs__srv__set_map_projections__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("map_msgs.srv._set_map_projections", (char *)PyUnicode_1BYTE_DATA(module_attr), 33) == 0);
    assert(strncmp("SetMapProjections_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 23) == 0);
