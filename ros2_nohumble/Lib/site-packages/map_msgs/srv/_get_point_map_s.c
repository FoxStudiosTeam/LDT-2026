...
bool map_msgs__srv__get_point_map__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("map_msgs.srv._get_point_map", (char *)PyUnicode_1BYTE_DATA(module_attr), 27) == 0);
    assert(strncmp("GetPointMap_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 19) == 0);
...
bool map_msgs__srv__get_point_map__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("map_msgs.srv._get_point_map", (char *)PyUnicode_1BYTE_DATA(module_attr), 27) == 0);
    assert(strncmp("GetPointMap_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 20) == 0);
...
bool map_msgs__srv__get_point_map__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("map_msgs.srv._get_point_map", (char *)PyUnicode_1BYTE_DATA(module_attr), 27) == 0);
    assert(strncmp("GetPointMap_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 17) == 0);
