...
bool map_msgs__srv__get_map_roi__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("map_msgs.srv._get_map_roi", (char *)PyUnicode_1BYTE_DATA(module_attr), 25) == 0);
    assert(strncmp("GetMapROI_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 17) == 0);
...
bool map_msgs__srv__get_map_roi__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("map_msgs.srv._get_map_roi", (char *)PyUnicode_1BYTE_DATA(module_attr), 25) == 0);
    assert(strncmp("GetMapROI_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 18) == 0);
...
bool map_msgs__srv__get_map_roi__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("map_msgs.srv._get_map_roi", (char *)PyUnicode_1BYTE_DATA(module_attr), 25) == 0);
    assert(strncmp("GetMapROI_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 15) == 0);
