...
bool rcl_interfaces__msg__parameter_event_descriptors__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rcl_interfaces.msg._parameter_event_descriptors", (char *)PyUnicode_1BYTE_DATA(module_attr), 47) == 0);
    assert(strncmp("ParameterEventDescriptors", (char *)PyUnicode_1BYTE_DATA(name_attr), 25) == 0);
