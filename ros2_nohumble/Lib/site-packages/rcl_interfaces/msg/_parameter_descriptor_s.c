...
bool rcl_interfaces__msg__parameter_descriptor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rcl_interfaces.msg._parameter_descriptor", (char *)PyUnicode_1BYTE_DATA(module_attr), 40) == 0);
    assert(strncmp("ParameterDescriptor", (char *)PyUnicode_1BYTE_DATA(name_attr), 19) == 0);
