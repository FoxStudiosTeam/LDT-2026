...
bool rcl_interfaces__msg__parameter__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rcl_interfaces.msg._parameter", (char *)PyUnicode_1BYTE_DATA(module_attr), 29) == 0);
    assert(strncmp("Parameter", (char *)PyUnicode_1BYTE_DATA(name_attr), 9) == 0);
