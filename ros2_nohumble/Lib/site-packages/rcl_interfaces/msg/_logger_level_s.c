...
bool rcl_interfaces__msg__logger_level__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rcl_interfaces.msg._logger_level", (char *)PyUnicode_1BYTE_DATA(module_attr), 32) == 0);
    assert(strncmp("LoggerLevel", (char *)PyUnicode_1BYTE_DATA(name_attr), 11) == 0);
