...
bool rcl_interfaces__msg__set_parameters_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rcl_interfaces.msg._set_parameters_result", (char *)PyUnicode_1BYTE_DATA(module_attr), 41) == 0);
    assert(strncmp("SetParametersResult", (char *)PyUnicode_1BYTE_DATA(name_attr), 19) == 0);
