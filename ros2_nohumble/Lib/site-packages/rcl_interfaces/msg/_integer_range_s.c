...
bool rcl_interfaces__msg__integer_range__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rcl_interfaces.msg._integer_range", (char *)PyUnicode_1BYTE_DATA(module_attr), 33) == 0);
    assert(strncmp("IntegerRange", (char *)PyUnicode_1BYTE_DATA(name_attr), 12) == 0);
