...
class Metaclass_SetParametersResult(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class SetParametersResultConstants(typing.TypedDict):
        pass

    __constants: SetParametersResultConstants = {
    }
...
class SetParametersResult(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_SetParametersResult):
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, SetParametersResult):
            return False
