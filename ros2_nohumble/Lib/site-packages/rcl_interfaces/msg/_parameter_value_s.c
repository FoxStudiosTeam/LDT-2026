...
bool rcl_interfaces__msg__parameter_value__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rcl_interfaces.msg._parameter_value", (char *)PyUnicode_1BYTE_DATA(module_attr), 35) == 0);
    assert(strncmp("ParameterValue", (char *)PyUnicode_1BYTE_DATA(name_attr), 14) == 0);
