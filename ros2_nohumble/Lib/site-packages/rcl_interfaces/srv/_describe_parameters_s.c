...
bool rcl_interfaces__srv__describe_parameters__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rcl_interfaces.srv._describe_parameters", (char *)PyUnicode_1BYTE_DATA(module_attr), 39) == 0);
    assert(strncmp("DescribeParameters_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 26) == 0);
...
bool rcl_interfaces__srv__describe_parameters__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("rcl_interfaces.srv._describe_parameters", (char *)PyUnicode_1BYTE_DATA(module_attr), 39) == 0);
    assert(strncmp("DescribeParameters_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 27) == 0);
...
bool rcl_interfaces__srv__describe_parameters__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("rcl_interfaces.srv._describe_parameters", (char *)PyUnicode_1BYTE_DATA(module_attr), 39) == 0);
    assert(strncmp("DescribeParameters_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 24) == 0);
