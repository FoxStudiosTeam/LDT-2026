...
bool rcl_interfaces__srv__get_parameter_types__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rcl_interfaces.srv._get_parameter_types", (char *)PyUnicode_1BYTE_DATA(module_attr), 39) == 0);
    assert(strncmp("GetParameterTypes_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 25) == 0);
...
bool rcl_interfaces__srv__get_parameter_types__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("rcl_interfaces.srv._get_parameter_types", (char *)PyUnicode_1BYTE_DATA(module_attr), 39) == 0);
    assert(strncmp("GetParameterTypes_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 26) == 0);
          ...
          if (rosidl_buffer_mod != NULL) {
            ...
            if (get_ptr_func != NULL) {
              ...
              if (ptr_result != NULL) {
                ...
                ros_message->types.data = (uint8_t *)buffer_ptr;
                ros_message->types.size = 0;
                ros_message->types.capacity = 0;
                ros_message->types.is_rosidl_buffer = true;
                ros_message->types.owns_rosidl_buffer = false;
...
PyObject * rcl_interfaces__srv__get_parameter_types__response__convert_to_py(void * raw_ros_message)
{
  ...
  {  // types
    ...
    if (ros_message->types.is_rosidl_buffer) {
      ...
      if (rosidl_buffer_internal != NULL) {
        ...
        if (take_func != NULL) {
          PyObject * ptr_arg = PyLong_FromUnsignedLongLong(
            (uint64_t)(uintptr_t)ros_message->types.data);
      ...
      if (PyObject_SetAttrString(_pymessage, "types", field) == -1) {
        Py_DECREF(field);
        return NULL;
      }
      Py_DECREF(field);
...
bool rcl_interfaces__srv__get_parameter_types__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("rcl_interfaces.srv._get_parameter_types", (char *)PyUnicode_1BYTE_DATA(module_attr), 39) == 0);
    assert(strncmp("GetParameterTypes_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 23) == 0);
