...
class Metaclass_SetParametersAtomically_Request(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class SetParametersAtomically_RequestConstants(typing.TypedDict):
        pass

    __constants: SetParametersAtomically_RequestConstants = {
    }
    ...
    def __import_type_support__(cls) -> None:
        try:
            ...
            if Parameter._TYPE_SUPPORT is None:
                Parameter.__import_type_support__()
...
class SetParametersAtomically_Request(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_SetParametersAtomically_Request):
    ...
    def __init__(self, *,
                 parameters: typing.Optional[collections.abc.Sequence[rcl_interfaces.msg.Parameter]] = None,  # noqa: E501
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, SetParametersAtomically_Request):
            return False
    ...
    @builtins.property
    def parameters(self) -> typing.Annotated[typing.Any, list[rcl_interfaces.msg.Parameter]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'parameters'."""
        return self._parameters

    @parameters.setter
    def parameters(self, value: collections.abc.Sequence[rcl_interfaces.msg.Parameter]) -> None:
            ...
            if False:  # Done for templating alignment
                ...
                assert \
                    ((isinstance(value, collections.abc.Sequence) or
                     ...
                     True), \
                    "The 'parameters' field must be sequence and each value of type 'Parameter'"
...
class Metaclass_SetParametersAtomically_Response(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class SetParametersAtomically_ResponseConstants(typing.TypedDict):
        pass

    __constants: SetParametersAtomically_ResponseConstants = {
    }
    ...
    def __import_type_support__(cls) -> None:
        try:
            ...
            if SetParametersResult._TYPE_SUPPORT is None:
                SetParametersResult.__import_type_support__()
...
class SetParametersAtomically_Response(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_SetParametersAtomically_Response):
    ...
    def __init__(self, *,
                 result: typing.Optional[rcl_interfaces.msg.SetParametersResult] = None,  # noqa: E501
                 check_fields: typing.Optional[bool] = None) -> None:
        if check_fields is not None:
            self._check_fields = check_fields
        else:
            self._check_fields = ros_python_check_fields == '1'
        from rcl_interfaces.msg import SetParametersResult
        self.result = result if result is not None else SetParametersResult()
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, SetParametersAtomically_Response):
            return False
...
class Metaclass_SetParametersAtomically_Event(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class SetParametersAtomically_EventConstants(typing.TypedDict):
        pass

    __constants: SetParametersAtomically_EventConstants = {
    }
...
class SetParametersAtomically_Event(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_SetParametersAtomically_Event):
    ...
    def __init__(self, *,
                 ...
                 request: typing.Optional[collections.abc.Sequence[rcl_interfaces.srv.SetParametersAtomically_Request]] = None,  # noqa: E501
                 response: typing.Optional[collections.abc.Sequence[rcl_interfaces.srv.SetParametersAtomically_Response]] = None,  # noqa: E501
                 check_fields: typing.Optional[bool] = None) -> None:
        if check_fields is not None:
            self._check_fields = check_fields
        else:
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, SetParametersAtomically_Event):
            return False
    ...
    @builtins.property
    def request(self) -> typing.Annotated[typing.Any, list[rcl_interfaces.srv.SetParametersAtomically_Request]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'request'."""
        return self._request

    @request.setter
    def request(self, value: collections.abc.Sequence[rcl_interfaces.srv.SetParametersAtomically_Request]) -> None:
        if isinstance(value, collections.abc.Set):
            import warnings
            warnings.warn(
                'Using set or subclass of set is deprecated,'
            ...
            if False:  # Done for templating alignment
                ...
                assert \
                    ((isinstance(value, collections.abc.Sequence) or
                     ...
                     True), \
                    "The 'request' field must be sequence with length <= 1 and each value of type 'SetParametersAtomically_Request'"
    ...
    @builtins.property
    def response(self) -> typing.Annotated[typing.Any, list[rcl_interfaces.srv.SetParametersAtomically_Response]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'response'."""
        return self._response

    @response.setter
    def response(self, value: collections.abc.Sequence[rcl_interfaces.srv.SetParametersAtomically_Response]) -> None:
        if isinstance(value, collections.abc.Set):
            import warnings
            warnings.warn(
                'Using set or subclass of set is deprecated,'
            ...
            if False:  # Done for templating alignment
                ...
                assert \
                    ((isinstance(value, collections.abc.Sequence) or
                     ...
                     True), \
                    "The 'response' field must be sequence with length <= 1 and each value of type 'SetParametersAtomically_Response'"
...
class Metaclass_SetParametersAtomically(rosidl_pycommon.interface_base_classes.ServiceTypeSupportMeta):
...
class SetParametersAtomically(rosidl_pycommon.interface_base_classes.BaseService[
    SetParametersAtomically_Request,
    SetParametersAtomically_Response
], metaclass=Metaclass_SetParametersAtomically):
    Request: TypeAlias = SetParametersAtomically_Request
    Response: TypeAlias = SetParametersAtomically_Response
    Event: TypeAlias = SetParametersAtomically_Event
