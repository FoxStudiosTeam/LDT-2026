...
if typing.TYPE_CHECKING:
    import rcl_interfaces.msg  # noqa: E402, I100, I201, I300
...
class Metaclass_SetLoggerLevels_Request(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class SetLoggerLevels_RequestConstants(typing.TypedDict):
        pass

    __constants: SetLoggerLevels_RequestConstants = {
    }
    ...
    def __import_type_support__(cls) -> None:
        try:
            ...
            if LoggerLevel._TYPE_SUPPORT is None:
                LoggerLevel.__import_type_support__()
...
class SetLoggerLevels_Request(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_SetLoggerLevels_Request):
    ...
    def __init__(self, *,
                 levels: typing.Optional[collections.abc.Sequence[rcl_interfaces.msg.LoggerLevel]] = None,  # noqa: E501
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, SetLoggerLevels_Request):
            return False
    ...
    @builtins.property
    def levels(self) -> typing.Annotated[typing.Any, list[rcl_interfaces.msg.LoggerLevel]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'levels'."""
        return self._levels

    @levels.setter
    def levels(self, value: collections.abc.Sequence[rcl_interfaces.msg.LoggerLevel]) -> None:
            ...
            if False:  # Done for templating alignment
                ...
                assert \
                    ((isinstance(value, collections.abc.Sequence) or
                     ...
                     True), \
                    "The 'levels' field must be sequence and each value of type 'LoggerLevel'"
...
class Metaclass_SetLoggerLevels_Response(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class SetLoggerLevels_ResponseConstants(typing.TypedDict):
        pass

    __constants: SetLoggerLevels_ResponseConstants = {
    }
    ...
    def __import_type_support__(cls) -> None:
        try:
            ...
            if SetLoggerLevelsResult._TYPE_SUPPORT is None:
                SetLoggerLevelsResult.__import_type_support__()
...
class SetLoggerLevels_Response(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_SetLoggerLevels_Response):
    ...
    def __init__(self, *,
                 results: typing.Optional[collections.abc.Sequence[rcl_interfaces.msg.SetLoggerLevelsResult]] = None,  # noqa: E501
                 check_fields: typing.Optional[bool] = None) -> None:
        if check_fields is not None:
            self._check_fields = check_fields
        else:
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, SetLoggerLevels_Response):
            return False
    ...
    @builtins.property
    def results(self) -> typing.Annotated[typing.Any, list[rcl_interfaces.msg.SetLoggerLevelsResult]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'results'."""
        return self._results

    @results.setter
    def results(self, value: collections.abc.Sequence[rcl_interfaces.msg.SetLoggerLevelsResult]) -> None:
        if isinstance(value, collections.abc.Set):
            import warnings
            warnings.warn(
                'Using set or subclass of set is deprecated,'
            ...
            if False:  # Done for templating alignment
                ...
                assert \
                    ((isinstance(value, collections.abc.Sequence) or
                     ...
                     True), \
                    "The 'results' field must be sequence and each value of type 'SetLoggerLevelsResult'"
...
if typing.TYPE_CHECKING:
    import rcl_interfaces.srv  # noqa: E402, I100, I201, I300
...
class Metaclass_SetLoggerLevels_Event(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class SetLoggerLevels_EventConstants(typing.TypedDict):
        pass

    __constants: SetLoggerLevels_EventConstants = {
    }
...
class SetLoggerLevels_Event(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_SetLoggerLevels_Event):
    ...
    def __init__(self, *,
                 ...
                 request: typing.Optional[collections.abc.Sequence[rcl_interfaces.srv.SetLoggerLevels_Request]] = None,  # noqa: E501
                 response: typing.Optional[collections.abc.Sequence[rcl_interfaces.srv.SetLoggerLevels_Response]] = None,  # noqa: E501
                 check_fields: typing.Optional[bool] = None) -> None:
        if check_fields is not None:
            self._check_fields = check_fields
        else:
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, SetLoggerLevels_Event):
            return False
    ...
    @builtins.property
    def request(self) -> typing.Annotated[typing.Any, list[rcl_interfaces.srv.SetLoggerLevels_Request]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'request'."""
        return self._request

    @request.setter
    def request(self, value: collections.abc.Sequence[rcl_interfaces.srv.SetLoggerLevels_Request]) -> None:
        if isinstance(value, collections.abc.Set):
            import warnings
            warnings.warn(
                'Using set or subclass of set is deprecated,'
            ...
            if False:  # Done for templating alignment
                ...
                assert \
                    ((isinstance(value, collections.abc.Sequence) or
                     ...
                     True), \
                    "The 'request' field must be sequence with length <= 1 and each value of type 'SetLoggerLevels_Request'"
    ...
    @builtins.property
    def response(self) -> typing.Annotated[typing.Any, list[rcl_interfaces.srv.SetLoggerLevels_Response]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'response'."""
        return self._response

    @response.setter
    def response(self, value: collections.abc.Sequence[rcl_interfaces.srv.SetLoggerLevels_Response]) -> None:
        if isinstance(value, collections.abc.Set):
            import warnings
            warnings.warn(
                'Using set or subclass of set is deprecated,'
            ...
            if False:  # Done for templating alignment
                ...
                assert \
                    ((isinstance(value, collections.abc.Sequence) or
                     ...
                     True), \
                    "The 'response' field must be sequence with length <= 1 and each value of type 'SetLoggerLevels_Response'"
...
class Metaclass_SetLoggerLevels(rosidl_pycommon.interface_base_classes.ServiceTypeSupportMeta):
...
class SetLoggerLevels(rosidl_pycommon.interface_base_classes.BaseService[
    SetLoggerLevels_Request,
    SetLoggerLevels_Response
], metaclass=Metaclass_SetLoggerLevels):
    Request: TypeAlias = SetLoggerLevels_Request
    Response: TypeAlias = SetLoggerLevels_Response
    Event: TypeAlias = SetLoggerLevels_Event
