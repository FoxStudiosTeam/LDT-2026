...
bool rcl_interfaces__srv__set_logger_levels__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rcl_interfaces.srv._set_logger_levels", (char *)PyUnicode_1BYTE_DATA(module_attr), 37) == 0);
    assert(strncmp("SetLoggerLevels_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 23) == 0);
...
bool rcl_interfaces__srv__set_logger_levels__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("rcl_interfaces.srv._set_logger_levels", (char *)PyUnicode_1BYTE_DATA(module_attr), 37) == 0);
    assert(strncmp("SetLoggerLevels_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 24) == 0);
...
bool rcl_interfaces__srv__set_logger_levels__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("rcl_interfaces.srv._set_logger_levels", (char *)PyUnicode_1BYTE_DATA(module_attr), 37) == 0);
    assert(strncmp("SetLoggerLevels_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 21) == 0);
