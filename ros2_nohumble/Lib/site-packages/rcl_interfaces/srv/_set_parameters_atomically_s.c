...
bool rcl_interfaces__srv__set_parameters_atomically__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rcl_interfaces.srv._set_parameters_atomically", (char *)PyUnicode_1BYTE_DATA(module_attr), 45) == 0);
    assert(strncmp("SetParametersAtomically_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 31) == 0);
...
bool rcl_interfaces__srv__set_parameters_atomically__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("rcl_interfaces.srv._set_parameters_atomically", (char *)PyUnicode_1BYTE_DATA(module_attr), 45) == 0);
    assert(strncmp("SetParametersAtomically_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 32) == 0);
...
bool rcl_interfaces__srv__set_parameters_atomically__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("rcl_interfaces.srv._set_parameters_atomically", (char *)PyUnicode_1BYTE_DATA(module_attr), 45) == 0);
    assert(strncmp("SetParametersAtomically_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 29) == 0);
