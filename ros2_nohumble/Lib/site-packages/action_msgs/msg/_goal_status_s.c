...
bool action_msgs__msg__goal_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("action_msgs.msg._goal_status", (char *)PyUnicode_1BYTE_DATA(module_attr), 28) == 0);
    assert(strncmp("GoalStatus", (char *)PyUnicode_1BYTE_DATA(name_attr), 10) == 0);
