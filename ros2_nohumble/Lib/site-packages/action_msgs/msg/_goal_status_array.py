...
if typing.TYPE_CHECKING:
    import action_msgs.msg  # noqa: E402, I100, I201, I300
...
class Metaclass_GoalStatusArray(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class GoalStatusArrayConstants(typing.TypedDict):
        pass

    __constants: GoalStatusArrayConstants = {
    }
    ...
    def __import_type_support__(cls) -> None:
        try:
            ...
            if GoalStatus._TYPE_SUPPORT is None:
                GoalStatus.__import_type_support__()
...
class GoalStatusArray(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_GoalStatusArray):
    ...
    def __init__(self, *,
                 status_list: typing.Optional[collections.abc.Sequence[action_msgs.msg.GoalStatus]] = None,  # noqa: E501
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, GoalStatusArray):
            return False
    ...
    @builtins.property
    def status_list(self) -> typing.Annotated[typing.Any, list[action_msgs.msg.GoalStatus]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'status_list'."""
        return self._status_list

    @status_list.setter
    def status_list(self, value: collections.abc.Sequence[action_msgs.msg.GoalStatus]) -> None:
            ...
            if False:  # Done for templating alignment
                ...
                assert \
                    ((isinstance(value, collections.abc.Sequence) or
                     ...
                     True), \
                    "The 'status_list' field must be sequence and each value of type 'GoalStatus'"

        if isinstance(value, list):
            self._status_list = value
            return
        self._status_list = list(value)
