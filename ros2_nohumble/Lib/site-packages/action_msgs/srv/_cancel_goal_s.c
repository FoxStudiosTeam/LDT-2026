...
bool action_msgs__srv__cancel_goal__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("action_msgs.srv._cancel_goal", (char *)PyUnicode_1BYTE_DATA(module_attr), 28) == 0);
    assert(strncmp("CancelGoal_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 18) == 0);
...
bool action_msgs__srv__cancel_goal__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("action_msgs.srv._cancel_goal", (char *)PyUnicode_1BYTE_DATA(module_attr), 28) == 0);
    assert(strncmp("CancelGoal_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 19) == 0);
...
bool action_msgs__srv__cancel_goal__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("action_msgs.srv._cancel_goal", (char *)PyUnicode_1BYTE_DATA(module_attr), 28) == 0);
    assert(strncmp("CancelGoal_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);
