...
bool rmw_dds_common__msg__node_entities_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmw_dds_common.msg._node_entities_info", (char *)PyUnicode_1BYTE_DATA(module_attr), 38) == 0);
    assert(strncmp("NodeEntitiesInfo", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);
