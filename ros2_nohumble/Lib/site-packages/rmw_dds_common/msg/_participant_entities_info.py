...
if typing.TYPE_CHECKING:
    import rmw_dds_common.msg  # noqa: E402, I100, I201, I300
...
class Metaclass_ParticipantEntitiesInfo(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class ParticipantEntitiesInfoConstants(typing.TypedDict):
        pass

    __constants: ParticipantEntitiesInfoConstants = {
    }
    ...
    def __import_type_support__(cls) -> None:
        try:
            ...
            if Gid._TYPE_SUPPORT is None:
                Gid.__import_type_support__()

            from rmw_dds_common.msg import NodeEntitiesInfo
            if NodeEntitiesInfo._TYPE_SUPPORT is None:
                NodeEntitiesInfo.__import_type_support__()
...
class ParticipantEntitiesInfo(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_ParticipantEntitiesInfo):
    ...
    def __init__(self, *,
                 gid: typing.Optional[rmw_dds_common.msg.Gid] = None,  # noqa: E501
                 node_entities_info_seq: typing.Optional[collections.abc.Sequence[rmw_dds_common.msg.NodeEntitiesInfo]] = None,  # noqa: E501
        ...
        from rmw_dds_common.msg import Gid
        self.gid = gid if gid is not None else Gid()
        self.node_entities_info_seq = node_entities_info_seq if node_entities_info_seq is not None else []
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, ParticipantEntitiesInfo):
            return False
    ...
    @builtins.property
    def gid(self) -> rmw_dds_common.msg.Gid:
        """Message field 'gid'."""
        return self._gid

    @gid.setter
    def gid(self, value: rmw_dds_common.msg.Gid) -> None:
        from rmw_dds_common.msg import Gid
    ...
    @builtins.property
    def node_entities_info_seq(self) -> typing.Annotated[typing.Any, list[rmw_dds_common.msg.NodeEntitiesInfo]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'node_entities_info_seq'."""
        return self._node_entities_info_seq

    @node_entities_info_seq.setter
    def node_entities_info_seq(self, value: collections.abc.Sequence[rmw_dds_common.msg.NodeEntitiesInfo]) -> None:
            ...
            if False:  # Done for templating alignment
                ...
                assert \
                    ((isinstance(value, collections.abc.Sequence) or
                     ...
                     True), \
                    "The 'node_entities_info_seq' field must be sequence and each value of type 'NodeEntitiesInfo'"

        if isinstance(value, list):
            self._node_entities_info_seq = value
            return
        self._node_entities_info_seq = list(value)
