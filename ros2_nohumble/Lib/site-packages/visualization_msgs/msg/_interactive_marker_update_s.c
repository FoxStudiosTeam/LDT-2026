...
bool visualization_msgs__msg__interactive_marker_update__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("visualization_msgs.msg._interactive_marker_update", (char *)PyUnicode_1BYTE_DATA(module_attr), 49) == 0);
    assert(strncmp("InteractiveMarkerUpdate", (char *)PyUnicode_1BYTE_DATA(name_attr), 23) == 0);
