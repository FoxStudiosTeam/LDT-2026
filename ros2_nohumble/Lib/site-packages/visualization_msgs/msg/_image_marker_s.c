...
bool visualization_msgs__msg__image_marker__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("visualization_msgs.msg._image_marker", (char *)PyUnicode_1BYTE_DATA(module_attr), 36) == 0);
    assert(strncmp("ImageMarker", (char *)PyUnicode_1BYTE_DATA(name_attr), 11) == 0);
