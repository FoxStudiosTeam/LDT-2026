...
bool visualization_msgs__msg__mesh_file__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("visualization_msgs.msg._mesh_file", (char *)PyUnicode_1BYTE_DATA(module_attr), 33) == 0);
    assert(strncmp("MeshFile", (char *)PyUnicode_1BYTE_DATA(name_attr), 8) == 0);
