...
bool visualization_msgs__msg__menu_entry__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("visualization_msgs.msg._menu_entry", (char *)PyUnicode_1BYTE_DATA(module_attr), 34) == 0);
    assert(strncmp("MenuEntry", (char *)PyUnicode_1BYTE_DATA(name_attr), 9) == 0);
