...
class Metaclass_Header(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class HeaderConstants(typing.TypedDict):
        pass

    __constants: HeaderConstants = {
    }
...
class Header(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_Header):
