...
bool example_interfaces__msg__w_string__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("example_interfaces.msg._w_string", (char *)PyUnicode_1BYTE_DATA(module_attr), 32) == 0);
    assert(strncmp("WString", (char *)PyUnicode_1BYTE_DATA(name_attr), 7) == 0);
