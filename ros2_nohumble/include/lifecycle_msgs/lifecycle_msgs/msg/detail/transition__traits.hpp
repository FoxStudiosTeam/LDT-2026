...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, lifecycle_msgs::msg::Transition>, int> = 0>
...
template<>
constexpr const char * data_type<lifecycle_msgs::msg::Transition>()
{
  return "lifecycle_msgs::msg::Transition";
}

template<>
constexpr const char * name<lifecycle_msgs::msg::Transition>()
{
  return "lifecycle_msgs/msg/Transition";
}
...
template<>
struct MessageTraits<lifecycle_msgs::msg::Transition>
{
