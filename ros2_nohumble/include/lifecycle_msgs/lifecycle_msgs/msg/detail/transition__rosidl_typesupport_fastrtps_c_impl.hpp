...
#ifndef LIFECYCLE_MSGS__MSG__DETAIL__TRANSITION__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
#define LIFECYCLE_MSGS__MSG__DETAIL__TRANSITION__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
...
inline
bool impl_cdr_serialize_lifecycle_msgs__msg__Transition(
...
inline
bool impl_cdr_deserialize_lifecycle_msgs__msg__Transition(
  eprosima::fastcdr::Cdr & cdr,
...
inline
size_t impl_get_serialized_size_lifecycle_msgs__msg__Transition(
...
inline
size_t impl_max_serialized_size_lifecycle_msgs__msg__Transition(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_key_lifecycle_msgs__msg__Transition(
  const lifecycle_msgs__msg__Transition * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: id
...
inline
size_t impl_get_serialized_size_key_lifecycle_msgs__msg__Transition(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Transition__ros_msg_type * ros_message = static_cast<const _Transition__ros_msg_type *>(untyped_ros_message);
...
inline
size_t impl_max_serialized_size_key_lifecycle_msgs__msg__Transition(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_with_endpoint_lifecycle_msgs__msg__Transition(
  const lifecycle_msgs__msg__Transition * ros_message,
  eprosima::fastcdr::Cdr & cdr,
...
inline
bool impl_cdr_deserialize_with_endpoint_lifecycle_msgs__msg__Transition(
  eprosima::fastcdr::Cdr & cdr,
  lifecycle_msgs__msg__Transition * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
...
#endif  // LIFECYCLE_MSGS__MSG__DETAIL__TRANSITION__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
