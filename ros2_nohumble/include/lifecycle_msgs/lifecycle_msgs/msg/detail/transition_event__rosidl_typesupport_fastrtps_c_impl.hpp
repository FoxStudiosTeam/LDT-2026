...
#ifndef LIFECYCLE_MSGS__MSG__DETAIL__TRANSITION_EVENT__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
#define LIFECYCLE_MSGS__MSG__DETAIL__TRANSITION_EVENT__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
...
inline
bool impl_cdr_serialize_lifecycle_msgs__msg__TransitionEvent(
...
inline
bool impl_cdr_deserialize_lifecycle_msgs__msg__TransitionEvent(
  eprosima::fastcdr::Cdr & cdr,
...
inline
size_t impl_get_serialized_size_lifecycle_msgs__msg__TransitionEvent(
...
inline
size_t impl_max_serialized_size_lifecycle_msgs__msg__TransitionEvent(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_key_lifecycle_msgs__msg__TransitionEvent(
  const lifecycle_msgs__msg__TransitionEvent * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: stamp
...
inline
size_t impl_get_serialized_size_key_lifecycle_msgs__msg__TransitionEvent(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TransitionEvent__ros_msg_type * ros_message = static_cast<const _TransitionEvent__ros_msg_type *>(untyped_ros_message);
...
inline
size_t impl_max_serialized_size_key_lifecycle_msgs__msg__TransitionEvent(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_with_endpoint_lifecycle_msgs__msg__TransitionEvent(
  const lifecycle_msgs__msg__TransitionEvent * ros_message,
  eprosima::fastcdr::Cdr & cdr,
...
inline
bool impl_cdr_deserialize_with_endpoint_lifecycle_msgs__msg__TransitionEvent(
  eprosima::fastcdr::Cdr & cdr,
  lifecycle_msgs__msg__TransitionEvent * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
...
#endif  // LIFECYCLE_MSGS__MSG__DETAIL__TRANSITION_EVENT__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
