...
class Init_TransitionEvent_stamp
{
public:
  Init_TransitionEvent_stamp()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_TransitionEvent_transition stamp(::lifecycle_msgs::msg::TransitionEvent::_stamp_type arg)
  {
...
{
  return lifecycle_msgs::msg::builder::Init_TransitionEvent_stamp();
}
