...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, lifecycle_msgs::srv::GetAvailableStates_Request>, int> = 0>
...
template<>
constexpr const char * data_type<lifecycle_msgs::srv::GetAvailableStates_Request>()
{
  return "lifecycle_msgs::srv::GetAvailableStates_Request";
}

template<>
constexpr const char * name<lifecycle_msgs::srv::GetAvailableStates_Request>()
{
  return "lifecycle_msgs/srv/GetAvailableStates_Request";
}
...
template<>
struct MessageTraits<lifecycle_msgs::srv::GetAvailableStates_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, lifecycle_msgs::srv::GetAvailableStates_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(std::forward<T>(msg).available_states);
}
...
template<>
constexpr const char * data_type<lifecycle_msgs::srv::GetAvailableStates_Response>()
{
  return "lifecycle_msgs::srv::GetAvailableStates_Response";
}

template<>
constexpr const char * name<lifecycle_msgs::srv::GetAvailableStates_Response>()
{
  return "lifecycle_msgs/srv/GetAvailableStates_Response";
}
...
template<>
struct MessageTraits<lifecycle_msgs::srv::GetAvailableStates_Response>
{
  static constexpr std::size_t member_count = 1;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "available_states",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, lifecycle_msgs::srv::GetAvailableStates_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<lifecycle_msgs::srv::GetAvailableStates_Event>()
{
  return "lifecycle_msgs::srv::GetAvailableStates_Event";
}

template<>
constexpr const char * name<lifecycle_msgs::srv::GetAvailableStates_Event>()
{
  return "lifecycle_msgs/srv/GetAvailableStates_Event";
}
...
template<>
struct MessageTraits<lifecycle_msgs::srv::GetAvailableStates_Event>
{
...
template<>
constexpr const char * data_type<lifecycle_msgs::srv::GetAvailableStates>()
{
  return "lifecycle_msgs::srv::GetAvailableStates";
}

template<>
constexpr const char * name<lifecycle_msgs::srv::GetAvailableStates>()
{
  return "lifecycle_msgs/srv/GetAvailableStates";
}
