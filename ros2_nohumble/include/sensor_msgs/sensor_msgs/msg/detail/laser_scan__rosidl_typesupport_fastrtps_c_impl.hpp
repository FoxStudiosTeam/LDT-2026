...
#ifndef SENSOR_MSGS__MSG__DETAIL__LASER_SCAN__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
#define SENSOR_MSGS__MSG__DETAIL__LASER_SCAN__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
...
inline
bool impl_cdr_serialize_sensor_msgs__msg__LaserScan(
...
inline
bool impl_cdr_deserialize_sensor_msgs__msg__LaserScan(
  eprosima::fastcdr::Cdr & cdr,
...
inline
size_t impl_get_serialized_size_sensor_msgs__msg__LaserScan(
...
inline
size_t impl_max_serialized_size_sensor_msgs__msg__LaserScan(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_key_sensor_msgs__msg__LaserScan(
  const sensor_msgs__msg__LaserScan * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
inline
size_t impl_get_serialized_size_key_sensor_msgs__msg__LaserScan(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LaserScan__ros_msg_type * ros_message = static_cast<const _LaserScan__ros_msg_type *>(untyped_ros_message);
...
inline
size_t impl_max_serialized_size_key_sensor_msgs__msg__LaserScan(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_with_endpoint_sensor_msgs__msg__LaserScan(
  const sensor_msgs__msg__LaserScan * ros_message,
  eprosima::fastcdr::Cdr & cdr,
...
inline
bool impl_cdr_deserialize_with_endpoint_sensor_msgs__msg__LaserScan(
  eprosima::fastcdr::Cdr & cdr,
  sensor_msgs__msg__LaserScan * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
...
#endif  // SENSOR_MSGS__MSG__DETAIL__LASER_SCAN__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
