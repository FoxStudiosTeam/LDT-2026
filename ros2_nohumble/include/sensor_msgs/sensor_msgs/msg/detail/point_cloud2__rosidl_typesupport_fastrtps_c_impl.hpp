...
#ifndef SENSOR_MSGS__MSG__DETAIL__POINT_CLOUD2__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
#define SENSOR_MSGS__MSG__DETAIL__POINT_CLOUD2__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
...
#include "sensor_msgs/msg/detail/point_field__rosidl_typesupport_fastrtps_c_impl.hpp"
...
inline
bool impl_cdr_serialize_sensor_msgs__msg__PointCloud2(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: fields
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_serialize_sensor_msgs__msg__PointField(
        &array_ptr[i], cdr);
    }
  }
...
inline
bool impl_cdr_deserialize_sensor_msgs__msg__PointCloud2(
  eprosima::fastcdr::Cdr & cdr,
  sensor_msgs__msg__PointCloud2 * ros_message)
{
  ...
  // Field name: fields
  {
    ...
    auto array_ptr = ros_message->fields.data;
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_deserialize_sensor_msgs__msg__PointField(cdr, &array_ptr[i]);
    }
  }
...
inline
size_t impl_get_serialized_size_sensor_msgs__msg__PointCloud2(
  ...
  size_t current_alignment)
{
  ...
  // Field name: fields
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += impl_get_serialized_size_sensor_msgs__msg__PointField(
...
inline
size_t impl_max_serialized_size_sensor_msgs__msg__PointCloud2(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: fields
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        impl_max_serialized_size_sensor_msgs__msg__PointField(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
inline
bool impl_cdr_serialize_key_sensor_msgs__msg__PointCloud2(
  const sensor_msgs__msg__PointCloud2 * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  ...
  // Field name: fields
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_serialize_key_sensor_msgs__msg__PointField(
        &array_ptr[i], cdr);
    }
  }
...
inline
size_t impl_get_serialized_size_key_sensor_msgs__msg__PointCloud2(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PointCloud2__ros_msg_type * ros_message = static_cast<const _PointCloud2__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: fields
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += impl_get_serialized_size_key_sensor_msgs__msg__PointField(
        &array_ptr[index], current_alignment);
    }
  }
...
inline
size_t impl_max_serialized_size_key_sensor_msgs__msg__PointCloud2(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: fields
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        impl_max_serialized_size_key_sensor_msgs__msg__PointField(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
inline
bool impl_cdr_serialize_with_endpoint_sensor_msgs__msg__PointCloud2(
  const sensor_msgs__msg__PointCloud2 * ros_message,
  eprosima::fastcdr::Cdr & cdr,
  ...
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Field name: fields
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_serialize_with_endpoint_sensor_msgs__msg__PointField(
...
inline
bool impl_cdr_deserialize_with_endpoint_sensor_msgs__msg__PointCloud2(
  eprosima::fastcdr::Cdr & cdr,
  sensor_msgs__msg__PointCloud2 * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Field name: fields
  {
    ...
    auto array_ptr = ros_message->fields.data;
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_deserialize_with_endpoint_sensor_msgs__msg__PointField(cdr, &array_ptr[i], endpoint_info, serialization_context);
    }
  }
...
#endif  // SENSOR_MSGS__MSG__DETAIL__POINT_CLOUD2__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
