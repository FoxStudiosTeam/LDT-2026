...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, sensor_msgs::msg::Imu>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).header,
    std::forward<T>(msg).orientation,
    std::forward<T>(msg).orientation_covariance,
    std::forward<T>(msg).angular_velocity,
    std::forward<T>(msg).angular_velocity_covariance,
    std::forward<T>(msg).linear_acceleration,
    std::forward<T>(msg).linear_acceleration_covariance);
}
...
template<>
constexpr const char * data_type<sensor_msgs::msg::Imu>()
{
  return "sensor_msgs::msg::Imu";
}

template<>
constexpr const char * name<sensor_msgs::msg::Imu>()
{
  return "sensor_msgs/msg/Imu";
}
...
template<>
struct MessageTraits<sensor_msgs::msg::Imu>
{
