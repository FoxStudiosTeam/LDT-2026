...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, map_msgs::srv::SetMapProjections_Request>, int> = 0>
...
template<>
constexpr const char * data_type<map_msgs::srv::SetMapProjections_Request>()
{
  return "map_msgs::srv::SetMapProjections_Request";
}

template<>
constexpr const char * name<map_msgs::srv::SetMapProjections_Request>()
{
  return "map_msgs/srv/SetMapProjections_Request";
}
...
template<>
struct MessageTraits<map_msgs::srv::SetMapProjections_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, map_msgs::srv::SetMapProjections_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<map_msgs::srv::SetMapProjections_Response>()
{
  return "map_msgs::srv::SetMapProjections_Response";
}

template<>
constexpr const char * name<map_msgs::srv::SetMapProjections_Response>()
{
  return "map_msgs/srv/SetMapProjections_Response";
}
...
template<>
struct MessageTraits<map_msgs::srv::SetMapProjections_Response>
{
  static constexpr std::size_t member_count = 1;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "projected_maps_info",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, map_msgs::srv::SetMapProjections_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<map_msgs::srv::SetMapProjections_Event>()
{
  return "map_msgs::srv::SetMapProjections_Event";
}

template<>
constexpr const char * name<map_msgs::srv::SetMapProjections_Event>()
{
  return "map_msgs/srv/SetMapProjections_Event";
}
...
template<>
struct MessageTraits<map_msgs::srv::SetMapProjections_Event>
{
...
template<>
constexpr const char * data_type<map_msgs::srv::SetMapProjections>()
{
  return "map_msgs::srv::SetMapProjections";
}

template<>
constexpr const char * name<map_msgs::srv::SetMapProjections>()
{
  return "map_msgs/srv/SetMapProjections";
}
