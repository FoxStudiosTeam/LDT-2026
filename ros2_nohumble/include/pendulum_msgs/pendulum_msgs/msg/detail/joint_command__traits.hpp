...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, pendulum_msgs::msg::JointCommand>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(std::forward<T>(msg).position);
}
...
template<>
constexpr const char * data_type<pendulum_msgs::msg::JointCommand>()
{
  return "pendulum_msgs::msg::JointCommand";
}

template<>
constexpr const char * name<pendulum_msgs::msg::JointCommand>()
{
  return "pendulum_msgs/msg/JointCommand";
}
...
template<>
struct MessageTraits<pendulum_msgs::msg::JointCommand>
{
