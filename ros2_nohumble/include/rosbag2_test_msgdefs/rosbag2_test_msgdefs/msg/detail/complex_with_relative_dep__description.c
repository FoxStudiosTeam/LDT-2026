  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xbb, 0xeb, 0x53, 0x37, 0x7e, 0xdc, 0x4b, 0x64,
      0x56, 0xa1, 0x48, 0xbf, 0x66, 0x16, 0x7d, 0x71,
      0x9f, 0x7d, 0x7a, 0x3d, 0xb9, 0xc8, 0xaf, 0xc8,
      0xa8, 0x0b, 0x24, 0xfe, 0x13, 0xd6, 0x69, 0x13,
    }};
  return &hash;
}
...
static char rosbag2_test_msgdefs__msg__ComplexWithRelativeDep__TYPE_NAME[] = "rosbag2_test_msgdefs/msg/ComplexWithRelativeDep";
static char rosbag2_test_msgdefs__msg__BasicIdl__TYPE_NAME[] = "rosbag2_test_msgdefs/msg/BasicIdl";

// Define type names, field names, and default values
static char rosbag2_test_msgdefs__msg__ComplexWithRelativeDep__FIELD_NAME__a[] = "a";

static rosidl_runtime_c__type_description__Field rosbag2_test_msgdefs__msg__ComplexWithRelativeDep__FIELDS[] = {
  {
    {rosbag2_test_msgdefs__msg__ComplexWithRelativeDep__FIELD_NAME__a, 1, 1},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rosbag2_test_msgdefs__msg__ComplexWithRelativeDep__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {rosbag2_test_msgdefs__msg__BasicIdl__TYPE_NAME, 33, 33},
    {NULL, 0, 0},
  },
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {rosbag2_test_msgdefs__msg__ComplexWithRelativeDep__TYPE_NAME, 47, 47},
      {rosbag2_test_msgdefs__msg__ComplexWithRelativeDep__FIELDS, 1, 1},
    },
    {rosbag2_test_msgdefs__msg__ComplexWithRelativeDep__REFERENCED_TYPE_DESCRIPTIONS, 1, 1},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rosbag2_test_msgdefs__msg__ComplexWithRelativeDep__get_individual_type_description_source(NULL),
