...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, rosbag2_test_msgdefs::msg::BasicMsg>, int> = 0>
...
template<>
constexpr const char * data_type<rosbag2_test_msgdefs::msg::BasicMsg>()
{
  return "rosbag2_test_msgdefs::msg::BasicMsg";
}

template<>
constexpr const char * name<rosbag2_test_msgdefs::msg::BasicMsg>()
{
  return "rosbag2_test_msgdefs/msg/BasicMsg";
}
...
template<>
struct MessageTraits<rosbag2_test_msgdefs::msg::BasicMsg>
{
