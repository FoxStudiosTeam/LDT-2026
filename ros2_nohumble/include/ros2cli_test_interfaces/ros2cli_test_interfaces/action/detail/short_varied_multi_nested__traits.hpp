...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, ros2cli_test_interfaces::action::ShortVariedMultiNested_Goal>, int> = 0>
...
template<>
constexpr const char * data_type<ros2cli_test_interfaces::action::ShortVariedMultiNested_Goal>()
{
  return "ros2cli_test_interfaces::action::ShortVariedMultiNested_Goal";
}

template<>
constexpr const char * name<ros2cli_test_interfaces::action::ShortVariedMultiNested_Goal>()
{
  return "ros2cli_test_interfaces/action/ShortVariedMultiNested_Goal";
}
...
template<>
struct MessageTraits<ros2cli_test_interfaces::action::ShortVariedMultiNested_Goal>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, ros2cli_test_interfaces::action::ShortVariedMultiNested_Result>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<ros2cli_test_interfaces::action::ShortVariedMultiNested_Result>()
{
  return "ros2cli_test_interfaces::action::ShortVariedMultiNested_Result";
}

template<>
constexpr const char * name<ros2cli_test_interfaces::action::ShortVariedMultiNested_Result>()
{
  return "ros2cli_test_interfaces/action/ShortVariedMultiNested_Result";
}
...
template<>
struct MessageTraits<ros2cli_test_interfaces::action::ShortVariedMultiNested_Result>
{
  static constexpr std::size_t member_count = 1;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "bool_value",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, ros2cli_test_interfaces::action::ShortVariedMultiNested_Feedback>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(std::forward<T>(msg).bool_values);
}
...
template<>
constexpr const char * data_type<ros2cli_test_interfaces::action::ShortVariedMultiNested_Feedback>()
{
  return "ros2cli_test_interfaces::action::ShortVariedMultiNested_Feedback";
}

template<>
constexpr const char * name<ros2cli_test_interfaces::action::ShortVariedMultiNested_Feedback>()
{
  return "ros2cli_test_interfaces/action/ShortVariedMultiNested_Feedback";
}
...
template<>
struct MessageTraits<ros2cli_test_interfaces::action::ShortVariedMultiNested_Feedback>
{
  static constexpr std::size_t member_count = 1;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "bool_values",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, ros2cli_test_interfaces::action::ShortVariedMultiNested_SendGoal_Request>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<ros2cli_test_interfaces::action::ShortVariedMultiNested_SendGoal_Request>()
{
  return "ros2cli_test_interfaces::action::ShortVariedMultiNested_SendGoal_Request";
}

template<>
constexpr const char * name<ros2cli_test_interfaces::action::ShortVariedMultiNested_SendGoal_Request>()
{
  return "ros2cli_test_interfaces/action/ShortVariedMultiNested_SendGoal_Request";
}
...
template<>
struct MessageTraits<ros2cli_test_interfaces::action::ShortVariedMultiNested_SendGoal_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, ros2cli_test_interfaces::action::ShortVariedMultiNested_SendGoal_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<ros2cli_test_interfaces::action::ShortVariedMultiNested_SendGoal_Response>()
{
  return "ros2cli_test_interfaces::action::ShortVariedMultiNested_SendGoal_Response";
}

template<>
constexpr const char * name<ros2cli_test_interfaces::action::ShortVariedMultiNested_SendGoal_Response>()
{
  return "ros2cli_test_interfaces/action/ShortVariedMultiNested_SendGoal_Response";
}
...
template<>
struct MessageTraits<ros2cli_test_interfaces::action::ShortVariedMultiNested_SendGoal_Response>
{
  static constexpr std::size_t member_count = 2;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "accepted",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, ros2cli_test_interfaces::action::ShortVariedMultiNested_SendGoal_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<ros2cli_test_interfaces::action::ShortVariedMultiNested_SendGoal_Event>()
{
  return "ros2cli_test_interfaces::action::ShortVariedMultiNested_SendGoal_Event";
}

template<>
constexpr const char * name<ros2cli_test_interfaces::action::ShortVariedMultiNested_SendGoal_Event>()
{
  return "ros2cli_test_interfaces/action/ShortVariedMultiNested_SendGoal_Event";
}
...
template<>
struct MessageTraits<ros2cli_test_interfaces::action::ShortVariedMultiNested_SendGoal_Event>
{
...
template<>
constexpr const char * data_type<ros2cli_test_interfaces::action::ShortVariedMultiNested_SendGoal>()
{
  return "ros2cli_test_interfaces::action::ShortVariedMultiNested_SendGoal";
}

template<>
constexpr const char * name<ros2cli_test_interfaces::action::ShortVariedMultiNested_SendGoal>()
{
  return "ros2cli_test_interfaces/action/ShortVariedMultiNested_SendGoal";
}
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, ros2cli_test_interfaces::action::ShortVariedMultiNested_GetResult_Request>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<ros2cli_test_interfaces::action::ShortVariedMultiNested_GetResult_Request>()
{
  return "ros2cli_test_interfaces::action::ShortVariedMultiNested_GetResult_Request";
}

template<>
constexpr const char * name<ros2cli_test_interfaces::action::ShortVariedMultiNested_GetResult_Request>()
{
  return "ros2cli_test_interfaces/action/ShortVariedMultiNested_GetResult_Request";
}
...
template<>
struct MessageTraits<ros2cli_test_interfaces::action::ShortVariedMultiNested_GetResult_Request>
{
  static constexpr std::size_t member_count = 1;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "goal_id",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, ros2cli_test_interfaces::action::ShortVariedMultiNested_GetResult_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<ros2cli_test_interfaces::action::ShortVariedMultiNested_GetResult_Response>()
{
  return "ros2cli_test_interfaces::action::ShortVariedMultiNested_GetResult_Response";
}

template<>
constexpr const char * name<ros2cli_test_interfaces::action::ShortVariedMultiNested_GetResult_Response>()
{
  return "ros2cli_test_interfaces/action/ShortVariedMultiNested_GetResult_Response";
}
...
template<>
struct MessageTraits<ros2cli_test_interfaces::action::ShortVariedMultiNested_GetResult_Response>
{
  static constexpr std::size_t member_count = 2;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "status",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, ros2cli_test_interfaces::action::ShortVariedMultiNested_GetResult_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).info,
...
template<>
constexpr const char * data_type<ros2cli_test_interfaces::action::ShortVariedMultiNested_GetResult_Event>()
{
  return "ros2cli_test_interfaces::action::ShortVariedMultiNested_GetResult_Event";
}

template<>
constexpr const char * name<ros2cli_test_interfaces::action::ShortVariedMultiNested_GetResult_Event>()
{
  return "ros2cli_test_interfaces/action/ShortVariedMultiNested_GetResult_Event";
}
...
template<>
struct MessageTraits<ros2cli_test_interfaces::action::ShortVariedMultiNested_GetResult_Event>
{
  static constexpr std::size_t member_count = 3;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "info",
...
template<>
constexpr const char * data_type<ros2cli_test_interfaces::action::ShortVariedMultiNested_GetResult>()
{
  return "ros2cli_test_interfaces::action::ShortVariedMultiNested_GetResult";
}

template<>
constexpr const char * name<ros2cli_test_interfaces::action::ShortVariedMultiNested_GetResult>()
{
  return "ros2cli_test_interfaces/action/ShortVariedMultiNested_GetResult";
}
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, ros2cli_test_interfaces::action::ShortVariedMultiNested_FeedbackMessage>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).goal_id,
...
template<>
constexpr const char * data_type<ros2cli_test_interfaces::action::ShortVariedMultiNested_FeedbackMessage>()
{
  return "ros2cli_test_interfaces::action::ShortVariedMultiNested_FeedbackMessage";
}

template<>
constexpr const char * name<ros2cli_test_interfaces::action::ShortVariedMultiNested_FeedbackMessage>()
{
  return "ros2cli_test_interfaces/action/ShortVariedMultiNested_FeedbackMessage";
}
...
template<>
struct MessageTraits<ros2cli_test_interfaces::action::ShortVariedMultiNested_FeedbackMessage>
{
  static constexpr std::size_t member_count = 2;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "goal_id",
...
template<>
constexpr const char * data_type<ros2cli_test_interfaces::action::ShortVariedMultiNested>()
{
  return "ros2cli_test_interfaces::action::ShortVariedMultiNested";
}

template<>
constexpr const char * name<ros2cli_test_interfaces::action::ShortVariedMultiNested>()
{
  return "ros2cli_test_interfaces/action/ShortVariedMultiNested";
}
