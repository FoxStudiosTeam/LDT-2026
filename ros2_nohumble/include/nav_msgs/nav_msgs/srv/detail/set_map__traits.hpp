...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav_msgs::srv::SetMap_Request>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).map,
    std::forward<T>(msg).initial_pose);
}
...
template<>
constexpr const char * data_type<nav_msgs::srv::SetMap_Request>()
{
  return "nav_msgs::srv::SetMap_Request";
}

template<>
constexpr const char * name<nav_msgs::srv::SetMap_Request>()
{
  return "nav_msgs/srv/SetMap_Request";
}
...
template<>
struct MessageTraits<nav_msgs::srv::SetMap_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav_msgs::srv::SetMap_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<nav_msgs::srv::SetMap_Response>()
{
  return "nav_msgs::srv::SetMap_Response";
}

template<>
constexpr const char * name<nav_msgs::srv::SetMap_Response>()
{
  return "nav_msgs/srv/SetMap_Response";
}
...
template<>
struct MessageTraits<nav_msgs::srv::SetMap_Response>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav_msgs::srv::SetMap_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<nav_msgs::srv::SetMap_Event>()
{
  return "nav_msgs::srv::SetMap_Event";
}

template<>
constexpr const char * name<nav_msgs::srv::SetMap_Event>()
{
  return "nav_msgs/srv/SetMap_Event";
}
...
template<>
struct MessageTraits<nav_msgs::srv::SetMap_Event>
{
...
template<>
constexpr const char * data_type<nav_msgs::srv::SetMap>()
{
  return "nav_msgs::srv::SetMap";
}

template<>
constexpr const char * name<nav_msgs::srv::SetMap>()
{
  return "nav_msgs/srv/SetMap";
}
