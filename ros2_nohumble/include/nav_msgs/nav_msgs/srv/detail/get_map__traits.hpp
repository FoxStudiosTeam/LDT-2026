...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav_msgs::srv::GetMap_Request>, int> = 0>
...
template<>
constexpr const char * data_type<nav_msgs::srv::GetMap_Request>()
{
  return "nav_msgs::srv::GetMap_Request";
}

template<>
constexpr const char * name<nav_msgs::srv::GetMap_Request>()
{
  return "nav_msgs/srv/GetMap_Request";
}
...
template<>
struct MessageTraits<nav_msgs::srv::GetMap_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav_msgs::srv::GetMap_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<nav_msgs::srv::GetMap_Response>()
{
  return "nav_msgs::srv::GetMap_Response";
}

template<>
constexpr const char * name<nav_msgs::srv::GetMap_Response>()
{
  return "nav_msgs/srv/GetMap_Response";
}
...
template<>
struct MessageTraits<nav_msgs::srv::GetMap_Response>
{
  static constexpr std::size_t member_count = 1;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "map",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav_msgs::srv::GetMap_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<nav_msgs::srv::GetMap_Event>()
{
  return "nav_msgs::srv::GetMap_Event";
}

template<>
constexpr const char * name<nav_msgs::srv::GetMap_Event>()
{
  return "nav_msgs/srv/GetMap_Event";
}
...
template<>
struct MessageTraits<nav_msgs::srv::GetMap_Event>
{
...
template<>
constexpr const char * data_type<nav_msgs::srv::GetMap>()
{
  return "nav_msgs::srv::GetMap";
}

template<>
constexpr const char * name<nav_msgs::srv::GetMap>()
{
  return "nav_msgs/srv/GetMap";
}
