...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, nav_msgs::msg::OccupancyGrid>, int> = 0>
...
template<>
constexpr const char * data_type<nav_msgs::msg::OccupancyGrid>()
{
  return "nav_msgs::msg::OccupancyGrid";
}

template<>
constexpr const char * name<nav_msgs::msg::OccupancyGrid>()
{
  return "nav_msgs/msg/OccupancyGrid";
}
...
template<>
struct MessageTraits<nav_msgs::msg::OccupancyGrid>
{
