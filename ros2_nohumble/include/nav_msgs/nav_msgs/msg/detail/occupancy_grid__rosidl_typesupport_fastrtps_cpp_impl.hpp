...
#ifndef NAV_MSGS__MSG__DETAIL__OCCUPANCY_GRID__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
#define NAV_MSGS__MSG__DETAIL__OCCUPANCY_GRID__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
...
#include "nav_msgs/msg/detail/map_meta_data__rosidl_typesupport_fastrtps_cpp_impl.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        nav_msgs::msg::typesupport_fastrtps_cpp::detail::max_serialized_size_MapMetaData(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  size_t current_alignment)
{
  ...
  // Member: info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        nav_msgs::msg::typesupport_fastrtps_cpp::detail::max_serialized_size_key_MapMetaData(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
#endif  // NAV_MSGS__MSG__DETAIL__OCCUPANCY_GRID__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
