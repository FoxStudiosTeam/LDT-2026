...
#ifndef ROSGRAPH_MSGS__MSG__DETAIL__CLOCK__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
#define ROSGRAPH_MSGS__MSG__DETAIL__CLOCK__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
...
inline
bool impl_cdr_serialize_rosgraph_msgs__msg__Clock(
...
inline
bool impl_cdr_deserialize_rosgraph_msgs__msg__Clock(
  eprosima::fastcdr::Cdr & cdr,
  rosgraph_msgs__msg__Clock * ros_message)
{
  // Field name: clock
  {
    impl_cdr_deserialize_builtin_interfaces__msg__Time(cdr, &ros_message->clock);
  }
...
inline
size_t impl_get_serialized_size_rosgraph_msgs__msg__Clock(
...
inline
size_t impl_max_serialized_size_rosgraph_msgs__msg__Clock(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_key_rosgraph_msgs__msg__Clock(
  const rosgraph_msgs__msg__Clock * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: clock
...
inline
size_t impl_get_serialized_size_key_rosgraph_msgs__msg__Clock(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Clock__ros_msg_type * ros_message = static_cast<const _Clock__ros_msg_type *>(untyped_ros_message);
...
inline
size_t impl_max_serialized_size_key_rosgraph_msgs__msg__Clock(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_with_endpoint_rosgraph_msgs__msg__Clock(
  const rosgraph_msgs__msg__Clock * ros_message,
  eprosima::fastcdr::Cdr & cdr,
  ...
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Field name: clock
  {
    impl_cdr_serialize_with_endpoint_builtin_interfaces__msg__Time(
      &ros_message->clock, cdr, endpoint_info, serialization_context);
  }
...
inline
bool impl_cdr_deserialize_with_endpoint_rosgraph_msgs__msg__Clock(
  eprosima::fastcdr::Cdr & cdr,
  rosgraph_msgs__msg__Clock * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Field name: clock
  {
    impl_cdr_deserialize_with_endpoint_builtin_interfaces__msg__Time(cdr, &ros_message->clock, endpoint_info, serialization_context);
  }
...
#endif  // ROSGRAPH_MSGS__MSG__DETAIL__CLOCK__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
