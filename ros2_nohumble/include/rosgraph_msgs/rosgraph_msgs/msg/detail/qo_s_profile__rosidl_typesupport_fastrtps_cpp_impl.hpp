...
#ifndef ROSGRAPH_MSGS__MSG__DETAIL__QO_S_PROFILE__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
#define ROSGRAPH_MSGS__MSG__DETAIL__QO_S_PROFILE__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
...
#include "rosgraph_msgs/msg/detail/qo_s_profile__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  builtin_interfaces::msg::typesupport_fastrtps_cpp::detail::cdr_serialize(
    ros_message.liveliness_lease_duration,
    cdr);
  ...
  rosgraph_msgs::msg::QoSProfile & ros_message)
{
  ...
  // Member: liveliness_lease_duration
  builtin_interfaces::msg::typesupport_fastrtps_cpp::detail::cdr_deserialize(
    cdr, ros_message.liveliness_lease_duration);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rosgraph_msgs::msg::QoSProfile;
    is_plain =
      (
...
#endif  // ROSGRAPH_MSGS__MSG__DETAIL__QO_S_PROFILE__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
