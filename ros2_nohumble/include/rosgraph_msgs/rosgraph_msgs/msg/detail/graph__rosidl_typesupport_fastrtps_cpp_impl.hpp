...
#ifndef ROSGRAPH_MSGS__MSG__DETAIL__GRAPH__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
#define ROSGRAPH_MSGS__MSG__DETAIL__GRAPH__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
...
#include "rosgraph_msgs/msg/detail/graph__rosidl_typesupport_fastrtps_cpp.hpp"
#include "fastcdr/Cdr.h"

// Include the inline (de)serialization headers of nested message types so
// their bodies are visible here and can be fully inlined by the compiler.
#include "rosgraph_msgs/msg/detail/node__rosidl_typesupport_fastrtps_cpp_impl.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rosgraph_msgs::msg::typesupport_fastrtps_cpp::detail::max_serialized_size_Node(
  ...
  if (is_plain) {
    ...
    using DataType = rosgraph_msgs::msg::Graph;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rosgraph_msgs::msg::typesupport_fastrtps_cpp::detail::max_serialized_size_key_Node(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
#endif  // ROSGRAPH_MSGS__MSG__DETAIL__GRAPH__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
