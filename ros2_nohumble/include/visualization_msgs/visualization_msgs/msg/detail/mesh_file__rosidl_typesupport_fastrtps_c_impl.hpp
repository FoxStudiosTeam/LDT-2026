...
#ifndef VISUALIZATION_MSGS__MSG__DETAIL__MESH_FILE__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
#define VISUALIZATION_MSGS__MSG__DETAIL__MESH_FILE__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
...
inline
bool impl_cdr_serialize_visualization_msgs__msg__MeshFile(
...
inline
bool impl_cdr_deserialize_visualization_msgs__msg__MeshFile(
  eprosima::fastcdr::Cdr & cdr,
...
inline
size_t impl_get_serialized_size_visualization_msgs__msg__MeshFile(
...
inline
size_t impl_max_serialized_size_visualization_msgs__msg__MeshFile(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_key_visualization_msgs__msg__MeshFile(
  const visualization_msgs__msg__MeshFile * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: filename
...
inline
size_t impl_get_serialized_size_key_visualization_msgs__msg__MeshFile(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MeshFile__ros_msg_type * ros_message = static_cast<const _MeshFile__ros_msg_type *>(untyped_ros_message);
...
inline
size_t impl_max_serialized_size_key_visualization_msgs__msg__MeshFile(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_with_endpoint_visualization_msgs__msg__MeshFile(
  const visualization_msgs__msg__MeshFile * ros_message,
  eprosima::fastcdr::Cdr & cdr,
...
inline
bool impl_cdr_deserialize_with_endpoint_visualization_msgs__msg__MeshFile(
  eprosima::fastcdr::Cdr & cdr,
  visualization_msgs__msg__MeshFile * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
...
#endif  // VISUALIZATION_MSGS__MSG__DETAIL__MESH_FILE__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
