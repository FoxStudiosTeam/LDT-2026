...
#ifndef VISUALIZATION_MSGS__MSG__DETAIL__INTERACTIVE_MARKER_FEEDBACK__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
#define VISUALIZATION_MSGS__MSG__DETAIL__INTERACTIVE_MARKER_FEEDBACK__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
  ...
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Member: mouse_point_valid
  cdr >> ros_message.mouse_point_valid;
...
#endif  // VISUALIZATION_MSGS__MSG__DETAIL__INTERACTIVE_MARKER_FEEDBACK__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
