...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, example_interfaces::msg::Bool>, int> = 0>
...
template<>
constexpr const char * data_type<example_interfaces::msg::Bool>()
{
  return "example_interfaces::msg::Bool";
}

template<>
constexpr const char * name<example_interfaces::msg::Bool>()
{
  return "example_interfaces/msg/Bool";
}
...
template<>
struct MessageTraits<example_interfaces::msg::Bool>
{
