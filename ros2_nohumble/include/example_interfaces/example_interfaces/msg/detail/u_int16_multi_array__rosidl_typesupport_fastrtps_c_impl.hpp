...
#ifndef EXAMPLE_INTERFACES__MSG__DETAIL__U_INT16_MULTI_ARRAY__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
#define EXAMPLE_INTERFACES__MSG__DETAIL__U_INT16_MULTI_ARRAY__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
...
inline
bool impl_cdr_serialize_example_interfaces__msg__UInt16MultiArray(
...
inline
bool impl_cdr_deserialize_example_interfaces__msg__UInt16MultiArray(
  eprosima::fastcdr::Cdr & cdr,
...
inline
size_t impl_get_serialized_size_example_interfaces__msg__UInt16MultiArray(
...
inline
size_t impl_max_serialized_size_example_interfaces__msg__UInt16MultiArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_key_example_interfaces__msg__UInt16MultiArray(
  const example_interfaces__msg__UInt16MultiArray * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: layout
...
inline
size_t impl_get_serialized_size_key_example_interfaces__msg__UInt16MultiArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _UInt16MultiArray__ros_msg_type * ros_message = static_cast<const _UInt16MultiArray__ros_msg_type *>(untyped_ros_message);
...
inline
size_t impl_max_serialized_size_key_example_interfaces__msg__UInt16MultiArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_with_endpoint_example_interfaces__msg__UInt16MultiArray(
  const example_interfaces__msg__UInt16MultiArray * ros_message,
  eprosima::fastcdr::Cdr & cdr,
...
inline
bool impl_cdr_deserialize_with_endpoint_example_interfaces__msg__UInt16MultiArray(
  eprosima::fastcdr::Cdr & cdr,
  example_interfaces__msg__UInt16MultiArray * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
...
#endif  // EXAMPLE_INTERFACES__MSG__DETAIL__U_INT16_MULTI_ARRAY__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
