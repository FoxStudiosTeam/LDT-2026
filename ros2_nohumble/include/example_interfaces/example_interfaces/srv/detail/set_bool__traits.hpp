...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, example_interfaces::srv::SetBool_Request>, int> = 0>
...
template<>
constexpr const char * data_type<example_interfaces::srv::SetBool_Request>()
{
  return "example_interfaces::srv::SetBool_Request";
}

template<>
constexpr const char * name<example_interfaces::srv::SetBool_Request>()
{
  return "example_interfaces/srv/SetBool_Request";
}
...
template<>
struct MessageTraits<example_interfaces::srv::SetBool_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, example_interfaces::srv::SetBool_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<example_interfaces::srv::SetBool_Response>()
{
  return "example_interfaces::srv::SetBool_Response";
}

template<>
constexpr const char * name<example_interfaces::srv::SetBool_Response>()
{
  return "example_interfaces/srv/SetBool_Response";
}
...
template<>
struct MessageTraits<example_interfaces::srv::SetBool_Response>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, example_interfaces::srv::SetBool_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<example_interfaces::srv::SetBool_Event>()
{
  return "example_interfaces::srv::SetBool_Event";
}

template<>
constexpr const char * name<example_interfaces::srv::SetBool_Event>()
{
  return "example_interfaces/srv/SetBool_Event";
}
...
template<>
struct MessageTraits<example_interfaces::srv::SetBool_Event>
{
...
template<>
constexpr const char * data_type<example_interfaces::srv::SetBool>()
{
  return "example_interfaces::srv::SetBool";
}

template<>
constexpr const char * name<example_interfaces::srv::SetBool>()
{
  return "example_interfaces/srv/SetBool";
}
