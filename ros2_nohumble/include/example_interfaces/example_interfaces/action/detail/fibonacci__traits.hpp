...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, example_interfaces::action::Fibonacci_Goal>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(std::forward<T>(msg).order);
}
...
template<>
constexpr const char * data_type<example_interfaces::action::Fibonacci_Goal>()
{
  return "example_interfaces::action::Fibonacci_Goal";
}

template<>
constexpr const char * name<example_interfaces::action::Fibonacci_Goal>()
{
  return "example_interfaces/action/Fibonacci_Goal";
}
...
template<>
struct MessageTraits<example_interfaces::action::Fibonacci_Goal>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, example_interfaces::action::Fibonacci_Result>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(std::forward<T>(msg).sequence);
}
...
template<>
constexpr const char * data_type<example_interfaces::action::Fibonacci_Result>()
{
  return "example_interfaces::action::Fibonacci_Result";
}

template<>
constexpr const char * name<example_interfaces::action::Fibonacci_Result>()
{
  return "example_interfaces/action/Fibonacci_Result";
}
...
template<>
struct MessageTraits<example_interfaces::action::Fibonacci_Result>
{
  static constexpr std::size_t member_count = 1;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "sequence",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, example_interfaces::action::Fibonacci_Feedback>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(std::forward<T>(msg).sequence);
}
...
template<>
constexpr const char * data_type<example_interfaces::action::Fibonacci_Feedback>()
{
  return "example_interfaces::action::Fibonacci_Feedback";
}

template<>
constexpr const char * name<example_interfaces::action::Fibonacci_Feedback>()
{
  return "example_interfaces/action/Fibonacci_Feedback";
}
...
template<>
struct MessageTraits<example_interfaces::action::Fibonacci_Feedback>
{
  static constexpr std::size_t member_count = 1;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "sequence",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, example_interfaces::action::Fibonacci_SendGoal_Request>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<example_interfaces::action::Fibonacci_SendGoal_Request>()
{
  return "example_interfaces::action::Fibonacci_SendGoal_Request";
}

template<>
constexpr const char * name<example_interfaces::action::Fibonacci_SendGoal_Request>()
{
  return "example_interfaces/action/Fibonacci_SendGoal_Request";
}
...
template<>
struct MessageTraits<example_interfaces::action::Fibonacci_SendGoal_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, example_interfaces::action::Fibonacci_SendGoal_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<example_interfaces::action::Fibonacci_SendGoal_Response>()
{
  return "example_interfaces::action::Fibonacci_SendGoal_Response";
}

template<>
constexpr const char * name<example_interfaces::action::Fibonacci_SendGoal_Response>()
{
  return "example_interfaces/action/Fibonacci_SendGoal_Response";
}
...
template<>
struct MessageTraits<example_interfaces::action::Fibonacci_SendGoal_Response>
{
  static constexpr std::size_t member_count = 2;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "accepted",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, example_interfaces::action::Fibonacci_SendGoal_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<example_interfaces::action::Fibonacci_SendGoal_Event>()
{
  return "example_interfaces::action::Fibonacci_SendGoal_Event";
}

template<>
constexpr const char * name<example_interfaces::action::Fibonacci_SendGoal_Event>()
{
  return "example_interfaces/action/Fibonacci_SendGoal_Event";
}
...
template<>
struct MessageTraits<example_interfaces::action::Fibonacci_SendGoal_Event>
{
...
template<>
constexpr const char * data_type<example_interfaces::action::Fibonacci_SendGoal>()
{
  return "example_interfaces::action::Fibonacci_SendGoal";
}

template<>
constexpr const char * name<example_interfaces::action::Fibonacci_SendGoal>()
{
  return "example_interfaces/action/Fibonacci_SendGoal";
}
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, example_interfaces::action::Fibonacci_GetResult_Request>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<example_interfaces::action::Fibonacci_GetResult_Request>()
{
  return "example_interfaces::action::Fibonacci_GetResult_Request";
}

template<>
constexpr const char * name<example_interfaces::action::Fibonacci_GetResult_Request>()
{
  return "example_interfaces/action/Fibonacci_GetResult_Request";
}
...
template<>
struct MessageTraits<example_interfaces::action::Fibonacci_GetResult_Request>
{
  static constexpr std::size_t member_count = 1;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "goal_id",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, example_interfaces::action::Fibonacci_GetResult_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<example_interfaces::action::Fibonacci_GetResult_Response>()
{
  return "example_interfaces::action::Fibonacci_GetResult_Response";
}

template<>
constexpr const char * name<example_interfaces::action::Fibonacci_GetResult_Response>()
{
  return "example_interfaces/action/Fibonacci_GetResult_Response";
}
...
template<>
struct MessageTraits<example_interfaces::action::Fibonacci_GetResult_Response>
{
  static constexpr std::size_t member_count = 2;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "status",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, example_interfaces::action::Fibonacci_GetResult_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).info,
...
template<>
constexpr const char * data_type<example_interfaces::action::Fibonacci_GetResult_Event>()
{
  return "example_interfaces::action::Fibonacci_GetResult_Event";
}

template<>
constexpr const char * name<example_interfaces::action::Fibonacci_GetResult_Event>()
{
  return "example_interfaces/action/Fibonacci_GetResult_Event";
}
...
template<>
struct MessageTraits<example_interfaces::action::Fibonacci_GetResult_Event>
{
  static constexpr std::size_t member_count = 3;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "info",
...
template<>
constexpr const char * data_type<example_interfaces::action::Fibonacci_GetResult>()
{
  return "example_interfaces::action::Fibonacci_GetResult";
}

template<>
constexpr const char * name<example_interfaces::action::Fibonacci_GetResult>()
{
  return "example_interfaces/action/Fibonacci_GetResult";
}
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, example_interfaces::action::Fibonacci_FeedbackMessage>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).goal_id,
...
template<>
constexpr const char * data_type<example_interfaces::action::Fibonacci_FeedbackMessage>()
{
  return "example_interfaces::action::Fibonacci_FeedbackMessage";
}

template<>
constexpr const char * name<example_interfaces::action::Fibonacci_FeedbackMessage>()
{
  return "example_interfaces/action/Fibonacci_FeedbackMessage";
}
...
template<>
struct MessageTraits<example_interfaces::action::Fibonacci_FeedbackMessage>
{
  static constexpr std::size_t member_count = 2;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "goal_id",
...
template<>
constexpr const char * data_type<example_interfaces::action::Fibonacci>()
{
  return "example_interfaces::action::Fibonacci";
}

template<>
constexpr const char * name<example_interfaces::action::Fibonacci>()
{
  return "example_interfaces/action/Fibonacci";
}
