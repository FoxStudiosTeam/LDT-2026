...
#ifndef TEST_ROSIDL_BUFFER__MSG__DETAIL__BYTE_ARRAY__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
#define TEST_ROSIDL_BUFFER__MSG__DETAIL__BYTE_ARRAY__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
...
#include "test_rosidl_buffer/msg/detail/byte_array__rosidl_typesupport_fastrtps_c.h"
...
using _ByteArray__ros_msg_type = test_rosidl_buffer__msg__ByteArray;


inline
bool impl_cdr_serialize_test_rosidl_buffer__msg__ByteArray(
...
inline
bool impl_cdr_deserialize_test_rosidl_buffer__msg__ByteArray(
  eprosima::fastcdr::Cdr & cdr,
...
inline
size_t impl_get_serialized_size_test_rosidl_buffer__msg__ByteArray(
...
inline
size_t impl_max_serialized_size_test_rosidl_buffer__msg__ByteArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = test_rosidl_buffer__msg__ByteArray;
    is_plain =
      (
...
inline
bool impl_cdr_serialize_key_test_rosidl_buffer__msg__ByteArray(
  const test_rosidl_buffer__msg__ByteArray * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: seq
...
inline
size_t impl_get_serialized_size_key_test_rosidl_buffer__msg__ByteArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ByteArray__ros_msg_type * ros_message = static_cast<const _ByteArray__ros_msg_type *>(untyped_ros_message);
...
inline
size_t impl_max_serialized_size_key_test_rosidl_buffer__msg__ByteArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_with_endpoint_test_rosidl_buffer__msg__ByteArray(
  const test_rosidl_buffer__msg__ByteArray * ros_message,
  eprosima::fastcdr::Cdr & cdr,
...
inline
bool impl_cdr_deserialize_with_endpoint_test_rosidl_buffer__msg__ByteArray(
  eprosima::fastcdr::Cdr & cdr,
  test_rosidl_buffer__msg__ByteArray * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
...
#endif  // TEST_ROSIDL_BUFFER__MSG__DETAIL__BYTE_ARRAY__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
