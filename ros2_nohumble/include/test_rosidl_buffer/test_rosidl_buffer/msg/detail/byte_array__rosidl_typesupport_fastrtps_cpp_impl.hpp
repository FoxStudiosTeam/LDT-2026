...
#ifndef TEST_ROSIDL_BUFFER__MSG__DETAIL__BYTE_ARRAY__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
#define TEST_ROSIDL_BUFFER__MSG__DETAIL__BYTE_ARRAY__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
...
#include "test_rosidl_buffer/msg/detail/byte_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
cdr_serialize(
  const test_rosidl_buffer::msg::ByteArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  test_rosidl_buffer::msg::ByteArray & ros_message)
{
  // Member: seq
  cdr >> ros_message.seq;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = test_rosidl_buffer::msg::ByteArray;
    is_plain =
      (
...
#endif  // TEST_ROSIDL_BUFFER__MSG__DETAIL__BYTE_ARRAY__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
