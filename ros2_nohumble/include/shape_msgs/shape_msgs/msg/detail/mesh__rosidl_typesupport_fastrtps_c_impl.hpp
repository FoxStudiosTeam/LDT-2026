...
#ifndef SHAPE_MSGS__MSG__DETAIL__MESH__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
#define SHAPE_MSGS__MSG__DETAIL__MESH__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
...
#include "shape_msgs/msg/detail/mesh_triangle__rosidl_typesupport_fastrtps_c_impl.hpp"
...
inline
bool impl_cdr_serialize_shape_msgs__msg__Mesh(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: triangles
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_serialize_shape_msgs__msg__MeshTriangle(
        &array_ptr[i], cdr);
    }
  }
...
inline
bool impl_cdr_deserialize_shape_msgs__msg__Mesh(
  eprosima::fastcdr::Cdr & cdr,
  shape_msgs__msg__Mesh * ros_message)
{
  // Field name: triangles
  {
    ...
    auto array_ptr = ros_message->triangles.data;
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_deserialize_shape_msgs__msg__MeshTriangle(cdr, &array_ptr[i]);
    }
  }
...
inline
size_t impl_get_serialized_size_shape_msgs__msg__Mesh(
  ...
  size_t current_alignment)
{
  ...
  // Field name: triangles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += impl_get_serialized_size_shape_msgs__msg__MeshTriangle(
...
inline
size_t impl_max_serialized_size_shape_msgs__msg__Mesh(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: triangles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        impl_max_serialized_size_shape_msgs__msg__MeshTriangle(
...
inline
bool impl_cdr_serialize_key_shape_msgs__msg__Mesh(
  const shape_msgs__msg__Mesh * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: triangles
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_serialize_key_shape_msgs__msg__MeshTriangle(
        &array_ptr[i], cdr);
    }
  }
...
inline
size_t impl_get_serialized_size_key_shape_msgs__msg__Mesh(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Mesh__ros_msg_type * ros_message = static_cast<const _Mesh__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: triangles
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += impl_get_serialized_size_key_shape_msgs__msg__MeshTriangle(
        &array_ptr[index], current_alignment);
    }
  }
...
inline
size_t impl_max_serialized_size_key_shape_msgs__msg__Mesh(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: triangles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        impl_max_serialized_size_key_shape_msgs__msg__MeshTriangle(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
inline
bool impl_cdr_serialize_with_endpoint_shape_msgs__msg__Mesh(
  const shape_msgs__msg__Mesh * ros_message,
  eprosima::fastcdr::Cdr & cdr,
  ...
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Field name: triangles
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_serialize_with_endpoint_shape_msgs__msg__MeshTriangle(
...
inline
bool impl_cdr_deserialize_with_endpoint_shape_msgs__msg__Mesh(
  eprosima::fastcdr::Cdr & cdr,
  shape_msgs__msg__Mesh * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Field name: triangles
  {
    ...
    auto array_ptr = ros_message->triangles.data;
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_deserialize_with_endpoint_shape_msgs__msg__MeshTriangle(cdr, &array_ptr[i], endpoint_info, serialization_context);
    }
  }
...
#endif  // SHAPE_MSGS__MSG__DETAIL__MESH__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
