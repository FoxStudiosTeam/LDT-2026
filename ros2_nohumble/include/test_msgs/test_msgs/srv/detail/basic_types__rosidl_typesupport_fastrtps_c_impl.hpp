...
#ifndef TEST_MSGS__SRV__DETAIL__BASIC_TYPES__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
#define TEST_MSGS__SRV__DETAIL__BASIC_TYPES__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
...
inline
bool impl_cdr_serialize_test_msgs__srv__BasicTypes_Request(
...
inline
bool impl_cdr_deserialize_test_msgs__srv__BasicTypes_Request(
  eprosima::fastcdr::Cdr & cdr,
...
inline
size_t impl_get_serialized_size_test_msgs__srv__BasicTypes_Request(
...
inline
size_t impl_max_serialized_size_test_msgs__srv__BasicTypes_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_key_test_msgs__srv__BasicTypes_Request(
  const test_msgs__srv__BasicTypes_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: bool_value
...
inline
size_t impl_get_serialized_size_key_test_msgs__srv__BasicTypes_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BasicTypes_Request__ros_msg_type * ros_message = static_cast<const _BasicTypes_Request__ros_msg_type *>(untyped_ros_message);
...
inline
size_t impl_max_serialized_size_key_test_msgs__srv__BasicTypes_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_with_endpoint_test_msgs__srv__BasicTypes_Request(
  const test_msgs__srv__BasicTypes_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr,
...
inline
bool impl_cdr_deserialize_with_endpoint_test_msgs__srv__BasicTypes_Request(
  eprosima::fastcdr::Cdr & cdr,
  test_msgs__srv__BasicTypes_Request * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
...
inline
bool impl_cdr_serialize_test_msgs__srv__BasicTypes_Response(
...
inline
bool impl_cdr_deserialize_test_msgs__srv__BasicTypes_Response(
  eprosima::fastcdr::Cdr & cdr,
...
inline
size_t impl_get_serialized_size_test_msgs__srv__BasicTypes_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
inline
size_t impl_max_serialized_size_test_msgs__srv__BasicTypes_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_key_test_msgs__srv__BasicTypes_Response(
  const test_msgs__srv__BasicTypes_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: bool_value
...
inline
size_t impl_get_serialized_size_key_test_msgs__srv__BasicTypes_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BasicTypes_Response__ros_msg_type * ros_message = static_cast<const _BasicTypes_Response__ros_msg_type *>(untyped_ros_message);
...
inline
size_t impl_max_serialized_size_key_test_msgs__srv__BasicTypes_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_with_endpoint_test_msgs__srv__BasicTypes_Response(
  const test_msgs__srv__BasicTypes_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
...
inline
bool impl_cdr_deserialize_with_endpoint_test_msgs__srv__BasicTypes_Response(
  eprosima::fastcdr::Cdr & cdr,
  test_msgs__srv__BasicTypes_Response * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
...
inline
bool impl_cdr_serialize_test_msgs__srv__BasicTypes_Event(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_serialize_test_msgs__srv__BasicTypes_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_serialize_test_msgs__srv__BasicTypes_Response(
        &array_ptr[i], cdr);
    }
  }
...
inline
bool impl_cdr_deserialize_test_msgs__srv__BasicTypes_Event(
  eprosima::fastcdr::Cdr & cdr,
  test_msgs__srv__BasicTypes_Event * ros_message)
{
  ...
  // Field name: request
  {
    ...
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_deserialize_test_msgs__srv__BasicTypes_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_deserialize_test_msgs__srv__BasicTypes_Response(cdr, &array_ptr[i]);
    }
  }
...
inline
size_t impl_get_serialized_size_test_msgs__srv__BasicTypes_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += impl_get_serialized_size_test_msgs__srv__BasicTypes_Request(
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += impl_get_serialized_size_test_msgs__srv__BasicTypes_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
inline
size_t impl_max_serialized_size_test_msgs__srv__BasicTypes_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        impl_max_serialized_size_test_msgs__srv__BasicTypes_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        impl_max_serialized_size_test_msgs__srv__BasicTypes_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
inline
bool impl_cdr_serialize_key_test_msgs__srv__BasicTypes_Event(
  const test_msgs__srv__BasicTypes_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_serialize_key_test_msgs__srv__BasicTypes_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_serialize_key_test_msgs__srv__BasicTypes_Response(
        &array_ptr[i], cdr);
    }
  }
...
inline
size_t impl_get_serialized_size_key_test_msgs__srv__BasicTypes_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BasicTypes_Event__ros_msg_type * ros_message = static_cast<const _BasicTypes_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += impl_get_serialized_size_key_test_msgs__srv__BasicTypes_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += impl_get_serialized_size_key_test_msgs__srv__BasicTypes_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
inline
size_t impl_max_serialized_size_key_test_msgs__srv__BasicTypes_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        impl_max_serialized_size_key_test_msgs__srv__BasicTypes_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        impl_max_serialized_size_key_test_msgs__srv__BasicTypes_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
inline
bool impl_cdr_serialize_with_endpoint_test_msgs__srv__BasicTypes_Event(
  const test_msgs__srv__BasicTypes_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_serialize_with_endpoint_test_msgs__srv__BasicTypes_Request(
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_serialize_with_endpoint_test_msgs__srv__BasicTypes_Response(
        &array_ptr[i], cdr, endpoint_info, serialization_context);
    }
  }
...
inline
bool impl_cdr_deserialize_with_endpoint_test_msgs__srv__BasicTypes_Event(
  eprosima::fastcdr::Cdr & cdr,
  test_msgs__srv__BasicTypes_Event * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Field name: request
  {
    ...
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_deserialize_with_endpoint_test_msgs__srv__BasicTypes_Request(cdr, &array_ptr[i], endpoint_info, serialization_context);
    }
  }
  ...
  // Field name: response
  {
    ...
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_deserialize_with_endpoint_test_msgs__srv__BasicTypes_Response(cdr, &array_ptr[i], endpoint_info, serialization_context);
    }
  }
...
#endif  // TEST_MSGS__SRV__DETAIL__BASIC_TYPES__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
