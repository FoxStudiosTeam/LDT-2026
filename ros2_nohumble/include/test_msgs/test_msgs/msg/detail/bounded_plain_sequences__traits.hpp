...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, test_msgs::msg::BoundedPlainSequences>, int> = 0>
...
template<>
constexpr const char * data_type<test_msgs::msg::BoundedPlainSequences>()
{
  return "test_msgs::msg::BoundedPlainSequences";
}

template<>
constexpr const char * name<test_msgs::msg::BoundedPlainSequences>()
{
  return "test_msgs/msg/BoundedPlainSequences";
}
...
template<>
struct MessageTraits<test_msgs::msg::BoundedPlainSequences>
{
  static constexpr std::size_t member_count = 30;
