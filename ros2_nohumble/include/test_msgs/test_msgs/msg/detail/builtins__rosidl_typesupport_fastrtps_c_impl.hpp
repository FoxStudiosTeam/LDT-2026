...
#ifndef TEST_MSGS__MSG__DETAIL__BUILTINS__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
#define TEST_MSGS__MSG__DETAIL__BUILTINS__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
...
inline
bool impl_cdr_serialize_test_msgs__msg__Builtins(
...
inline
bool impl_cdr_deserialize_test_msgs__msg__Builtins(
  eprosima::fastcdr::Cdr & cdr,
  test_msgs__msg__Builtins * ros_message)
{
  // Field name: duration_value
  {
    impl_cdr_deserialize_builtin_interfaces__msg__Duration(cdr, &ros_message->duration_value);
  }

  // Field name: time_value
  {
    impl_cdr_deserialize_builtin_interfaces__msg__Time(cdr, &ros_message->time_value);
  }
...
inline
size_t impl_get_serialized_size_test_msgs__msg__Builtins(
...
inline
size_t impl_max_serialized_size_test_msgs__msg__Builtins(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_key_test_msgs__msg__Builtins(
  const test_msgs__msg__Builtins * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: duration_value
...
inline
size_t impl_get_serialized_size_key_test_msgs__msg__Builtins(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Builtins__ros_msg_type * ros_message = static_cast<const _Builtins__ros_msg_type *>(untyped_ros_message);
...
inline
size_t impl_max_serialized_size_key_test_msgs__msg__Builtins(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_with_endpoint_test_msgs__msg__Builtins(
  const test_msgs__msg__Builtins * ros_message,
  eprosima::fastcdr::Cdr & cdr,
  ...
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Field name: duration_value
  {
    impl_cdr_serialize_with_endpoint_builtin_interfaces__msg__Duration(
      &ros_message->duration_value, cdr, endpoint_info, serialization_context);
  }

  // Field name: time_value
  {
    impl_cdr_serialize_with_endpoint_builtin_interfaces__msg__Time(
      &ros_message->time_value, cdr, endpoint_info, serialization_context);
  }
...
inline
bool impl_cdr_deserialize_with_endpoint_test_msgs__msg__Builtins(
  eprosima::fastcdr::Cdr & cdr,
  test_msgs__msg__Builtins * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Field name: duration_value
  {
    impl_cdr_deserialize_with_endpoint_builtin_interfaces__msg__Duration(cdr, &ros_message->duration_value, endpoint_info, serialization_context);
  }

  // Field name: time_value
  {
    impl_cdr_deserialize_with_endpoint_builtin_interfaces__msg__Time(cdr, &ros_message->time_value, endpoint_info, serialization_context);
  }
...
#endif  // TEST_MSGS__MSG__DETAIL__BUILTINS__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
