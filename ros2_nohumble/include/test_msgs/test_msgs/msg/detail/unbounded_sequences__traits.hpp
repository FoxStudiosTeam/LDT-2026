...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, test_msgs::msg::UnboundedSequences>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    ...
    std::forward<T>(msg).alignment_check);
}
...
template<>
constexpr const char * data_type<test_msgs::msg::UnboundedSequences>()
{
  return "test_msgs::msg::UnboundedSequences";
}

template<>
constexpr const char * name<test_msgs::msg::UnboundedSequences>()
{
  return "test_msgs/msg/UnboundedSequences";
}
...
template<>
struct MessageTraits<test_msgs::msg::UnboundedSequences>
{
  static constexpr std::size_t member_count = 32;
