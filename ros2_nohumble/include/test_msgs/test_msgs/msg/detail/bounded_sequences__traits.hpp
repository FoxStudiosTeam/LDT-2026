...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, test_msgs::msg::BoundedSequences>, int> = 0>
...
template<>
constexpr const char * data_type<test_msgs::msg::BoundedSequences>()
{
  return "test_msgs::msg::BoundedSequences";
}

template<>
constexpr const char * name<test_msgs::msg::BoundedSequences>()
{
  return "test_msgs/msg/BoundedSequences";
}
...
template<>
struct MessageTraits<test_msgs::msg::BoundedSequences>
{
