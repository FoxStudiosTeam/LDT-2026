...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, test_msgs::msg::Arrays>, int> = 0>
...
template<>
constexpr const char * data_type<test_msgs::msg::Arrays>()
{
  return "test_msgs::msg::Arrays";
}

template<>
constexpr const char * name<test_msgs::msg::Arrays>()
{
  return "test_msgs/msg/Arrays";
}
...
template<>
struct MessageTraits<test_msgs::msg::Arrays>
{
