...
#ifndef TEST_MSGS__MSG__DETAIL__UNBOUNDED_SEQUENCES__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
#define TEST_MSGS__MSG__DETAIL__UNBOUNDED_SEQUENCES__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
...
inline
bool impl_cdr_serialize_test_msgs__msg__UnboundedSequences(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: char_values
  {
    ...
    if (ros_message->char_values.is_rosidl_buffer) {
      auto * buffer = reinterpret_cast<const rosidl::Buffer<uint8_t> *>(ros_message->char_values.data);
      if (buffer == nullptr) {
        fprintf(stderr, "null rosidl_buffer pointer for field 'char_values'\n");
        return false;
      }
  ...
  {
    // Regular path CPU fallback for rosidl_buffer-backed uint8[]
    if (ros_message->uint8_values.is_rosidl_buffer) {
      auto * buffer = reinterpret_cast<const rosidl::Buffer<uint8_t> *>(ros_message->uint8_values.data);
      if (buffer == nullptr) {
        fprintf(stderr, "null rosidl_buffer pointer for field 'uint8_values'\n");
        return false;
      }
      if (buffer->get_backend_type() == "cpu") {
        cdr << static_cast<uint32_t>(buffer->size());
  ...
  {
    // Regular path CPU fallback for rosidl_buffer-backed uint8[]
    if (ros_message->char_values_default.is_rosidl_buffer) {
      auto * buffer = reinterpret_cast<const rosidl::Buffer<uint8_t> *>(ros_message->char_values_default.data);
      if (buffer == nullptr) {
        fprintf(stderr, "null rosidl_buffer pointer for field 'char_values_default'\n");
        return false;
      }
      if (buffer->get_backend_type() == "cpu") {
        cdr << static_cast<uint32_t>(buffer->size());
  ...
  {
    // Regular path CPU fallback for rosidl_buffer-backed uint8[]
    if (ros_message->uint8_values_default.is_rosidl_buffer) {
      auto * buffer = reinterpret_cast<const rosidl::Buffer<uint8_t> *>(ros_message->uint8_values_default.data);
      if (buffer == nullptr) {
        fprintf(stderr, "null rosidl_buffer pointer for field 'uint8_values_default'\n");
        return false;
      }
      if (buffer->get_backend_type() == "cpu") {
        cdr << static_cast<uint32_t>(buffer->size());
...
inline
bool impl_cdr_deserialize_test_msgs__msg__UnboundedSequences(
  eprosima::fastcdr::Cdr & cdr,
  test_msgs__msg__UnboundedSequences * ros_message)
{
  ...
  // Field name: char_values
  {
    // Regular path CPU fallback for rosidl_buffer-backed uint8[]
    if (ros_message->char_values.is_rosidl_buffer) {
      auto * old_buffer = reinterpret_cast<rosidl::Buffer<uint8_t> *>(ros_message->char_values.data);
      delete old_buffer;
      ros_message->char_values.data = nullptr;
      ros_message->char_values.size = 0;
      ros_message->char_values.capacity = 0;
      ros_message->char_values.is_rosidl_buffer = false;
    }
    ...
    if (!rosidl_runtime_c__uint8__Sequence__init(&ros_message->char_values, seq_size)) {
      fprintf(stderr, "failed to create array for field 'char_values'");
      return false;
    }
    if (seq_size > 0) {
      cdr.deserialize_array(ros_message->char_values.data, seq_size);
    }
    ros_message->char_values.is_rosidl_buffer = false;
  }
  ...
  // Field name: uint8_values
  {
    // Regular path CPU fallback for rosidl_buffer-backed uint8[]
    if (ros_message->uint8_values.is_rosidl_buffer) {
      auto * old_buffer = reinterpret_cast<rosidl::Buffer<uint8_t> *>(ros_message->uint8_values.data);
      delete old_buffer;
      ros_message->uint8_values.data = nullptr;
      ros_message->uint8_values.size = 0;
      ros_message->uint8_values.capacity = 0;
      ros_message->uint8_values.is_rosidl_buffer = false;
    }
    uint32_t seq_size = 0u;
    cdr >> seq_size;
    ...
    if (!rosidl_runtime_c__uint8__Sequence__init(&ros_message->uint8_values, seq_size)) {
      fprintf(stderr, "failed to create array for field 'uint8_values'");
      return false;
    }
    if (seq_size > 0) {
      cdr.deserialize_array(ros_message->uint8_values.data, seq_size);
    }
    ros_message->uint8_values.is_rosidl_buffer = false;
  }
  ...
  // Field name: char_values_default
  {
    // Regular path CPU fallback for rosidl_buffer-backed uint8[]
    if (ros_message->char_values_default.is_rosidl_buffer) {
      auto * old_buffer = reinterpret_cast<rosidl::Buffer<uint8_t> *>(ros_message->char_values_default.data);
      delete old_buffer;
      ros_message->char_values_default.data = nullptr;
      ros_message->char_values_default.size = 0;
      ros_message->char_values_default.capacity = 0;
      ros_message->char_values_default.is_rosidl_buffer = false;
    }
    uint32_t seq_size = 0u;
    cdr >> seq_size;
    ...
    if (!rosidl_runtime_c__uint8__Sequence__init(&ros_message->char_values_default, seq_size)) {
      fprintf(stderr, "failed to create array for field 'char_values_default'");
      return false;
    }
    if (seq_size > 0) {
      cdr.deserialize_array(ros_message->char_values_default.data, seq_size);
    }
    ros_message->char_values_default.is_rosidl_buffer = false;
  }
  ...
  // Field name: uint8_values_default
  {
    // Regular path CPU fallback for rosidl_buffer-backed uint8[]
    if (ros_message->uint8_values_default.is_rosidl_buffer) {
      auto * old_buffer = reinterpret_cast<rosidl::Buffer<uint8_t> *>(ros_message->uint8_values_default.data);
      delete old_buffer;
      ros_message->uint8_values_default.data = nullptr;
      ros_message->uint8_values_default.size = 0;
      ros_message->uint8_values_default.capacity = 0;
      ros_message->uint8_values_default.is_rosidl_buffer = false;
    }
    uint32_t seq_size = 0u;
    cdr >> seq_size;
    ...
    if (!rosidl_runtime_c__uint8__Sequence__init(&ros_message->uint8_values_default, seq_size)) {
      fprintf(stderr, "failed to create array for field 'uint8_values_default'");
      return false;
    }
    if (seq_size > 0) {
      cdr.deserialize_array(ros_message->uint8_values_default.data, seq_size);
    }
    ros_message->uint8_values_default.is_rosidl_buffer = false;
  }
...
inline
size_t impl_get_serialized_size_test_msgs__msg__UnboundedSequences(
...
inline
size_t impl_max_serialized_size_test_msgs__msg__UnboundedSequences(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_key_test_msgs__msg__UnboundedSequences(
  const test_msgs__msg__UnboundedSequences * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: bool_values
...
inline
size_t impl_get_serialized_size_key_test_msgs__msg__UnboundedSequences(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _UnboundedSequences__ros_msg_type * ros_message = static_cast<const _UnboundedSequences__ros_msg_type *>(untyped_ros_message);
...
inline
size_t impl_max_serialized_size_key_test_msgs__msg__UnboundedSequences(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_with_endpoint_test_msgs__msg__UnboundedSequences(
  const test_msgs__msg__UnboundedSequences * ros_message,
  eprosima::fastcdr::Cdr & cdr,
...
inline
bool impl_cdr_deserialize_with_endpoint_test_msgs__msg__UnboundedSequences(
  eprosima::fastcdr::Cdr & cdr,
  test_msgs__msg__UnboundedSequences * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Field name: char_values
  {
    if (!rosidl_typesupport_fastrtps_cpp::deserialize_buffer_or_c_sequence_with_endpoint(
        cdr, ros_message->char_values, endpoint_info, serialization_context))
    {
      fprintf(stderr, "Failed to deserialize buffer field 'char_values'\n");
      return false;
    }
  }
  ...
  // Field name: uint8_values
  {
    if (!rosidl_typesupport_fastrtps_cpp::deserialize_buffer_or_c_sequence_with_endpoint(
        cdr, ros_message->uint8_values, endpoint_info, serialization_context))
    {
      fprintf(stderr, "Failed to deserialize buffer field 'uint8_values'\n");
      return false;
    }
  }
  ...
  // Field name: char_values_default
  {
    if (!rosidl_typesupport_fastrtps_cpp::deserialize_buffer_or_c_sequence_with_endpoint(
        cdr, ros_message->char_values_default, endpoint_info, serialization_context))
    {
      fprintf(stderr, "Failed to deserialize buffer field 'char_values_default'\n");
      return false;
    }
  }
  ...
  // Field name: uint8_values_default
  {
    if (!rosidl_typesupport_fastrtps_cpp::deserialize_buffer_or_c_sequence_with_endpoint(
        cdr, ros_message->uint8_values_default, endpoint_info, serialization_context))
    {
      fprintf(stderr, "Failed to deserialize buffer field 'uint8_values_default'\n");
      return false;
    }
  }
...
#endif  // TEST_MSGS__MSG__DETAIL__UNBOUNDED_SEQUENCES__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
