...
#ifndef TEST_MSGS__MSG__DETAIL__ARRAYS__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
#define TEST_MSGS__MSG__DETAIL__ARRAYS__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
...
inline
bool impl_cdr_serialize_test_msgs__msg__Arrays(
...
inline
bool impl_cdr_deserialize_test_msgs__msg__Arrays(
  eprosima::fastcdr::Cdr & cdr,
...
inline
size_t impl_get_serialized_size_test_msgs__msg__Arrays(
...
inline
size_t impl_max_serialized_size_test_msgs__msg__Arrays(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_key_test_msgs__msg__Arrays(
  const test_msgs__msg__Arrays * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: bool_values
...
inline
size_t impl_get_serialized_size_key_test_msgs__msg__Arrays(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Arrays__ros_msg_type * ros_message = static_cast<const _Arrays__ros_msg_type *>(untyped_ros_message);
...
inline
size_t impl_max_serialized_size_key_test_msgs__msg__Arrays(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_with_endpoint_test_msgs__msg__Arrays(
  const test_msgs__msg__Arrays * ros_message,
  eprosima::fastcdr::Cdr & cdr,
...
inline
bool impl_cdr_deserialize_with_endpoint_test_msgs__msg__Arrays(
  eprosima::fastcdr::Cdr & cdr,
  test_msgs__msg__Arrays * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
...
#endif  // TEST_MSGS__MSG__DETAIL__ARRAYS__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
