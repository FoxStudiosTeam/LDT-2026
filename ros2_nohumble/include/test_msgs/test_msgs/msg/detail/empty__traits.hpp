...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, test_msgs::msg::Empty>, int> = 0>
...
template<>
constexpr const char * data_type<test_msgs::msg::Empty>()
{
  return "test_msgs::msg::Empty";
}

template<>
constexpr const char * name<test_msgs::msg::Empty>()
{
  return "test_msgs/msg/Empty";
}
...
template<>
struct MessageTraits<test_msgs::msg::Empty>
{
