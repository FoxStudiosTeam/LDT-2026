...
#ifndef TEST_MSGS__MSG__DETAIL__NESTED__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
#define TEST_MSGS__MSG__DETAIL__NESTED__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
...
inline
bool impl_cdr_serialize_test_msgs__msg__Nested(
...
inline
bool impl_cdr_deserialize_test_msgs__msg__Nested(
  eprosima::fastcdr::Cdr & cdr,
  test_msgs__msg__Nested * ros_message)
{
  // Field name: basic_types_value
  {
    impl_cdr_deserialize_test_msgs__msg__BasicTypes(cdr, &ros_message->basic_types_value);
  }
...
inline
size_t impl_get_serialized_size_test_msgs__msg__Nested(
...
inline
size_t impl_max_serialized_size_test_msgs__msg__Nested(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_key_test_msgs__msg__Nested(
  const test_msgs__msg__Nested * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: basic_types_value
...
inline
size_t impl_get_serialized_size_key_test_msgs__msg__Nested(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Nested__ros_msg_type * ros_message = static_cast<const _Nested__ros_msg_type *>(untyped_ros_message);
...
inline
size_t impl_max_serialized_size_key_test_msgs__msg__Nested(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_with_endpoint_test_msgs__msg__Nested(
  const test_msgs__msg__Nested * ros_message,
  eprosima::fastcdr::Cdr & cdr,
  ...
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Field name: basic_types_value
  {
    impl_cdr_serialize_with_endpoint_test_msgs__msg__BasicTypes(
      &ros_message->basic_types_value, cdr, endpoint_info, serialization_context);
  }
...
inline
bool impl_cdr_deserialize_with_endpoint_test_msgs__msg__Nested(
  eprosima::fastcdr::Cdr & cdr,
  test_msgs__msg__Nested * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Field name: basic_types_value
  {
    impl_cdr_deserialize_with_endpoint_test_msgs__msg__BasicTypes(cdr, &ros_message->basic_types_value, endpoint_info, serialization_context);
  }
...
#endif  // TEST_MSGS__MSG__DETAIL__NESTED__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
