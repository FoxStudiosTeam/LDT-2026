...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, test_msgs::msg::BasicTypes>, int> = 0>
...
template<>
constexpr const char * data_type<test_msgs::msg::BasicTypes>()
{
  return "test_msgs::msg::BasicTypes";
}

template<>
constexpr const char * name<test_msgs::msg::BasicTypes>()
{
  return "test_msgs/msg/BasicTypes";
}
...
template<>
struct MessageTraits<test_msgs::msg::BasicTypes>
{
