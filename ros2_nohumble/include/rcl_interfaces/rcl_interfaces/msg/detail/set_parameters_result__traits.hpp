...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, rcl_interfaces::msg::SetParametersResult>, int> = 0>
...
template<>
constexpr const char * data_type<rcl_interfaces::msg::SetParametersResult>()
{
  return "rcl_interfaces::msg::SetParametersResult";
}

template<>
constexpr const char * name<rcl_interfaces::msg::SetParametersResult>()
{
  return "rcl_interfaces/msg/SetParametersResult";
}
...
template<>
struct MessageTraits<rcl_interfaces::msg::SetParametersResult>
{
