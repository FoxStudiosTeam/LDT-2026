...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, rcl_interfaces::msg::ParameterValue>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).type,
    std::forward<T>(msg).bool_value,
    std::forward<T>(msg).integer_value,
    std::forward<T>(msg).double_value,
    std::forward<T>(msg).string_value,
    std::forward<T>(msg).byte_array_value,
    std::forward<T>(msg).bool_array_value,
    std::forward<T>(msg).integer_array_value,
    std::forward<T>(msg).double_array_value,
    std::forward<T>(msg).string_array_value);
}
...
template<>
constexpr const char * data_type<rcl_interfaces::msg::ParameterValue>()
{
  return "rcl_interfaces::msg::ParameterValue";
}

template<>
constexpr const char * name<rcl_interfaces::msg::ParameterValue>()
{
  return "rcl_interfaces/msg/ParameterValue";
}
...
template<>
struct MessageTraits<rcl_interfaces::msg::ParameterValue>
{
