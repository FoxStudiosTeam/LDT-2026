...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, rcl_interfaces::msg::IntegerRange>, int> = 0>
...
template<>
constexpr const char * data_type<rcl_interfaces::msg::IntegerRange>()
{
  return "rcl_interfaces::msg::IntegerRange";
}

template<>
constexpr const char * name<rcl_interfaces::msg::IntegerRange>()
{
  return "rcl_interfaces/msg/IntegerRange";
}
...
template<>
struct MessageTraits<rcl_interfaces::msg::IntegerRange>
{
