...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, rcl_interfaces::msg::ParameterEvent>, int> = 0>
...
template<>
constexpr const char * data_type<rcl_interfaces::msg::ParameterEvent>()
{
  return "rcl_interfaces::msg::ParameterEvent";
}

template<>
constexpr const char * name<rcl_interfaces::msg::ParameterEvent>()
{
  return "rcl_interfaces/msg/ParameterEvent";
}
...
template<>
struct MessageTraits<rcl_interfaces::msg::ParameterEvent>
{
