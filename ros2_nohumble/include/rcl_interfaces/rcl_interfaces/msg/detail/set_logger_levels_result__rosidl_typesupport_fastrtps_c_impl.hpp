...
#ifndef RCL_INTERFACES__MSG__DETAIL__SET_LOGGER_LEVELS_RESULT__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
#define RCL_INTERFACES__MSG__DETAIL__SET_LOGGER_LEVELS_RESULT__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
...
inline
bool impl_cdr_serialize_rcl_interfaces__msg__SetLoggerLevelsResult(
...
inline
bool impl_cdr_deserialize_rcl_interfaces__msg__SetLoggerLevelsResult(
  eprosima::fastcdr::Cdr & cdr,
...
inline
size_t impl_get_serialized_size_rcl_interfaces__msg__SetLoggerLevelsResult(
...
inline
size_t impl_max_serialized_size_rcl_interfaces__msg__SetLoggerLevelsResult(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_key_rcl_interfaces__msg__SetLoggerLevelsResult(
  const rcl_interfaces__msg__SetLoggerLevelsResult * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: successful
...
inline
size_t impl_get_serialized_size_key_rcl_interfaces__msg__SetLoggerLevelsResult(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetLoggerLevelsResult__ros_msg_type * ros_message = static_cast<const _SetLoggerLevelsResult__ros_msg_type *>(untyped_ros_message);
...
inline
size_t impl_max_serialized_size_key_rcl_interfaces__msg__SetLoggerLevelsResult(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_with_endpoint_rcl_interfaces__msg__SetLoggerLevelsResult(
  const rcl_interfaces__msg__SetLoggerLevelsResult * ros_message,
  eprosima::fastcdr::Cdr & cdr,
...
inline
bool impl_cdr_deserialize_with_endpoint_rcl_interfaces__msg__SetLoggerLevelsResult(
  eprosima::fastcdr::Cdr & cdr,
  rcl_interfaces__msg__SetLoggerLevelsResult * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
...
#endif  // RCL_INTERFACES__MSG__DETAIL__SET_LOGGER_LEVELS_RESULT__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
