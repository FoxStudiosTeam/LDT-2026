...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, rcl_interfaces::srv::SetLoggerLevels_Request>, int> = 0>
...
template<>
constexpr const char * data_type<rcl_interfaces::srv::SetLoggerLevels_Request>()
{
  return "rcl_interfaces::srv::SetLoggerLevels_Request";
}

template<>
constexpr const char * name<rcl_interfaces::srv::SetLoggerLevels_Request>()
{
  return "rcl_interfaces/srv/SetLoggerLevels_Request";
}
...
template<>
struct MessageTraits<rcl_interfaces::srv::SetLoggerLevels_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, rcl_interfaces::srv::SetLoggerLevels_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(std::forward<T>(msg).results);
}
...
template<>
constexpr const char * data_type<rcl_interfaces::srv::SetLoggerLevels_Response>()
{
  return "rcl_interfaces::srv::SetLoggerLevels_Response";
}

template<>
constexpr const char * name<rcl_interfaces::srv::SetLoggerLevels_Response>()
{
  return "rcl_interfaces/srv/SetLoggerLevels_Response";
}
...
template<>
struct MessageTraits<rcl_interfaces::srv::SetLoggerLevels_Response>
{
  static constexpr std::size_t member_count = 1;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "results",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, rcl_interfaces::srv::SetLoggerLevels_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<rcl_interfaces::srv::SetLoggerLevels_Event>()
{
  return "rcl_interfaces::srv::SetLoggerLevels_Event";
}

template<>
constexpr const char * name<rcl_interfaces::srv::SetLoggerLevels_Event>()
{
  return "rcl_interfaces/srv/SetLoggerLevels_Event";
}
...
template<>
struct MessageTraits<rcl_interfaces::srv::SetLoggerLevels_Event>
{
...
template<>
constexpr const char * data_type<rcl_interfaces::srv::SetLoggerLevels>()
{
  return "rcl_interfaces::srv::SetLoggerLevels";
}

template<>
constexpr const char * name<rcl_interfaces::srv::SetLoggerLevels>()
{
  return "rcl_interfaces/srv/SetLoggerLevels";
}
