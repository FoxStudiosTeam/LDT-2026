...
#ifndef RCL_INTERFACES__SRV__DETAIL__GET_LOGGER_LEVELS__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
#define RCL_INTERFACES__SRV__DETAIL__GET_LOGGER_LEVELS__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
...
inline
bool impl_cdr_serialize_rcl_interfaces__srv__GetLoggerLevels_Request(
...
inline
bool impl_cdr_deserialize_rcl_interfaces__srv__GetLoggerLevels_Request(
  eprosima::fastcdr::Cdr & cdr,
...
inline
size_t impl_get_serialized_size_rcl_interfaces__srv__GetLoggerLevels_Request(
...
inline
size_t impl_max_serialized_size_rcl_interfaces__srv__GetLoggerLevels_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_key_rcl_interfaces__srv__GetLoggerLevels_Request(
  const rcl_interfaces__srv__GetLoggerLevels_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: names
...
inline
size_t impl_get_serialized_size_key_rcl_interfaces__srv__GetLoggerLevels_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetLoggerLevels_Request__ros_msg_type * ros_message = static_cast<const _GetLoggerLevels_Request__ros_msg_type *>(untyped_ros_message);
...
inline
size_t impl_max_serialized_size_key_rcl_interfaces__srv__GetLoggerLevels_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_with_endpoint_rcl_interfaces__srv__GetLoggerLevels_Request(
  const rcl_interfaces__srv__GetLoggerLevels_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr,
...
inline
bool impl_cdr_deserialize_with_endpoint_rcl_interfaces__srv__GetLoggerLevels_Request(
  eprosima::fastcdr::Cdr & cdr,
  rcl_interfaces__srv__GetLoggerLevels_Request * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
...
inline
bool impl_cdr_serialize_rcl_interfaces__srv__GetLoggerLevels_Response(
...
inline
bool impl_cdr_deserialize_rcl_interfaces__srv__GetLoggerLevels_Response(
  eprosima::fastcdr::Cdr & cdr,
...
inline
size_t impl_get_serialized_size_rcl_interfaces__srv__GetLoggerLevels_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
inline
size_t impl_max_serialized_size_rcl_interfaces__srv__GetLoggerLevels_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_key_rcl_interfaces__srv__GetLoggerLevels_Response(
  const rcl_interfaces__srv__GetLoggerLevels_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: levels
...
inline
size_t impl_get_serialized_size_key_rcl_interfaces__srv__GetLoggerLevels_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetLoggerLevels_Response__ros_msg_type * ros_message = static_cast<const _GetLoggerLevels_Response__ros_msg_type *>(untyped_ros_message);
...
inline
size_t impl_max_serialized_size_key_rcl_interfaces__srv__GetLoggerLevels_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_with_endpoint_rcl_interfaces__srv__GetLoggerLevels_Response(
  const rcl_interfaces__srv__GetLoggerLevels_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
...
inline
bool impl_cdr_deserialize_with_endpoint_rcl_interfaces__srv__GetLoggerLevels_Response(
  eprosima::fastcdr::Cdr & cdr,
  rcl_interfaces__srv__GetLoggerLevels_Response * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
...
inline
bool impl_cdr_serialize_rcl_interfaces__srv__GetLoggerLevels_Event(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_serialize_rcl_interfaces__srv__GetLoggerLevels_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_serialize_rcl_interfaces__srv__GetLoggerLevels_Response(
        &array_ptr[i], cdr);
    }
  }
...
inline
bool impl_cdr_deserialize_rcl_interfaces__srv__GetLoggerLevels_Event(
  eprosima::fastcdr::Cdr & cdr,
  rcl_interfaces__srv__GetLoggerLevels_Event * ros_message)
{
  ...
  // Field name: request
  {
    ...
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_deserialize_rcl_interfaces__srv__GetLoggerLevels_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_deserialize_rcl_interfaces__srv__GetLoggerLevels_Response(cdr, &array_ptr[i]);
    }
  }
...
inline
size_t impl_get_serialized_size_rcl_interfaces__srv__GetLoggerLevels_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += impl_get_serialized_size_rcl_interfaces__srv__GetLoggerLevels_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += impl_get_serialized_size_rcl_interfaces__srv__GetLoggerLevels_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
inline
size_t impl_max_serialized_size_rcl_interfaces__srv__GetLoggerLevels_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        impl_max_serialized_size_rcl_interfaces__srv__GetLoggerLevels_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        impl_max_serialized_size_rcl_interfaces__srv__GetLoggerLevels_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
inline
bool impl_cdr_serialize_key_rcl_interfaces__srv__GetLoggerLevels_Event(
  const rcl_interfaces__srv__GetLoggerLevels_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_serialize_key_rcl_interfaces__srv__GetLoggerLevels_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_serialize_key_rcl_interfaces__srv__GetLoggerLevels_Response(
        &array_ptr[i], cdr);
    }
  }
...
inline
size_t impl_get_serialized_size_key_rcl_interfaces__srv__GetLoggerLevels_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetLoggerLevels_Event__ros_msg_type * ros_message = static_cast<const _GetLoggerLevels_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += impl_get_serialized_size_key_rcl_interfaces__srv__GetLoggerLevels_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += impl_get_serialized_size_key_rcl_interfaces__srv__GetLoggerLevels_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
inline
size_t impl_max_serialized_size_key_rcl_interfaces__srv__GetLoggerLevels_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        impl_max_serialized_size_key_rcl_interfaces__srv__GetLoggerLevels_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        impl_max_serialized_size_key_rcl_interfaces__srv__GetLoggerLevels_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
inline
bool impl_cdr_serialize_with_endpoint_rcl_interfaces__srv__GetLoggerLevels_Event(
  const rcl_interfaces__srv__GetLoggerLevels_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_serialize_with_endpoint_rcl_interfaces__srv__GetLoggerLevels_Request(
        &array_ptr[i], cdr, endpoint_info, serialization_context);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_serialize_with_endpoint_rcl_interfaces__srv__GetLoggerLevels_Response(
        &array_ptr[i], cdr, endpoint_info, serialization_context);
    }
  }
...
inline
bool impl_cdr_deserialize_with_endpoint_rcl_interfaces__srv__GetLoggerLevels_Event(
  eprosima::fastcdr::Cdr & cdr,
  rcl_interfaces__srv__GetLoggerLevels_Event * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Field name: request
  {
    ...
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_deserialize_with_endpoint_rcl_interfaces__srv__GetLoggerLevels_Request(cdr, &array_ptr[i], endpoint_info, serialization_context);
    }
  }
  ...
  // Field name: response
  {
    ...
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_deserialize_with_endpoint_rcl_interfaces__srv__GetLoggerLevels_Response(cdr, &array_ptr[i], endpoint_info, serialization_context);
    }
  }
...
#endif  // RCL_INTERFACES__SRV__DETAIL__GET_LOGGER_LEVELS__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
