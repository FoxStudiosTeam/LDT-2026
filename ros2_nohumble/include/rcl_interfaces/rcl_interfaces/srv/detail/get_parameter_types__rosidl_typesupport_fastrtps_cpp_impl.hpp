...
#ifndef RCL_INTERFACES__SRV__DETAIL__GET_PARAMETER_TYPES__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
#define RCL_INTERFACES__SRV__DETAIL__GET_PARAMETER_TYPES__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: types
  {
    if (ros_message.types.get_backend_type() == "cpu") {
      const std::vector<uint8_t> & vec = ros_message.types;
      cdr << vec;
    } else {
      std::vector<uint8_t> vec = ros_message.types.to_vector();
      cdr << vec;
    }
  }
  ...
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Member: types
  {
        ...
        cdr, ros_message.types, endpoint_info, serialization_context))
    {
      RCUTILS_LOG_ERROR_NAMED(
        "rcl_interfaces.typesupport_fastrtps_cpp",
        "cdr_deserialize_with_endpoint: failed to deserialize 'types'");
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    ...
    ros_message.types, current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rcl_interfaces::srv::typesupport_fastrtps_cpp::detail::max_serialized_size_GetParameterTypes_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rcl_interfaces::srv::typesupport_fastrtps_cpp::detail::max_serialized_size_GetParameterTypes_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rcl_interfaces::srv::typesupport_fastrtps_cpp::detail::max_serialized_size_key_GetParameterTypes_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rcl_interfaces::srv::typesupport_fastrtps_cpp::detail::max_serialized_size_key_GetParameterTypes_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
#endif  // RCL_INTERFACES__SRV__DETAIL__GET_PARAMETER_TYPES__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
