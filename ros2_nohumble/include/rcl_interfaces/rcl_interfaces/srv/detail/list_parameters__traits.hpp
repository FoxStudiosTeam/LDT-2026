...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, rcl_interfaces::srv::ListParameters_Request>, int> = 0>
...
template<>
constexpr const char * data_type<rcl_interfaces::srv::ListParameters_Request>()
{
  return "rcl_interfaces::srv::ListParameters_Request";
}

template<>
constexpr const char * name<rcl_interfaces::srv::ListParameters_Request>()
{
  return "rcl_interfaces/srv/ListParameters_Request";
}
...
template<>
struct MessageTraits<rcl_interfaces::srv::ListParameters_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, rcl_interfaces::srv::ListParameters_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<rcl_interfaces::srv::ListParameters_Response>()
{
  return "rcl_interfaces::srv::ListParameters_Response";
}

template<>
constexpr const char * name<rcl_interfaces::srv::ListParameters_Response>()
{
  return "rcl_interfaces/srv/ListParameters_Response";
}
...
template<>
struct MessageTraits<rcl_interfaces::srv::ListParameters_Response>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, rcl_interfaces::srv::ListParameters_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<rcl_interfaces::srv::ListParameters_Event>()
{
  return "rcl_interfaces::srv::ListParameters_Event";
}

template<>
constexpr const char * name<rcl_interfaces::srv::ListParameters_Event>()
{
  return "rcl_interfaces/srv/ListParameters_Event";
}
...
template<>
struct MessageTraits<rcl_interfaces::srv::ListParameters_Event>
{
...
template<>
constexpr const char * data_type<rcl_interfaces::srv::ListParameters>()
{
  return "rcl_interfaces::srv::ListParameters";
}

template<>
constexpr const char * name<rcl_interfaces::srv::ListParameters>()
{
  return "rcl_interfaces/srv/ListParameters";
}
