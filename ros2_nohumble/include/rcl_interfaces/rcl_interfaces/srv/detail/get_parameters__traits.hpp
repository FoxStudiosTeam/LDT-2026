...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, rcl_interfaces::srv::GetParameters_Request>, int> = 0>
...
template<>
constexpr const char * data_type<rcl_interfaces::srv::GetParameters_Request>()
{
  return "rcl_interfaces::srv::GetParameters_Request";
}

template<>
constexpr const char * name<rcl_interfaces::srv::GetParameters_Request>()
{
  return "rcl_interfaces/srv/GetParameters_Request";
}
...
template<>
struct MessageTraits<rcl_interfaces::srv::GetParameters_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, rcl_interfaces::srv::GetParameters_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(std::forward<T>(msg).values);
}
...
template<>
constexpr const char * data_type<rcl_interfaces::srv::GetParameters_Response>()
{
  return "rcl_interfaces::srv::GetParameters_Response";
}

template<>
constexpr const char * name<rcl_interfaces::srv::GetParameters_Response>()
{
  return "rcl_interfaces/srv/GetParameters_Response";
}
...
template<>
struct MessageTraits<rcl_interfaces::srv::GetParameters_Response>
{
  static constexpr std::size_t member_count = 1;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "values",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, rcl_interfaces::srv::GetParameters_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<rcl_interfaces::srv::GetParameters_Event>()
{
  return "rcl_interfaces::srv::GetParameters_Event";
}

template<>
constexpr const char * name<rcl_interfaces::srv::GetParameters_Event>()
{
  return "rcl_interfaces/srv/GetParameters_Event";
}
...
template<>
struct MessageTraits<rcl_interfaces::srv::GetParameters_Event>
{
...
template<>
constexpr const char * data_type<rcl_interfaces::srv::GetParameters>()
{
  return "rcl_interfaces::srv::GetParameters";
}

template<>
constexpr const char * name<rcl_interfaces::srv::GetParameters>()
{
  return "rcl_interfaces/srv/GetParameters";
}
