...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, rosbag2_interfaces::msg::ReadSplitEvent>, int> = 0>
...
template<>
constexpr const char * data_type<rosbag2_interfaces::msg::ReadSplitEvent>()
{
  return "rosbag2_interfaces::msg::ReadSplitEvent";
}

template<>
constexpr const char * name<rosbag2_interfaces::msg::ReadSplitEvent>()
{
  return "rosbag2_interfaces/msg/ReadSplitEvent";
}
...
template<>
struct MessageTraits<rosbag2_interfaces::msg::ReadSplitEvent>
{
