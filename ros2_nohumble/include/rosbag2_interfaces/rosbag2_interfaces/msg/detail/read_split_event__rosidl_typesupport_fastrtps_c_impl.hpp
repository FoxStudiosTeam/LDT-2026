...
#ifndef ROSBAG2_INTERFACES__MSG__DETAIL__READ_SPLIT_EVENT__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
#define ROSBAG2_INTERFACES__MSG__DETAIL__READ_SPLIT_EVENT__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
...
inline
bool impl_cdr_serialize_rosbag2_interfaces__msg__ReadSplitEvent(
...
inline
bool impl_cdr_deserialize_rosbag2_interfaces__msg__ReadSplitEvent(
  eprosima::fastcdr::Cdr & cdr,
...
inline
size_t impl_get_serialized_size_rosbag2_interfaces__msg__ReadSplitEvent(
...
inline
size_t impl_max_serialized_size_rosbag2_interfaces__msg__ReadSplitEvent(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_key_rosbag2_interfaces__msg__ReadSplitEvent(
  const rosbag2_interfaces__msg__ReadSplitEvent * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: closed_file
...
inline
size_t impl_get_serialized_size_key_rosbag2_interfaces__msg__ReadSplitEvent(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ReadSplitEvent__ros_msg_type * ros_message = static_cast<const _ReadSplitEvent__ros_msg_type *>(untyped_ros_message);
...
inline
size_t impl_max_serialized_size_key_rosbag2_interfaces__msg__ReadSplitEvent(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_with_endpoint_rosbag2_interfaces__msg__ReadSplitEvent(
  const rosbag2_interfaces__msg__ReadSplitEvent * ros_message,
  eprosima::fastcdr::Cdr & cdr,
...
inline
bool impl_cdr_deserialize_with_endpoint_rosbag2_interfaces__msg__ReadSplitEvent(
  eprosima::fastcdr::Cdr & cdr,
  rosbag2_interfaces__msg__ReadSplitEvent * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
...
#endif  // ROSBAG2_INTERFACES__MSG__DETAIL__READ_SPLIT_EVENT__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
