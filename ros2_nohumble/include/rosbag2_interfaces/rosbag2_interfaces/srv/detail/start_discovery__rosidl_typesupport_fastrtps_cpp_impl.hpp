...
#ifndef ROSBAG2_INTERFACES__SRV__DETAIL__START_DISCOVERY__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
#define ROSBAG2_INTERFACES__SRV__DETAIL__START_DISCOVERY__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
...
#include "rosbag2_interfaces/srv/detail/start_discovery__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
cdr_serialize(
  const rosbag2_interfaces::srv::StartDiscovery_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rosbag2_interfaces::srv::StartDiscovery_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
inline
size_t
max_serialized_size_StartDiscovery_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rosbag2_interfaces::srv::StartDiscovery_Request;
    is_plain =
      (
...
inline
size_t
max_serialized_size_key_StartDiscovery_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
bool
cdr_serialize(
  const rosbag2_interfaces::srv::StartDiscovery_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: return_code
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rosbag2_interfaces::srv::StartDiscovery_Response & ros_message)
{
  // Member: return_code
  cdr >> ros_message.return_code;
...
inline
size_t
max_serialized_size_StartDiscovery_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rosbag2_interfaces::srv::StartDiscovery_Response;
    is_plain =
      (
...
inline
size_t
max_serialized_size_key_StartDiscovery_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
bool
cdr_serialize(
  const rosbag2_interfaces::srv::StartDiscovery_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rosbag2_interfaces::srv::StartDiscovery_Event & ros_message)
{
  // Member: info
...
inline
size_t
max_serialized_size_StartDiscovery_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rosbag2_interfaces::srv::typesupport_fastrtps_cpp::detail::max_serialized_size_StartDiscovery_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rosbag2_interfaces::srv::typesupport_fastrtps_cpp::detail::max_serialized_size_StartDiscovery_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rosbag2_interfaces::srv::StartDiscovery_Event;
    is_plain =
      (
...
inline
size_t
max_serialized_size_key_StartDiscovery_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rosbag2_interfaces::srv::typesupport_fastrtps_cpp::detail::max_serialized_size_key_StartDiscovery_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rosbag2_interfaces::srv::typesupport_fastrtps_cpp::detail::max_serialized_size_key_StartDiscovery_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
#endif  // ROSBAG2_INTERFACES__SRV__DETAIL__START_DISCOVERY__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
