...
#ifndef ROSBAG2_INTERFACES__SRV__DETAIL__SPLIT_BAGFILE__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
#define ROSBAG2_INTERFACES__SRV__DETAIL__SPLIT_BAGFILE__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
...
#include "rosbag2_interfaces/srv/detail/split_bagfile__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.tracking_topic_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rosbag2_interfaces::srv::SplitBagfile_Request;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rosbag2_interfaces::srv::SplitBagfile_Response;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rosbag2_interfaces::srv::typesupport_fastrtps_cpp::detail::max_serialized_size_SplitBagfile_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rosbag2_interfaces::srv::typesupport_fastrtps_cpp::detail::max_serialized_size_SplitBagfile_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rosbag2_interfaces::srv::SplitBagfile_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rosbag2_interfaces::srv::typesupport_fastrtps_cpp::detail::max_serialized_size_key_SplitBagfile_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rosbag2_interfaces::srv::typesupport_fastrtps_cpp::detail::max_serialized_size_key_SplitBagfile_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
#endif  // ROSBAG2_INTERFACES__SRV__DETAIL__SPLIT_BAGFILE__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
