...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, rosbag2_interfaces::srv::SetRate_Request>, int> = 0>
...
template<>
constexpr const char * data_type<rosbag2_interfaces::srv::SetRate_Request>()
{
  return "rosbag2_interfaces::srv::SetRate_Request";
}

template<>
constexpr const char * name<rosbag2_interfaces::srv::SetRate_Request>()
{
  return "rosbag2_interfaces/srv/SetRate_Request";
}
...
template<>
struct MessageTraits<rosbag2_interfaces::srv::SetRate_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, rosbag2_interfaces::srv::SetRate_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<rosbag2_interfaces::srv::SetRate_Response>()
{
  return "rosbag2_interfaces::srv::SetRate_Response";
}

template<>
constexpr const char * name<rosbag2_interfaces::srv::SetRate_Response>()
{
  return "rosbag2_interfaces/srv/SetRate_Response";
}
...
template<>
struct MessageTraits<rosbag2_interfaces::srv::SetRate_Response>
{
  static constexpr std::size_t member_count = 1;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "success",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, rosbag2_interfaces::srv::SetRate_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<rosbag2_interfaces::srv::SetRate_Event>()
{
  return "rosbag2_interfaces::srv::SetRate_Event";
}

template<>
constexpr const char * name<rosbag2_interfaces::srv::SetRate_Event>()
{
  return "rosbag2_interfaces/srv/SetRate_Event";
}
...
template<>
struct MessageTraits<rosbag2_interfaces::srv::SetRate_Event>
{
...
template<>
constexpr const char * data_type<rosbag2_interfaces::srv::SetRate>()
{
  return "rosbag2_interfaces::srv::SetRate";
}

template<>
constexpr const char * name<rosbag2_interfaces::srv::SetRate>()
{
  return "rosbag2_interfaces/srv/SetRate";
}
