...
class Init_Stop_Response_error_string
{
public:
  explicit Init_Stop_Response_error_string(::rosbag2_interfaces::srv::Stop_Response & msg)
  : msg_(msg)
  {}
  ::rosbag2_interfaces::srv::Stop_Response error_string(::rosbag2_interfaces::srv::Stop_Response::_error_string_type arg)
  {
...
private:
  ::rosbag2_interfaces::srv::Stop_Response msg_;
};

class Init_Stop_Response_return_code
{
public:
  Init_Stop_Response_return_code()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Stop_Response_error_string return_code(::rosbag2_interfaces::srv::Stop_Response::_return_code_type arg)
  {
    msg_.return_code = std::move(arg);
    return Init_Stop_Response_error_string(msg_);
  }
...
{
  return rosbag2_interfaces::srv::builder::Init_Stop_Response_return_code();
}
