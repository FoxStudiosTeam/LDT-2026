...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, builtin_interfaces::msg::Time>, int> = 0>
...
template<>
constexpr const char * data_type<builtin_interfaces::msg::Time>()
{
  return "builtin_interfaces::msg::Time";
}

template<>
constexpr const char * name<builtin_interfaces::msg::Time>()
{
  return "builtin_interfaces/msg/Time";
}
...
template<>
struct MessageTraits<builtin_interfaces::msg::Time>
{
