...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, builtin_interfaces::msg::Duration>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).sec,
    std::forward<T>(msg).nanosec);
}
...
template<>
constexpr const char * data_type<builtin_interfaces::msg::Duration>()
{
  return "builtin_interfaces::msg::Duration";
}

template<>
constexpr const char * name<builtin_interfaces::msg::Duration>()
{
  return "builtin_interfaces/msg/Duration";
}
...
template<>
struct MessageTraits<builtin_interfaces::msg::Duration>
{
