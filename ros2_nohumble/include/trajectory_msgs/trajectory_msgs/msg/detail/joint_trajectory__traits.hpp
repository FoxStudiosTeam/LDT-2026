...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, trajectory_msgs::msg::JointTrajectory>, int> = 0>
...
template<>
constexpr const char * data_type<trajectory_msgs::msg::JointTrajectory>()
{
  return "trajectory_msgs::msg::JointTrajectory";
}

template<>
constexpr const char * name<trajectory_msgs::msg::JointTrajectory>()
{
  return "trajectory_msgs/msg/JointTrajectory";
}
...
template<>
struct MessageTraits<trajectory_msgs::msg::JointTrajectory>
{
