...
#ifndef TRAJECTORY_MSGS__MSG__DETAIL__JOINT_TRAJECTORY__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
#define TRAJECTORY_MSGS__MSG__DETAIL__JOINT_TRAJECTORY__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
...
#include "trajectory_msgs/msg/detail/joint_trajectory_point__rosidl_typesupport_fastrtps_c_impl.hpp"
...
inline
bool impl_cdr_serialize_trajectory_msgs__msg__JointTrajectory(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: points
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_serialize_trajectory_msgs__msg__JointTrajectoryPoint(
        &array_ptr[i], cdr);
    }
  }
...
inline
bool impl_cdr_deserialize_trajectory_msgs__msg__JointTrajectory(
  eprosima::fastcdr::Cdr & cdr,
  trajectory_msgs__msg__JointTrajectory * ros_message)
{
  ...
  // Field name: points
  {
    ...
    auto array_ptr = ros_message->points.data;
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_deserialize_trajectory_msgs__msg__JointTrajectoryPoint(cdr, &array_ptr[i]);
    }
  }
...
inline
size_t impl_get_serialized_size_trajectory_msgs__msg__JointTrajectory(
  ...
  size_t current_alignment)
{
  ...
  // Field name: points
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += impl_get_serialized_size_trajectory_msgs__msg__JointTrajectoryPoint(
...
inline
size_t impl_max_serialized_size_trajectory_msgs__msg__JointTrajectory(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        impl_max_serialized_size_trajectory_msgs__msg__JointTrajectoryPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
inline
bool impl_cdr_serialize_key_trajectory_msgs__msg__JointTrajectory(
  const trajectory_msgs__msg__JointTrajectory * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  ...
  // Field name: points
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_serialize_key_trajectory_msgs__msg__JointTrajectoryPoint(
        &array_ptr[i], cdr);
    }
  }
...
inline
size_t impl_get_serialized_size_key_trajectory_msgs__msg__JointTrajectory(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _JointTrajectory__ros_msg_type * ros_message = static_cast<const _JointTrajectory__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: points
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += impl_get_serialized_size_key_trajectory_msgs__msg__JointTrajectoryPoint(
        &array_ptr[index], current_alignment);
    }
  }
...
inline
size_t impl_max_serialized_size_key_trajectory_msgs__msg__JointTrajectory(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        impl_max_serialized_size_key_trajectory_msgs__msg__JointTrajectoryPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
inline
bool impl_cdr_serialize_with_endpoint_trajectory_msgs__msg__JointTrajectory(
  const trajectory_msgs__msg__JointTrajectory * ros_message,
  eprosima::fastcdr::Cdr & cdr,
  ...
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Field name: points
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_serialize_with_endpoint_trajectory_msgs__msg__JointTrajectoryPoint(
...
inline
bool impl_cdr_deserialize_with_endpoint_trajectory_msgs__msg__JointTrajectory(
  eprosima::fastcdr::Cdr & cdr,
  trajectory_msgs__msg__JointTrajectory * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Field name: points
  {
    ...
    auto array_ptr = ros_message->points.data;
    for (size_t i = 0; i < size; ++i) {
      impl_cdr_deserialize_with_endpoint_trajectory_msgs__msg__JointTrajectoryPoint(cdr, &array_ptr[i], endpoint_info, serialization_context);
    }
  }
...
#endif  // TRAJECTORY_MSGS__MSG__DETAIL__JOINT_TRAJECTORY__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
