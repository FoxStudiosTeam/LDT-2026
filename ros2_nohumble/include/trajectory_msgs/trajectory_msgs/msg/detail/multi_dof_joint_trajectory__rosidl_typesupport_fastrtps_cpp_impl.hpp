...
#ifndef TRAJECTORY_MSGS__MSG__DETAIL__MULTI_DOF_JOINT_TRAJECTORY__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
#define TRAJECTORY_MSGS__MSG__DETAIL__MULTI_DOF_JOINT_TRAJECTORY__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
...
#include "trajectory_msgs/msg/detail/multi_dof_joint_trajectory_point__rosidl_typesupport_fastrtps_cpp_impl.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: points
  {
    ...
    for (size_t i = 0; i < size; i++) {
      trajectory_msgs::msg::typesupport_fastrtps_cpp::detail::cdr_serialize(
  ...
  trajectory_msgs::msg::MultiDOFJointTrajectory & ros_message)
{
  ...
  // Member: points
  {
    ...
    for (size_t i = 0; i < size; i++) {
      trajectory_msgs::msg::typesupport_fastrtps_cpp::detail::cdr_deserialize(
  ...
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  try {
    ...
    // Member: points
    {
      ...
      cdr << static_cast<uint32_t>(size);
      for (size_t i = 0; i < size; i++) {
        trajectory_msgs::msg::typesupport_fastrtps_cpp::detail::cdr_serialize_with_endpoint(
          ros_message.points[i],
          cdr, endpoint_info, serialization_context);
      }
    }
    ...
    RCUTILS_LOG_ERROR_NAMED(
      "trajectory_msgs.typesupport_fastrtps_cpp",
  ...
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Member: points
  {
    ...
    ros_message.points.resize(size);
    for (size_t i = 0; i < size; i++) {
      trajectory_msgs::msg::typesupport_fastrtps_cpp::detail::cdr_deserialize_with_endpoint(
        cdr,
        ros_message.points[i],
        endpoint_info,
        serialization_context);
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        trajectory_msgs::msg::typesupport_fastrtps_cpp::detail::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        trajectory_msgs::msg::typesupport_fastrtps_cpp::detail::max_serialized_size_MultiDOFJointTrajectoryPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: points
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      trajectory_msgs::msg::typesupport_fastrtps_cpp::detail::cdr_serialize_key(
        ros_message.points[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        trajectory_msgs::msg::typesupport_fastrtps_cpp::detail::get_serialized_size_key(
        ros_message.points[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        trajectory_msgs::msg::typesupport_fastrtps_cpp::detail::max_serialized_size_key_MultiDOFJointTrajectoryPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
#endif  // TRAJECTORY_MSGS__MSG__DETAIL__MULTI_DOF_JOINT_TRAJECTORY__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
