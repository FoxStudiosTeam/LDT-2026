...
#ifndef SERVICE_MSGS__MSG__DETAIL__SERVICE_EVENT_INFO__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
#define SERVICE_MSGS__MSG__DETAIL__SERVICE_EVENT_INFO__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
...
inline
bool impl_cdr_serialize_service_msgs__msg__ServiceEventInfo(
...
inline
bool impl_cdr_deserialize_service_msgs__msg__ServiceEventInfo(
  eprosima::fastcdr::Cdr & cdr,
...
inline
size_t impl_get_serialized_size_service_msgs__msg__ServiceEventInfo(
...
inline
size_t impl_max_serialized_size_service_msgs__msg__ServiceEventInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_key_service_msgs__msg__ServiceEventInfo(
  const service_msgs__msg__ServiceEventInfo * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: event_type
...
inline
size_t impl_get_serialized_size_key_service_msgs__msg__ServiceEventInfo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ServiceEventInfo__ros_msg_type * ros_message = static_cast<const _ServiceEventInfo__ros_msg_type *>(untyped_ros_message);
...
inline
size_t impl_max_serialized_size_key_service_msgs__msg__ServiceEventInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_with_endpoint_service_msgs__msg__ServiceEventInfo(
  const service_msgs__msg__ServiceEventInfo * ros_message,
  eprosima::fastcdr::Cdr & cdr,
...
inline
bool impl_cdr_deserialize_with_endpoint_service_msgs__msg__ServiceEventInfo(
  eprosima::fastcdr::Cdr & cdr,
  service_msgs__msg__ServiceEventInfo * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
...
#endif  // SERVICE_MSGS__MSG__DETAIL__SERVICE_EVENT_INFO__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
