...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, type_description_interfaces::srv::GetTypeDescription_Request>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).type_name,
    std::forward<T>(msg).type_hash,
    std::forward<T>(msg).include_type_sources);
}
...
template<>
constexpr const char * data_type<type_description_interfaces::srv::GetTypeDescription_Request>()
{
  return "type_description_interfaces::srv::GetTypeDescription_Request";
}

template<>
constexpr const char * name<type_description_interfaces::srv::GetTypeDescription_Request>()
{
  return "type_description_interfaces/srv/GetTypeDescription_Request";
}
...
template<>
struct MessageTraits<type_description_interfaces::srv::GetTypeDescription_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, type_description_interfaces::srv::GetTypeDescription_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).successful,
    std::forward<T>(msg).failure_reason,
    std::forward<T>(msg).type_description,
    std::forward<T>(msg).type_sources,
    std::forward<T>(msg).extra_information);
}
...
template<>
constexpr const char * data_type<type_description_interfaces::srv::GetTypeDescription_Response>()
{
  return "type_description_interfaces::srv::GetTypeDescription_Response";
}

template<>
constexpr const char * name<type_description_interfaces::srv::GetTypeDescription_Response>()
{
  return "type_description_interfaces/srv/GetTypeDescription_Response";
}
...
template<>
struct MessageTraits<type_description_interfaces::srv::GetTypeDescription_Response>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, type_description_interfaces::srv::GetTypeDescription_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<type_description_interfaces::srv::GetTypeDescription_Event>()
{
  return "type_description_interfaces::srv::GetTypeDescription_Event";
}

template<>
constexpr const char * name<type_description_interfaces::srv::GetTypeDescription_Event>()
{
  return "type_description_interfaces/srv/GetTypeDescription_Event";
}
...
template<>
struct MessageTraits<type_description_interfaces::srv::GetTypeDescription_Event>
{
  static constexpr std::size_t member_count = 3;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "info",
...
template<>
constexpr const char * data_type<type_description_interfaces::srv::GetTypeDescription>()
{
  return "type_description_interfaces::srv::GetTypeDescription";
}

template<>
constexpr const char * name<type_description_interfaces::srv::GetTypeDescription>()
{
  return "type_description_interfaces/srv/GetTypeDescription";
}
