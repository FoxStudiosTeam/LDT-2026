...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, geometry_msgs::msg::PolygonStamped>, int> = 0>
...
template<>
constexpr const char * data_type<geometry_msgs::msg::PolygonStamped>()
{
  return "geometry_msgs::msg::PolygonStamped";
}

template<>
constexpr const char * name<geometry_msgs::msg::PolygonStamped>()
{
  return "geometry_msgs/msg/PolygonStamped";
}
...
template<>
struct MessageTraits<geometry_msgs::msg::PolygonStamped>
{
