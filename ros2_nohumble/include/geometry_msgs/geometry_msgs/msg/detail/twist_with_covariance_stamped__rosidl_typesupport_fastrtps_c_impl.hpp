...
#ifndef GEOMETRY_MSGS__MSG__DETAIL__TWIST_WITH_COVARIANCE_STAMPED__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
#define GEOMETRY_MSGS__MSG__DETAIL__TWIST_WITH_COVARIANCE_STAMPED__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
...
inline
bool impl_cdr_serialize_geometry_msgs__msg__TwistWithCovarianceStamped(
...
inline
bool impl_cdr_deserialize_geometry_msgs__msg__TwistWithCovarianceStamped(
  eprosima::fastcdr::Cdr & cdr,
...
inline
size_t impl_get_serialized_size_geometry_msgs__msg__TwistWithCovarianceStamped(
...
inline
size_t impl_max_serialized_size_geometry_msgs__msg__TwistWithCovarianceStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = geometry_msgs__msg__TwistWithCovarianceStamped;
    is_plain =
      (
...
inline
bool impl_cdr_serialize_key_geometry_msgs__msg__TwistWithCovarianceStamped(
  const geometry_msgs__msg__TwistWithCovarianceStamped * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
inline
size_t impl_get_serialized_size_key_geometry_msgs__msg__TwistWithCovarianceStamped(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TwistWithCovarianceStamped__ros_msg_type * ros_message = static_cast<const _TwistWithCovarianceStamped__ros_msg_type *>(untyped_ros_message);
...
inline
size_t impl_max_serialized_size_key_geometry_msgs__msg__TwistWithCovarianceStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_with_endpoint_geometry_msgs__msg__TwistWithCovarianceStamped(
  const geometry_msgs__msg__TwistWithCovarianceStamped * ros_message,
  eprosima::fastcdr::Cdr & cdr,
...
inline
bool impl_cdr_deserialize_with_endpoint_geometry_msgs__msg__TwistWithCovarianceStamped(
  eprosima::fastcdr::Cdr & cdr,
  geometry_msgs__msg__TwistWithCovarianceStamped * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
...
#endif  // GEOMETRY_MSGS__MSG__DETAIL__TWIST_WITH_COVARIANCE_STAMPED__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
