...
#ifndef GEOMETRY_MSGS__MSG__DETAIL__VELOCITY_WITH_COVARIANCE_STAMPED__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
#define GEOMETRY_MSGS__MSG__DETAIL__VELOCITY_WITH_COVARIANCE_STAMPED__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
...
#include "geometry_msgs/msg/detail/velocity_with_covariance_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
#include "fastcdr/Cdr.h"

// Include the inline (de)serialization headers of nested message types so
// their bodies are visible here and can be fully inlined by the compiler.
#include "std_msgs/msg/detail/header__rosidl_typesupport_fastrtps_cpp_impl.hpp"
#include "geometry_msgs/msg/detail/twist_with_covariance__rosidl_typesupport_fastrtps_cpp_impl.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: velocity
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        geometry_msgs::msg::typesupport_fastrtps_cpp::detail::max_serialized_size_TwistWithCovariance(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = geometry_msgs::msg::VelocityWithCovarianceStamped;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: velocity
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        geometry_msgs::msg::typesupport_fastrtps_cpp::detail::max_serialized_size_key_TwistWithCovariance(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
#endif  // GEOMETRY_MSGS__MSG__DETAIL__VELOCITY_WITH_COVARIANCE_STAMPED__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
