...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, geometry_msgs::msg::Point>, int> = 0>
...
template<>
constexpr const char * data_type<geometry_msgs::msg::Point>()
{
  return "geometry_msgs::msg::Point";
}

template<>
constexpr const char * name<geometry_msgs::msg::Point>()
{
  return "geometry_msgs/msg/Point";
}
...
template<>
struct MessageTraits<geometry_msgs::msg::Point>
{
