...
#ifndef GEOMETRY_MSGS__MSG__DETAIL__VELOCITY_WITH_COVARIANCE_STAMPED__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
#define GEOMETRY_MSGS__MSG__DETAIL__VELOCITY_WITH_COVARIANCE_STAMPED__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
...
#include "geometry_msgs/msg/detail/velocity_with_covariance_stamped__rosidl_typesupport_fastrtps_c.h"
...
using _VelocityWithCovarianceStamped__ros_msg_type = geometry_msgs__msg__VelocityWithCovarianceStamped;


inline
bool impl_cdr_serialize_geometry_msgs__msg__VelocityWithCovarianceStamped(
...
inline
bool impl_cdr_deserialize_geometry_msgs__msg__VelocityWithCovarianceStamped(
  eprosima::fastcdr::Cdr & cdr,
  geometry_msgs__msg__VelocityWithCovarianceStamped * ros_message)
{
  ...
  // Field name: velocity
  {
    impl_cdr_deserialize_geometry_msgs__msg__TwistWithCovariance(cdr, &ros_message->velocity);
  }
...
inline
size_t impl_get_serialized_size_geometry_msgs__msg__VelocityWithCovarianceStamped(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VelocityWithCovarianceStamped__ros_msg_type * ros_message = static_cast<const _VelocityWithCovarianceStamped__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
...
inline
size_t impl_max_serialized_size_geometry_msgs__msg__VelocityWithCovarianceStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = geometry_msgs__msg__VelocityWithCovarianceStamped;
    is_plain =
      (
...
inline
bool impl_cdr_serialize_key_geometry_msgs__msg__VelocityWithCovarianceStamped(
  const geometry_msgs__msg__VelocityWithCovarianceStamped * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
inline
size_t impl_get_serialized_size_key_geometry_msgs__msg__VelocityWithCovarianceStamped(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VelocityWithCovarianceStamped__ros_msg_type * ros_message = static_cast<const _VelocityWithCovarianceStamped__ros_msg_type *>(untyped_ros_message);
...
inline
size_t impl_max_serialized_size_key_geometry_msgs__msg__VelocityWithCovarianceStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_with_endpoint_geometry_msgs__msg__VelocityWithCovarianceStamped(
  const geometry_msgs__msg__VelocityWithCovarianceStamped * ros_message,
  eprosima::fastcdr::Cdr & cdr,
...
inline
bool impl_cdr_deserialize_with_endpoint_geometry_msgs__msg__VelocityWithCovarianceStamped(
  eprosima::fastcdr::Cdr & cdr,
  geometry_msgs__msg__VelocityWithCovarianceStamped * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Field name: velocity
  {
    impl_cdr_deserialize_with_endpoint_geometry_msgs__msg__TwistWithCovariance(cdr, &ros_message->velocity, endpoint_info, serialization_context);
  }
...
#endif  // GEOMETRY_MSGS__MSG__DETAIL__VELOCITY_WITH_COVARIANCE_STAMPED__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
