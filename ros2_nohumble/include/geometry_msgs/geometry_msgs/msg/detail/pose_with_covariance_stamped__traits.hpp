...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, geometry_msgs::msg::PoseWithCovarianceStamped>, int> = 0>
...
template<>
constexpr const char * data_type<geometry_msgs::msg::PoseWithCovarianceStamped>()
{
  return "geometry_msgs::msg::PoseWithCovarianceStamped";
}

template<>
constexpr const char * name<geometry_msgs::msg::PoseWithCovarianceStamped>()
{
  return "geometry_msgs/msg/PoseWithCovarianceStamped";
}
...
template<>
struct MessageTraits<geometry_msgs::msg::PoseWithCovarianceStamped>
{
