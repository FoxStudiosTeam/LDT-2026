...
#ifndef DIAGNOSTIC_MSGS__MSG__DETAIL__DIAGNOSTIC_ARRAY__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
#define DIAGNOSTIC_MSGS__MSG__DETAIL__DIAGNOSTIC_ARRAY__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
...
inline
bool impl_cdr_serialize_diagnostic_msgs__msg__DiagnosticArray(
...
inline
bool impl_cdr_deserialize_diagnostic_msgs__msg__DiagnosticArray(
  eprosima::fastcdr::Cdr & cdr,
...
inline
size_t impl_get_serialized_size_diagnostic_msgs__msg__DiagnosticArray(
...
inline
size_t impl_max_serialized_size_diagnostic_msgs__msg__DiagnosticArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_key_diagnostic_msgs__msg__DiagnosticArray(
  const diagnostic_msgs__msg__DiagnosticArray * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
inline
size_t impl_get_serialized_size_key_diagnostic_msgs__msg__DiagnosticArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DiagnosticArray__ros_msg_type * ros_message = static_cast<const _DiagnosticArray__ros_msg_type *>(untyped_ros_message);
...
inline
size_t impl_max_serialized_size_key_diagnostic_msgs__msg__DiagnosticArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_with_endpoint_diagnostic_msgs__msg__DiagnosticArray(
  const diagnostic_msgs__msg__DiagnosticArray * ros_message,
  eprosima::fastcdr::Cdr & cdr,
...
inline
bool impl_cdr_deserialize_with_endpoint_diagnostic_msgs__msg__DiagnosticArray(
  eprosima::fastcdr::Cdr & cdr,
  diagnostic_msgs__msg__DiagnosticArray * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
...
#endif  // DIAGNOSTIC_MSGS__MSG__DETAIL__DIAGNOSTIC_ARRAY__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
