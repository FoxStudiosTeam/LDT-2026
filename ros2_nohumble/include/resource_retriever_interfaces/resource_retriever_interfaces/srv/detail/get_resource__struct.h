...
// IWYU pragma: private, include "resource_retriever_interfaces/srv/get_resource.h"


#ifndef RESOURCE_RETRIEVER_INTERFACES__SRV__DETAIL__GET_RESOURCE__STRUCT_H_
#define RESOURCE_RETRIEVER_INTERFACES__SRV__DETAIL__GET_RESOURCE__STRUCT_H_
...
/// Struct defined in srv/GetResource in the package resource_retriever_interfaces.
typedef struct resource_retriever_interfaces__srv__GetResource_Request
{
...
// Struct for a sequence of resource_retriever_interfaces__srv__GetResource_Request.
typedef struct resource_retriever_interfaces__srv__GetResource_Request__Sequence
{
...
enum
{
  resource_retriever_interfaces__srv__GetResource_Response__ERROR = 0l
};
...
enum
{
  resource_retriever_interfaces__srv__GetResource_Response__OK = 1l
};
...
enum
{
  resource_retriever_interfaces__srv__GetResource_Response__NOT_MODIFIED = 2l
};
...
/// Struct defined in srv/GetResource in the package resource_retriever_interfaces.
typedef struct resource_retriever_interfaces__srv__GetResource_Response
{
...
// Struct for a sequence of resource_retriever_interfaces__srv__GetResource_Response.
typedef struct resource_retriever_interfaces__srv__GetResource_Response__Sequence
{
...
enum
{
  resource_retriever_interfaces__srv__GetResource_Event__request__MAX_SIZE = 1
};
// response
enum
{
  resource_retriever_interfaces__srv__GetResource_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetResource in the package resource_retriever_interfaces.
typedef struct resource_retriever_interfaces__srv__GetResource_Event
{
  service_msgs__msg__ServiceEventInfo info;
  resource_retriever_interfaces__srv__GetResource_Request__Sequence request;
  resource_retriever_interfaces__srv__GetResource_Response__Sequence response;
} resource_retriever_interfaces__srv__GetResource_Event;

// Struct for a sequence of resource_retriever_interfaces__srv__GetResource_Event.
typedef struct resource_retriever_interfaces__srv__GetResource_Event__Sequence
{
...
#endif  // RESOURCE_RETRIEVER_INTERFACES__SRV__DETAIL__GET_RESOURCE__STRUCT_H_
