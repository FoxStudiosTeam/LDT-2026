...
#ifndef TF2_MSGS__MSG__DETAIL__TF_MESSAGE__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
#define TF2_MSGS__MSG__DETAIL__TF_MESSAGE__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
...
#include "geometry_msgs/msg/detail/transform_stamped__rosidl_typesupport_fastrtps_cpp_impl.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: transforms
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        geometry_msgs::msg::typesupport_fastrtps_cpp::detail::max_serialized_size_TransformStamped(
  ...
  size_t current_alignment)
{
  ...
  // Member: transforms
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        geometry_msgs::msg::typesupport_fastrtps_cpp::detail::max_serialized_size_key_TransformStamped(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
#endif  // TF2_MSGS__MSG__DETAIL__TF_MESSAGE__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
