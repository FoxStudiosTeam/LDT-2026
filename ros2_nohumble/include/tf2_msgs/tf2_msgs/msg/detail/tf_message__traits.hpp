...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, tf2_msgs::msg::TFMessage>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(std::forward<T>(msg).transforms);
}
...
template<>
constexpr const char * data_type<tf2_msgs::msg::TFMessage>()
{
  return "tf2_msgs::msg::TFMessage";
}

template<>
constexpr const char * name<tf2_msgs::msg::TFMessage>()
{
  return "tf2_msgs/msg/TFMessage";
}
...
template<>
struct MessageTraits<tf2_msgs::msg::TFMessage>
{
