...
tf2_msgs__srv__FrameGraph_Request__Sequence__init(tf2_msgs__srv__FrameGraph_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(tf2_msgs__srv__FrameGraph_Request)) {
      return false;
    }
  ...
  tf2_msgs__srv__FrameGraph_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(tf2_msgs__srv__FrameGraph_Request)) {
      return false;
    }
...
tf2_msgs__srv__FrameGraph_Response__Sequence__init(tf2_msgs__srv__FrameGraph_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(tf2_msgs__srv__FrameGraph_Response)) {
      return false;
    }
  ...
  tf2_msgs__srv__FrameGraph_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(tf2_msgs__srv__FrameGraph_Response)) {
      return false;
    }
    const size_t allocation_size =
...
tf2_msgs__srv__FrameGraph_Event__Sequence__init(tf2_msgs__srv__FrameGraph_Event__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(tf2_msgs__srv__FrameGraph_Event)) {
      return false;
    }
  ...
  tf2_msgs__srv__FrameGraph_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(tf2_msgs__srv__FrameGraph_Event)) {
      return false;
    }
    const size_t allocation_size =
