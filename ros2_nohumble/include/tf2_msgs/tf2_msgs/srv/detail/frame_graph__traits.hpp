...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, tf2_msgs::srv::FrameGraph_Request>, int> = 0>
...
template<>
constexpr const char * data_type<tf2_msgs::srv::FrameGraph_Request>()
{
  return "tf2_msgs::srv::FrameGraph_Request";
}

template<>
constexpr const char * name<tf2_msgs::srv::FrameGraph_Request>()
{
  return "tf2_msgs/srv/FrameGraph_Request";
}
...
template<>
struct MessageTraits<tf2_msgs::srv::FrameGraph_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, tf2_msgs::srv::FrameGraph_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(std::forward<T>(msg).frame_yaml);
}
...
template<>
constexpr const char * data_type<tf2_msgs::srv::FrameGraph_Response>()
{
  return "tf2_msgs::srv::FrameGraph_Response";
}

template<>
constexpr const char * name<tf2_msgs::srv::FrameGraph_Response>()
{
  return "tf2_msgs/srv/FrameGraph_Response";
}
...
template<>
struct MessageTraits<tf2_msgs::srv::FrameGraph_Response>
{
  static constexpr std::size_t member_count = 1;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "frame_yaml",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, tf2_msgs::srv::FrameGraph_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<tf2_msgs::srv::FrameGraph_Event>()
{
  return "tf2_msgs::srv::FrameGraph_Event";
}

template<>
constexpr const char * name<tf2_msgs::srv::FrameGraph_Event>()
{
  return "tf2_msgs/srv/FrameGraph_Event";
}
...
template<>
struct MessageTraits<tf2_msgs::srv::FrameGraph_Event>
{
...
template<>
constexpr const char * data_type<tf2_msgs::srv::FrameGraph>()
{
  return "tf2_msgs::srv::FrameGraph";
}

template<>
constexpr const char * name<tf2_msgs::srv::FrameGraph>()
{
  return "tf2_msgs/srv/FrameGraph";
}
