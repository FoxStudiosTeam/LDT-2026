...
#ifndef STD_MSGS__MSG__DETAIL__MULTI_ARRAY_LAYOUT__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
#define STD_MSGS__MSG__DETAIL__MULTI_ARRAY_LAYOUT__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
...
#include "std_msgs/msg/detail/multi_array_dimension__rosidl_typesupport_fastrtps_cpp_impl.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: dim
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        std_msgs::msg::typesupport_fastrtps_cpp::detail::max_serialized_size_MultiArrayDimension(
  ...
  size_t current_alignment)
{
  ...
  // Member: dim
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        std_msgs::msg::typesupport_fastrtps_cpp::detail::max_serialized_size_key_MultiArrayDimension(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
#endif  // STD_MSGS__MSG__DETAIL__MULTI_ARRAY_LAYOUT__ROSIDL_TYPESUPPORT_FASTRTPS_CPP_IMPL_HPP_
