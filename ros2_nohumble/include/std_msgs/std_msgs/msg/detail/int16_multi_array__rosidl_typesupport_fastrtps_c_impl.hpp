...
#ifndef STD_MSGS__MSG__DETAIL__INT16_MULTI_ARRAY__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
#define STD_MSGS__MSG__DETAIL__INT16_MULTI_ARRAY__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
...
inline
bool impl_cdr_serialize_std_msgs__msg__Int16MultiArray(
...
inline
bool impl_cdr_deserialize_std_msgs__msg__Int16MultiArray(
  eprosima::fastcdr::Cdr & cdr,
...
inline
size_t impl_get_serialized_size_std_msgs__msg__Int16MultiArray(
...
inline
size_t impl_max_serialized_size_std_msgs__msg__Int16MultiArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_key_std_msgs__msg__Int16MultiArray(
  const std_msgs__msg__Int16MultiArray * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: layout
...
inline
size_t impl_get_serialized_size_key_std_msgs__msg__Int16MultiArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Int16MultiArray__ros_msg_type * ros_message = static_cast<const _Int16MultiArray__ros_msg_type *>(untyped_ros_message);
...
inline
size_t impl_max_serialized_size_key_std_msgs__msg__Int16MultiArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
inline
bool impl_cdr_serialize_with_endpoint_std_msgs__msg__Int16MultiArray(
  const std_msgs__msg__Int16MultiArray * ros_message,
  eprosima::fastcdr::Cdr & cdr,
...
inline
bool impl_cdr_deserialize_with_endpoint_std_msgs__msg__Int16MultiArray(
  eprosima::fastcdr::Cdr & cdr,
  std_msgs__msg__Int16MultiArray * ros_message,
  const rmw_topic_endpoint_info_t & endpoint_info,
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
...
#endif  // STD_MSGS__MSG__DETAIL__INT16_MULTI_ARRAY__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_
