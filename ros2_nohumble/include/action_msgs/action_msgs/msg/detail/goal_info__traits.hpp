...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, action_msgs::msg::GoalInfo>, int> = 0>
...
template<>
constexpr const char * data_type<action_msgs::msg::GoalInfo>()
{
  return "action_msgs::msg::GoalInfo";
}

template<>
constexpr const char * name<action_msgs::msg::GoalInfo>()
{
  return "action_msgs/msg/GoalInfo";
}
...
template<>
struct MessageTraits<action_msgs::msg::GoalInfo>
{
