...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, action_msgs::srv::CancelGoal_Request>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(std::forward<T>(msg).goal_info);
}
...
template<>
constexpr const char * data_type<action_msgs::srv::CancelGoal_Request>()
{
  return "action_msgs::srv::CancelGoal_Request";
}

template<>
constexpr const char * name<action_msgs::srv::CancelGoal_Request>()
{
  return "action_msgs/srv/CancelGoal_Request";
}
...
template<>
struct MessageTraits<action_msgs::srv::CancelGoal_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, action_msgs::srv::CancelGoal_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).return_code,
    std::forward<T>(msg).goals_canceling);
}
...
template<>
constexpr const char * data_type<action_msgs::srv::CancelGoal_Response>()
{
  return "action_msgs::srv::CancelGoal_Response";
}

template<>
constexpr const char * name<action_msgs::srv::CancelGoal_Response>()
{
  return "action_msgs/srv/CancelGoal_Response";
}
...
template<>
struct MessageTraits<action_msgs::srv::CancelGoal_Response>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, action_msgs::srv::CancelGoal_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<action_msgs::srv::CancelGoal_Event>()
{
  return "action_msgs::srv::CancelGoal_Event";
}

template<>
constexpr const char * name<action_msgs::srv::CancelGoal_Event>()
{
  return "action_msgs/srv/CancelGoal_Event";
}
...
template<>
struct MessageTraits<action_msgs::srv::CancelGoal_Event>
{
...
template<>
constexpr const char * data_type<action_msgs::srv::CancelGoal>()
{
  return "action_msgs::srv::CancelGoal";
}

template<>
constexpr const char * name<action_msgs::srv::CancelGoal>()
{
  return "action_msgs/srv/CancelGoal";
}
