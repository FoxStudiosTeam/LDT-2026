...
/// Cylinder, Cone, Capsule, and Ellipsoid.
///
...
/// integrands that do not admit a closed-form antiderivative (e.g. the
/// Cone, whose cross-sectional radius varies with height).  Nodes and
...
namespace detail
{
  ...
  /// Used by Cone::VolumeBelow and Cone::CenterOfVolumeBelow where the
  /// varying cross-sectional radius prevents closed-form integration.
