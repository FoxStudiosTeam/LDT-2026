...
#ifndef GZ_UTILS_LOG_EXPORT_HH_
#define GZ_UTILS_LOG_EXPORT_HH_
...
#include "gz/utils/log/detail/Export.hh"


#ifndef GZ_UTILS_LOG_VISIBLE
/// For gz-utils-log developers: Apply this macro to gz-utils-log
/// functions and classes which consumers of this library will need to be able
/// to call from their own programs or libraries.
#define GZ_UTILS_LOG_VISIBLE \
  DETAIL_GZ_UTILS_LOG_VISIBLE
#endif


#ifndef GZ_UTILS_LOG_HIDDEN
/// For gz-utils-log developers: Apply this macro to gz-utils-log
...
/// not tagged with GZ_UTILS_LOG_VISIBLE, so this does not
/// generally need to be used.
#define GZ_UTILS_LOG_HIDDEN \
  DETAIL_GZ_UTILS_LOG_HIDDEN
#endif


#ifndef GZ_DEPRECATED
/// For gz-utils-log developers: Use this macro to indicate that a
