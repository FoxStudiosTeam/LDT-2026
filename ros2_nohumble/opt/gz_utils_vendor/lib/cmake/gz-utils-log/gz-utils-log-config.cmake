# - Config file for the gz-utils-log component
#
# This should only be invoked by gz-utils-config.cmake.
#
# To load this component into your project, use:
# find_package(gz-utils COMPONENTS log)
#
# This creates the following targets:
#
#   Component library target                - gz-utils::gz-utils-log
#   Alternative target name                 - gz-utils::log
...
# this is discouraged:
#
#   gz-utils-log_LIBRARY  - Component library (actually contains gz-utils::log)
#
# We will also set gz-utils-log_FOUND to indicate that the component was found.
#
################################################################################
...
if(gz-utils-log_CONFIG_INCLUDED)
  return()
endif()
set(gz-utils-log_CONFIG_INCLUDED TRUE)

if(NOT gz-utils-log_FIND_QUIETLY)
  message(STATUS "Looking for gz-utils-log -- found version 4.0.0")
endif()
...
if(NOT gz-utils-log_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of gz-utils-log")
endif()
find_package(spdlog ${gz_package_quiet} ${gz_package_required})
# --------------------------------

if(NOT TARGET gz-utils::gz-utils-log)
  include("${CMAKE_CURRENT_LIST_DIR}/gz-utils-log-targets.cmake")

  # Create a simplified imported target name for the log library.
  # You can link to this target instead of the log library.
  add_library(gz-utils::log INTERFACE IMPORTED)
  set_target_properties(gz-utils::log PROPERTIES
    INTERFACE_LINK_LIBRARIES "gz-utils::gz-utils-log")
...
if(NOT gz_requested_components)
  ...
  set_target_properties(gz-utils::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};gz-utils::gz-utils-log")
endif()

set(gz-utils-log_LIBRARY gz-utils::gz-utils-log)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(gz-utils-log "gz-utils-log")
