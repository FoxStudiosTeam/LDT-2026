...
#
# That will define the variable gz-cmake_FOUND, and will open up access
...
if(gz-cmake_CONFIG_INCLUDED)
  return()
endif()
set(gz-cmake_CONFIG_INCLUDED TRUE)
...
if( NOT GZ_CMAKE_VERSION_MAJOR
    OR (GZ_CMAKE_VERSION_MAJOR LESS 5) )
  ...
  set(GZ_CMAKE_DOXYGEN_DIR "${PACKAGE_PREFIX_DIR}/share/gz/gz-cmake/doxygen")
  set(GZ_CMAKE_CODECHECK_DIR "${PACKAGE_PREFIX_DIR}/share/gz/gz-cmake/codecheck")
  set(GZ_CMAKE_BENCHMARK_DIR "${PACKAGE_PREFIX_DIR}/share/gz/gz-cmake/benchmark")
  set(GZ_CMAKE_TOOLS_DIR "${PACKAGE_PREFIX_DIR}/share/gz/gz-cmake/tools")
endif()
