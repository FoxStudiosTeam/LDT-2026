...
set "AMENT_ENVIRONMENT_HOOKS[test_rosidl_buffer]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[test_rosidl_buffer] "%AMENT_CURRENT_PREFIX%\share\test_rosidl_buffer\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[test_rosidl_buffer] "%AMENT_CURRENT_PREFIX%\share\test_rosidl_buffer\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[test_rosidl_buffer] "%AMENT_CURRENT_PREFIX%\share\test_rosidl_buffer\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[test_rosidl_buffer]:;=";"%") do (
    call:call_file %%f
  )
