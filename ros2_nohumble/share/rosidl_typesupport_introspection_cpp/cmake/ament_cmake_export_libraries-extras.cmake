  ...
  while(_i LESS _length)
    ...
    if(NOT IS_ABSOLUTE "${_library}")
      ...
      find_library(
        ...
        "${rosidl_typesupport_introspection_cpp_DIR}/../../../lib"
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING
          "Package 'rosidl_typesupport_introspection_cpp' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND rosidl_typesupport_introspection_cpp_LIBRARIES ${_cfg} "${_lib}")
