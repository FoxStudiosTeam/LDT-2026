...
# to rosidl_core_runtime_DEFINITIONS , rosidl_core_runtime_INCLUDE_DIRS and
# rosidl_core_runtime_LIBRARIES.
foreach(_dep ${rosidl_runtime_packages})
  find_package("${_dep}" QUIET)
  if(${_dep}_FOUND)
    if(${_dep}_DEFINITIONS)
      list(APPEND rosidl_core_runtime_DEFINITIONS "${${_dep}_DEFINITIONS}")
    endif()
    if(${_dep}_INCLUDE_DIRS)
      list(APPEND rosidl_core_runtime_INCLUDE_DIRS "${${_dep}_INCLUDE_DIRS}")
    endif()
    if(${_dep}_LIBRARIES)
      list(APPEND rosidl_core_runtime_LIBRARIES "${${_dep}_LIBRARIES}")
    endif()
  endif()
endforeach()
