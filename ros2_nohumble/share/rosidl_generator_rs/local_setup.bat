...
set "AMENT_ENVIRONMENT_HOOKS[rosidl_generator_rs]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_generator_rs] "%AMENT_CURRENT_PREFIX%\share\rosidl_generator_rs\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_generator_rs] "%AMENT_CURRENT_PREFIX%\share\rosidl_generator_rs\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_generator_rs] "%AMENT_CURRENT_PREFIX%\share\rosidl_generator_rs\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rosidl_generator_rs]:;=";"%") do (
    call:call_file %%f
  )
