...
set "AMENT_ENVIRONMENT_HOOKS[rosidl_buffer_backend]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_buffer_backend] "%AMENT_CURRENT_PREFIX%\share\rosidl_buffer_backend\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_buffer_backend] "%AMENT_CURRENT_PREFIX%\share\rosidl_buffer_backend\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rosidl_buffer_backend]:;=";"%") do (
    call:call_file %%f
  )
