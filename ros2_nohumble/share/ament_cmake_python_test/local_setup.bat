...
set "AMENT_ENVIRONMENT_HOOKS[ament_cmake_python_test]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_cmake_python_test] "%AMENT_CURRENT_PREFIX%\share\ament_cmake_python_test\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_cmake_python_test] "%AMENT_CURRENT_PREFIX%\share\ament_cmake_python_test\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ament_cmake_python_test]:;=";"%") do (
    call:call_file %%f
  )
