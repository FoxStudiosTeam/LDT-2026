...
set(_exported_libraries "libstatistics_collector")
  ...
  while(_i LESS _length)
    ...
    if(NOT IS_ABSOLUTE "${_library}")
      ...
      find_library(
        ...
        "${libstatistics_collector_DIR}/../../../lib"
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING
          "Package 'libstatistics_collector' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND libstatistics_collector_LIBRARIES ${_cfg} "${_lib}")
