...
call:ament_prepend_unique_value PATH "%AMENT_CURRENT_PREFIX%\opt\zenoh_cpp_vendor\lib"
call:ament_prepend_unique_value PATH "%AMENT_CURRENT_PREFIX%\opt\zenoh_cpp_vendor\lib64"
