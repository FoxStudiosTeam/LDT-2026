...
set "AMENT_ENVIRONMENT_HOOKS[rmw_test_fixture_implementation]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rmw_test_fixture_implementation] "%AMENT_CURRENT_PREFIX%\share\rmw_test_fixture_implementation\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rmw_test_fixture_implementation] "%AMENT_CURRENT_PREFIX%\share\rmw_test_fixture_implementation\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rmw_test_fixture_implementation] "%AMENT_CURRENT_PREFIX%\share\rmw_test_fixture_implementation\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rmw_test_fixture_implementation]:;=";"%") do (
    call:call_file %%f
  )
